...
func deltapackzigzag_int32_1(initoffset int32, in *[32]int32, out *[1]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 1) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 2) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 3) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 4) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 5) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 6) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 7) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 9) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 10) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 11) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 12) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 13) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 14) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 15) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 17) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 18) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 19) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 20) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 21) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 22) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 23) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 24) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 25) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 26) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 27) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 28) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 29) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 30) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 31))
}

func deltapackzigzag_int32_2(initoffset int32, in *[32]int32, out *[2]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 2) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 4) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 6) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 8) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 10) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 12) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 14) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 18) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 20) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 22) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 24) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 26) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 28) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 30))
	out[1] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 2) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 4) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 6) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 8) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 10) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 12) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 14) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 18) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 20) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 22) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 24) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 26) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 28) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 30))
}

func deltapackzigzag_int32_3(initoffset int32, in *[32]int32, out *[3]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 3) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 6) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 9) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 12) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 15) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 18) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 21) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 24) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 27) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 30))
	out[1] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>2 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 1) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 4) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 7) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 10) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 13) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 19) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 22) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 25) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 28) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 31))
	out[2] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>1 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 2) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 5) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 11) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 14) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 17) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 20) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 23) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 26) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 29))
}

func deltapackzigzag_int32_4(initoffset int32, in *[32]int32, out *[4]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 4) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 8) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 12) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 16) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 20) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 24) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 28))
	out[1] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 4) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 8) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 12) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 16) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 20) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 24) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 28))
	out[2] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 4) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 8) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 12) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 16) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 20) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 24) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 28))
	out[3] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 4) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 8) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 12) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 16) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 20) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 24) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 28))
}

func deltapackzigzag_int32_5(initoffset int32, in *[32]int32, out *[5]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 5) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 10) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 15) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 20) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 25) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 30))
	out[1] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>2 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 3) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 13) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 18) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 23) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 28))
	out[2] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>4 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 1) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 6) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 11) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 21) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 26) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 31))
	out[3] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>1 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 4) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 9) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 14) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 19) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 24) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 29))
	out[4] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>3 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 2) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 7) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 12) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 17) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 22) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 27))
}

func deltapackzigzag_int32_6(initoffset int32, in *[32]int32, out *[6]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 6) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 12) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 18) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 24) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 30))
	out[1] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>2 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 4) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 10) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 22) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 28))
	out[2] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>4 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 2) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 8) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 14) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 20) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 26))
	out[3] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 6) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 12) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 18) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 24) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 30))
	out[4] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>2 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 4) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 10) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 22) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 28))
	out[5] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>4 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 2) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 8) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 14) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 20) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 26))
}

func deltapackzigzag_int32_7(initoffset int32, in *[32]int32, out *[7]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 7) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 14) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 21) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 28))
	out[1] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>4 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 3) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 10) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 17) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 24) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 31))
	out[2] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>1 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 6) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 13) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 20) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 27))
	out[3] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>5 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 2) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 9) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 23) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 30))
	out[4] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>2 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 5) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 12) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 19) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 26))
	out[5] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>6 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 1) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 15) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 22) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 29))
	out[6] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>3 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 4) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 11) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 18) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 25))
}

func deltapackzigzag_int32_8(initoffset int32, in *[32]int32, out *[8]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 8) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 16) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 24))
	out[1] = uint32(
		((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 8) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 16) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 24))
	out[2] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 8) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 16) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 24))
	out[3] = uint32(
		((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 8) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 16) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 24))
	out[4] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 8) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 16) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 24))
	out[5] = uint32(
		((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 8) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 16) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 24))
	out[6] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 8) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 16) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 24))
	out[7] = uint32(
		((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 8) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 16) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 24))
}

func deltapackzigzag_int32_9(initoffset int32, in *[32]int32, out *[9]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 9) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 18) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 27))
	out[1] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>5 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 4) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 13) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 22) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 31))
	out[2] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>1 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 17) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 26))
	out[3] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>6 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 3) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 12) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 21) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 30))
	out[4] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>2 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 7) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 25))
	out[5] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>7 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 2) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 11) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 20) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 29))
	out[6] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>3 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 6) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 15) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 24))
	out[7] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>8 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 1) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 10) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 19) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 28))
	out[8] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>4 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 5) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 14) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 23))
}

func deltapackzigzag_int32_10(initoffset int32, in *[32]int32, out *[10]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 10) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 20) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 30))
	out[1] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>2 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 8) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 18) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 28))
	out[2] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>4 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 6) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 26))
	out[3] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>6 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 4) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 14) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 24))
	out[4] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>8 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 2) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 12) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 22))
	out[5] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 10) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 20) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 30))
	out[6] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>2 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 8) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 18) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 28))
	out[7] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>4 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 6) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 26))
	out[8] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>6 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 4) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 14) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 24))
	out[9] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>8 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 2) |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 12) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 22))
}

func deltapackzigzag_int32_11(initoffset int32, in *[32]int32, out *[11]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 11) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 22))
	out[1] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>10 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 1) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 12) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 23))
	out[2] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>9 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 2) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 13) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 24))
	out[3] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>8 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 3) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 14) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 25))
	out[4] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>7 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 4) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 15) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 26))
	out[5] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>6 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 5) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 27))
	out[6] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>5 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 6) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 17) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 28))
	out[7] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>4 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 7) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 18) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 29))
	out[8] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>3 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 19) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 30))
	out[9] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>2 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 9) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 20) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 31))
	out[10] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>1 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 10) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 21))
}

func deltapackzigzag_int32_12(initoffset int32, in *[32]int32, out *[12]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 12) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 24))
	out[1] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>8 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 4) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 16) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 28))
	out[2] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>4 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 8) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 20))
	out[3] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 12) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 24))
	out[4] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>8 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 4) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 16) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 28))
	out[5] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>4 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 8) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 20))
	out[6] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 12) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 24))
	out[7] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>8 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 4) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 16) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 28))
	out[8] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>4 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 8) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 20))
	out[9] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 12) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 24))
	out[10] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>8 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 4) |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 16) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 28))
	out[11] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>4 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 8) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 20))
}

func deltapackzigzag_int32_13(initoffset int32, in *[32]int32, out *[13]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 13) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 26))
	out[1] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>6 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 7) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 20))
	out[2] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>12 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 1) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 14) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 27))
	out[3] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>5 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 21))
	out[4] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>11 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 2) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 15) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 28))
	out[5] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>4 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 9) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 22))
	out[6] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>10 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 3) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 29))
	out[7] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>3 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 10) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 23))
	out[8] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>9 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 4) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 17) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 30))
	out[9] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>2 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 11) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 24))
	out[10] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>8 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 5) |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 18) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 31))
	out[11] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>1 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 12) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 25))
	out[12] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>7 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 6) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 19))
}

func deltapackzigzag_int32_14(initoffset int32, in *[32]int32, out *[14]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 14) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 28))
	out[1] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>4 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 10) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 24))
	out[2] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>8 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 6) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 20))
	out[3] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>12 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 2) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 30))
	out[4] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>2 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 12) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 26))
	out[5] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>6 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 8) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 22))
	out[6] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>10 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 4) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 18))
	out[7] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 14) |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 28))
	out[8] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>4 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 10) |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 24))
	out[9] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>8 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 6) |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 20))
	out[10] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>12 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 2) |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 30))
	out[11] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>2 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 12) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 26))
	out[12] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>6 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 8) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 22))
	out[13] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>10 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 4) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 18))
}

func deltapackzigzag_int32_15(initoffset int32, in *[32]int32, out *[15]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 15) |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 30))
	out[1] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>2 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 13) |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 28))
	out[2] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>4 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 11) |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 26))
	out[3] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>6 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 9) |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 24))
	out[4] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>8 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 7) |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 22))
	out[5] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>10 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 5) |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 20))
	out[6] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>12 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 3) |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 18))
	out[7] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>14 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 1) |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 31))
	out[8] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>1 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 14) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 29))
	out[9] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>3 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 12) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 27))
	out[10] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>5 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 10) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 25))
	out[11] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>7 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 23))
	out[12] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>9 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 6) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 21))
	out[13] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>11 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 4) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 19))
	out[14] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>13 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 2) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 17))
}

func deltapackzigzag_int32_16(initoffset int32, in *[32]int32, out *[16]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 16))
	out[1] = uint32(
		((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 16))
	out[2] = uint32(
		((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 16))
	out[3] = uint32(
		((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 16))
	out[4] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 16))
	out[5] = uint32(
		((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 16))
	out[6] = uint32(
		((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 16))
	out[7] = uint32(
		((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 16))
	out[8] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 16))
	out[9] = uint32(
		((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 16))
	out[10] = uint32(
		((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 16))
	out[11] = uint32(
		((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 16))
	out[12] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 16))
	out[13] = uint32(
		((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 16))
	out[14] = uint32(
		((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 16))
	out[15] = uint32(
		((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31) |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 16))
}

func deltapackzigzag_int32_17(initoffset int32, in *[32]int32, out *[17]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 17))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>15 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 2) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 19))
	out[2] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>13 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 4) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 21))
	out[3] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>11 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 6) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 23))
	out[4] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>9 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 25))
	out[5] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>7 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 10) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 27))
	out[6] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>5 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 12) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 29))
	out[7] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>3 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 14) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 31))
	out[8] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>1 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[9] = uint32(
	...
	out[16] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>2 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 15))
}

func deltapackzigzag_int32_18(initoffset int32, in *[32]int32, out *[18]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 18))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>14 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 4) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 22))
	out[2] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>10 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 8) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 26))
	out[3] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>6 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 12) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 30))
	out[4] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>2 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16))
	out[5] = uint32(
	...
	out[8] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>4 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 14))
	out[9] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 18))
	out[10] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>14 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 4) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 22))
	out[11] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>10 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 8) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 26))
	out[12] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>6 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 12) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 30))
	out[13] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>2 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16))
	out[14] = uint32(
	...
	out[17] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>4 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 14))
}

func deltapackzigzag_int32_19(initoffset int32, in *[32]int32, out *[19]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 19))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>13 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 6) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 25))
	out[2] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>7 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 12) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 31))
	out[3] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>1 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 18))
	out[4] = uint32(
	...
	out[6] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>2 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 17))
	out[7] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>15 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 4) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 23))
	out[8] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>9 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 10) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 29))
	out[9] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>3 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[10] = uint32(
	...
	out[12] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>4 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 15))
	out[13] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>17 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 2) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 21))
	out[14] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>11 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 27))
	out[15] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>5 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 14))
	out[16] = uint32(
	...
	out[18] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>6 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 13))
}

func deltapackzigzag_int32_20(initoffset int32, in *[32]int32, out *[20]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 20))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>12 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 8) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 28))
	out[2] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>4 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 16))
	out[3] = uint32(
	...
	out[4] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>8 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 12))
	out[5] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 20))
	out[6] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>12 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 8) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 28))
	out[7] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>4 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 16))
	out[8] = uint32(
	...
	out[9] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>8 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 12))
	out[10] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 20))
	out[11] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>12 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 8) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 28))
	out[12] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>4 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 16))
	out[13] = uint32(
	...
	out[14] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>8 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 12))
	out[15] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 20))
	out[16] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>12 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 8) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 28))
	out[17] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>4 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 16))
	out[18] = uint32(
	...
	out[19] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>8 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 12))
}

func deltapackzigzag_int32_21(initoffset int32, in *[32]int32, out *[21]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 21))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>11 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 10) |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 31))
	out[2] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>1 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 20))
	out[3] = uint32(
	...
	out[4] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>2 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 19))
	out[5] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>13 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 29))
	out[6] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>3 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 18))
	out[7] = uint32(
	...
	out[8] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>4 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 17))
	out[9] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>15 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 6) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 27))
	out[10] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>5 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[11] = uint32(
	...
	out[12] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>6 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 15))
	out[13] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>17 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 4) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 25))
	out[14] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>7 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 14))
	out[15] = uint32(
	...
	out[16] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>8 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 13))
	out[17] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>19 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 2) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 23))
	out[18] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>9 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 12))
	out[19] = uint32(
...
func deltapackzigzag_int32_22(initoffset int32, in *[32]int32, out *[22]uint32) {
	...
	out[3] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>8 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 14))
	out[4] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>18 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 4) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 26))
	out[5] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>6 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16))
	out[6] = uint32(
	...
	out[7] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>4 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 18))
	out[8] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>14 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 8) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 30))
	out[9] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>2 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 20))
	out[10] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>12 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 10))
	out[11] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 22))
	out[12] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>10 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 12))
	out[13] = uint32(
	...
	out[14] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>8 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 14))
	out[15] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>18 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 4) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 26))
	out[16] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>6 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16))
	out[17] = uint32(
	...
	out[18] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>4 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 18))
	out[19] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>14 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 8) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 30))
	out[20] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>2 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 20))
	out[21] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>12 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 10))
}

func deltapackzigzag_int32_23(initoffset int32, in *[32]int32, out *[23]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 23))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>9 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 14))
	out[2] = uint32(
	...
	out[6] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>8 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 15))
	out[7] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>17 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 6) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 29))
	out[8] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>3 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 20))
	out[9] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>12 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 11))
	out[10] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>21 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 2) |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 25))
	out[11] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>7 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[12] = uint32(
	...
	out[13] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>2 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 21))
	out[14] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>11 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 12))
	out[15] = uint32(
	...
	out[16] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>6 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 17))
	out[17] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>15 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 31))
	out[18] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>1 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 22))
	out[19] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>10 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 13))
	out[20] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>19 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 4) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 27))
	out[21] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>5 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 18))
	out[22] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>14 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 9))
}

func deltapackzigzag_int32_24(initoffset int32, in *[32]int32, out *[24]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 24))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>8 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 16))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>16 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 8))
	out[3] = uint32(
		((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 24))
	out[4] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>8 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 16))
	out[5] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>16 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 8))
	out[6] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 24))
	out[7] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>8 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 16))
	out[8] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>16 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 8))
	out[9] = uint32(
		((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 24))
	out[10] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>8 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 16))
	out[11] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>16 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 8))
	out[12] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 24))
	out[13] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>8 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 16))
	out[14] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>16 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 8))
	out[15] = uint32(
		((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31) |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 24))
	out[16] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>8 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 16))
	out[17] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>16 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 8))
	out[18] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 24))
	out[19] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>8 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 16))
	out[20] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>16 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 8))
	out[21] = uint32(
		((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31) |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 24))
	out[22] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>8 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 16))
	out[23] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>16 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 8))
}

func deltapackzigzag_int32_25(initoffset int32, in *[32]int32, out *[25]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 25))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>7 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 18))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>14 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 11))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>21 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 4) |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 29))
	out[4] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>3 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 22))
	out[5] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>10 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 15))
	out[6] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>17 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8))
	out[7] = uint32(
	...
	out[8] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>6 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 19))
	out[9] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>13 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 12))
	out[10] = uint32(
	...
	out[11] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>2 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 23))
	out[12] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>9 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[13] = uint32(
		(((in[16]-in[15])<<1)^((in[16]-in[15])>>31))>>16 |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 9))
	out[14] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>23 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 2) |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 27))
	out[15] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>5 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 20))
	out[16] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>12 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 13))
	out[17] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>19 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 6) |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 31))
	out[18] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>1 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 24))
	out[19] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>8 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 17))
	out[20] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>15 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 10))
	out[21] = uint32(
	...
	out[22] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>4 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 21))
	out[23] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>11 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 14))
	out[24] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>18 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 7))
}

func deltapackzigzag_int32_26(initoffset int32, in *[32]int32, out *[26]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 26))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>6 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 20))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>12 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 14))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>18 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 8))
	out[4] = uint32(
	...
	out[5] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>4 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 22))
	out[6] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>10 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16))
	out[7] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>16 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 10))
	out[8] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>22 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 4) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 30))
	out[9] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>2 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 24))
	out[10] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>8 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 18))
	out[11] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>14 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 12))
	out[12] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>20 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 6))
	out[13] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 26))
	out[14] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>6 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 20))
	out[15] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>12 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 14))
	out[16] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>18 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 8))
	out[17] = uint32(
	...
	out[18] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>4 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 22))
	out[19] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>10 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16))
	out[20] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>16 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 10))
	out[21] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>22 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 4) |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 30))
	out[22] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>2 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 24))
	out[23] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>8 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 18))
	out[24] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>14 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 12))
	out[25] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>20 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 6))
}

func deltapackzigzag_int32_27(initoffset int32, in *[32]int32, out *[27]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 27))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>5 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 22))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>10 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 17))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>15 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 12))
	out[4] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>20 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 7))
	out[5] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>25 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 2) |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 29))
	out[6] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>3 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 24))
	out[7] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>8 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 19))
	out[8] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>13 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 14))
	out[9] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>18 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 9))
	out[10] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>23 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 4) |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 31))
	out[11] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>1 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 26))
	out[12] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>6 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 21))
	out[13] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>11 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[14] = uint32(
		(((in[16]-in[15])<<1)^((in[16]-in[15])>>31))>>16 |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 11))
	out[15] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>21 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 6))
	out[16] = uint32(
	...
	out[17] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>4 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 23))
	out[18] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>9 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 18))
	out[19] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>14 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 13))
	out[20] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>19 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8))
	out[21] = uint32(
	...
	out[22] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>2 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 25))
	out[23] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>7 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 20))
	out[24] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>12 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 15))
	out[25] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>17 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 10))
	out[26] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>22 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 5))
}

func deltapackzigzag_int32_28(initoffset int32, in *[32]int32, out *[28]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 28))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>4 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 24))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>8 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 20))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>12 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 16))
	out[4] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>16 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 12))
	out[5] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>20 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 8))
	out[6] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>24 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 4))
	out[7] = uint32(
		((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31) |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 28))
	out[8] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>4 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 24))
	out[9] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>8 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 20))
	out[10] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>12 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 16))
	out[11] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>16 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 12))
	out[12] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>20 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 8))
	out[13] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>24 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 4))
	out[14] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 28))
	out[15] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>4 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 24))
	out[16] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>8 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 20))
	out[17] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>12 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 16))
	out[18] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>16 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 12))
	out[19] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>20 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 8))
	out[20] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>24 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 4))
	out[21] = uint32(
		((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31) |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 28))
	out[22] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>4 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 24))
	out[23] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>8 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 20))
	out[24] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>12 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 16))
	out[25] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>16 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 12))
	out[26] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>20 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 8))
	out[27] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>24 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 4))
}

func deltapackzigzag_int32_29(initoffset int32, in *[32]int32, out *[29]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 29))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>3 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 26))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>6 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 23))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>9 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 20))
	out[4] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>12 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 17))
	out[5] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>15 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 14))
	out[6] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>18 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 11))
	out[7] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>21 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 8))
	out[8] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>24 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 5))
	out[9] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>27 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 2) |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 31))
	out[10] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>1 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 28))
	out[11] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>4 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 25))
	out[12] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>7 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 22))
	out[13] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>10 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 19))
	out[14] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>13 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[15] = uint32(
		(((in[16]-in[15])<<1)^((in[16]-in[15])>>31))>>16 |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 13))
	out[16] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>19 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 10))
	out[17] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>22 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 7))
	out[18] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>25 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 4))
	out[19] = uint32(
	...
	out[20] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>2 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 27))
	out[21] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>5 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 24))
	out[22] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>8 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 21))
	out[23] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>11 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 18))
	out[24] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>14 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 15))
	out[25] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>17 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 12))
	out[26] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>20 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 9))
	out[27] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>23 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 6))
	out[28] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>26 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 3))
}

func deltapackzigzag_int32_30(initoffset int32, in *[32]int32, out *[30]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 30))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>2 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 28))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>4 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 26))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>6 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 24))
	out[4] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>8 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 22))
	out[5] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>10 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 20))
	out[6] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>12 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 18))
	out[7] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>14 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 16))
	out[8] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>16 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 14))
	out[9] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>18 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 12))
	out[10] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>20 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 10))
	out[11] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>22 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 8))
	out[12] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>24 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 6))
	out[13] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>26 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 4))
	out[14] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>28 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 2))
	out[15] = uint32(
		((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31) |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 30))
	out[16] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>2 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 28))
	out[17] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>4 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 26))
	out[18] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>6 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 24))
	out[19] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>8 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 22))
	out[20] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>10 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 20))
	out[21] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>12 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 18))
	out[22] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>14 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 16))
	out[23] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>16 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 14))
	out[24] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>18 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 12))
	out[25] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>20 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 10))
	out[26] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>22 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 8))
	out[27] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>24 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 6))
	out[28] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>26 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 4))
	out[29] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>28 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 2))
}

func deltapackzigzag_int32_31(initoffset int32, in *[32]int32, out *[31]uint32) {
	out[0] = uint32(
		((in[0] - initoffset) << 1) ^ ((in[0] - initoffset) >> 31) |
			((((in[1] - in[0]) << 1) ^ ((in[1] - in[0]) >> 31)) << 31))
	out[1] = uint32(
		(((in[1]-in[0])<<1)^((in[1]-in[0])>>31))>>1 |
			((((in[2] - in[1]) << 1) ^ ((in[2] - in[1]) >> 31)) << 30))
	out[2] = uint32(
		(((in[2]-in[1])<<1)^((in[2]-in[1])>>31))>>2 |
			((((in[3] - in[2]) << 1) ^ ((in[3] - in[2]) >> 31)) << 29))
	out[3] = uint32(
		(((in[3]-in[2])<<1)^((in[3]-in[2])>>31))>>3 |
			((((in[4] - in[3]) << 1) ^ ((in[4] - in[3]) >> 31)) << 28))
	out[4] = uint32(
		(((in[4]-in[3])<<1)^((in[4]-in[3])>>31))>>4 |
			((((in[5] - in[4]) << 1) ^ ((in[5] - in[4]) >> 31)) << 27))
	out[5] = uint32(
		(((in[5]-in[4])<<1)^((in[5]-in[4])>>31))>>5 |
			((((in[6] - in[5]) << 1) ^ ((in[6] - in[5]) >> 31)) << 26))
	out[6] = uint32(
		(((in[6]-in[5])<<1)^((in[6]-in[5])>>31))>>6 |
			((((in[7] - in[6]) << 1) ^ ((in[7] - in[6]) >> 31)) << 25))
	out[7] = uint32(
		(((in[7]-in[6])<<1)^((in[7]-in[6])>>31))>>7 |
			((((in[8] - in[7]) << 1) ^ ((in[8] - in[7]) >> 31)) << 24))
	out[8] = uint32(
		(((in[8]-in[7])<<1)^((in[8]-in[7])>>31))>>8 |
			((((in[9] - in[8]) << 1) ^ ((in[9] - in[8]) >> 31)) << 23))
	out[9] = uint32(
		(((in[9]-in[8])<<1)^((in[9]-in[8])>>31))>>9 |
			((((in[10] - in[9]) << 1) ^ ((in[10] - in[9]) >> 31)) << 22))
	out[10] = uint32(
		(((in[10]-in[9])<<1)^((in[10]-in[9])>>31))>>10 |
			((((in[11] - in[10]) << 1) ^ ((in[11] - in[10]) >> 31)) << 21))
	out[11] = uint32(
		(((in[11]-in[10])<<1)^((in[11]-in[10])>>31))>>11 |
			((((in[12] - in[11]) << 1) ^ ((in[12] - in[11]) >> 31)) << 20))
	out[12] = uint32(
		(((in[12]-in[11])<<1)^((in[12]-in[11])>>31))>>12 |
			((((in[13] - in[12]) << 1) ^ ((in[13] - in[12]) >> 31)) << 19))
	out[13] = uint32(
		(((in[13]-in[12])<<1)^((in[13]-in[12])>>31))>>13 |
			((((in[14] - in[13]) << 1) ^ ((in[14] - in[13]) >> 31)) << 18))
	out[14] = uint32(
		(((in[14]-in[13])<<1)^((in[14]-in[13])>>31))>>14 |
			((((in[15] - in[14]) << 1) ^ ((in[15] - in[14]) >> 31)) << 17))
	out[15] = uint32(
		(((in[15]-in[14])<<1)^((in[15]-in[14])>>31))>>15 |
			((((in[16] - in[15]) << 1) ^ ((in[16] - in[15]) >> 31)) << 16))
	out[16] = uint32(
		(((in[16]-in[15])<<1)^((in[16]-in[15])>>31))>>16 |
			((((in[17] - in[16]) << 1) ^ ((in[17] - in[16]) >> 31)) << 15))
	out[17] = uint32(
		(((in[17]-in[16])<<1)^((in[17]-in[16])>>31))>>17 |
			((((in[18] - in[17]) << 1) ^ ((in[18] - in[17]) >> 31)) << 14))
	out[18] = uint32(
		(((in[18]-in[17])<<1)^((in[18]-in[17])>>31))>>18 |
			((((in[19] - in[18]) << 1) ^ ((in[19] - in[18]) >> 31)) << 13))
	out[19] = uint32(
		(((in[19]-in[18])<<1)^((in[19]-in[18])>>31))>>19 |
			((((in[20] - in[19]) << 1) ^ ((in[20] - in[19]) >> 31)) << 12))
	out[20] = uint32(
		(((in[20]-in[19])<<1)^((in[20]-in[19])>>31))>>20 |
			((((in[21] - in[20]) << 1) ^ ((in[21] - in[20]) >> 31)) << 11))
	out[21] = uint32(
		(((in[21]-in[20])<<1)^((in[21]-in[20])>>31))>>21 |
			((((in[22] - in[21]) << 1) ^ ((in[22] - in[21]) >> 31)) << 10))
	out[22] = uint32(
		(((in[22]-in[21])<<1)^((in[22]-in[21])>>31))>>22 |
			((((in[23] - in[22]) << 1) ^ ((in[23] - in[22]) >> 31)) << 9))
	out[23] = uint32(
		(((in[23]-in[22])<<1)^((in[23]-in[22])>>31))>>23 |
			((((in[24] - in[23]) << 1) ^ ((in[24] - in[23]) >> 31)) << 8))
	out[24] = uint32(
		(((in[24]-in[23])<<1)^((in[24]-in[23])>>31))>>24 |
			((((in[25] - in[24]) << 1) ^ ((in[25] - in[24]) >> 31)) << 7))
	out[25] = uint32(
		(((in[25]-in[24])<<1)^((in[25]-in[24])>>31))>>25 |
			((((in[26] - in[25]) << 1) ^ ((in[26] - in[25]) >> 31)) << 6))
	out[26] = uint32(
		(((in[26]-in[25])<<1)^((in[26]-in[25])>>31))>>26 |
			((((in[27] - in[26]) << 1) ^ ((in[27] - in[26]) >> 31)) << 5))
	out[27] = uint32(
		(((in[27]-in[26])<<1)^((in[27]-in[26])>>31))>>27 |
			((((in[28] - in[27]) << 1) ^ ((in[28] - in[27]) >> 31)) << 4))
	out[28] = uint32(
		(((in[28]-in[27])<<1)^((in[28]-in[27])>>31))>>28 |
			((((in[29] - in[28]) << 1) ^ ((in[29] - in[28]) >> 31)) << 3))
	out[29] = uint32(
		(((in[29]-in[28])<<1)^((in[29]-in[28])>>31))>>29 |
			((((in[30] - in[29]) << 1) ^ ((in[30] - in[29]) >> 31)) << 2))
	out[30] = uint32(
		(((in[30]-in[29])<<1)^((in[30]-in[29])>>31))>>30 |
			((((in[31] - in[30]) << 1) ^ ((in[31] - in[30]) >> 31)) << 1))
}
