...
func deltapack32_12[T uint32 | int32](out *[12]uint32, in *[32]T, initoffset T) {
	out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9], out[10], out[11] =
		uint32(in[0]-initoffset|((in[1]-in[0])<<12)|((in[2]-in[1])<<24)), uint32((in[2]-in[1])>>8|((in[3]-in[2])<<4)|((in[4]-in[3])<<16)|((in[5]-in[4])<<28)), uint32((in[5]-in[4])>>4|((in[6]-in[5])<<8)|((in[7]-in[6])<<20)), uint32(in[8]-in[7]|((in[9]-in[8])<<12)|((in[10]-in[9])<<24)), uint32((in[10]-in[9])>>8|((in[11]-in[10])<<4)|((in[12]-in[11])<<16)|((in[13]-in[12])<<28)), uint32((in[13]-in[12])>>4|((in[14]-in[13])<<8)|((in[15]-in[14])<<20)), uint32(in[16]-in[15]|((in[17]-in[16])<<12)|((in[18]-in[17])<<24)), uint32((in[18]-in[17])>>8|((in[19]-in[18])<<4)|((in[20]-in[19])<<16)|((in[21]-in[20])<<28)), uint32((in[21]-in[20])>>4|((in[22]-in[21])<<8)|((in[23]-in[22])<<20)), uint32(in[24]-in[23]|((in[25]-in[24])<<12)|((in[26]-in[25])<<24)), uint32((in[26]-in[25])>>8|((in[27]-in[26])<<4)|((in[28]-in[27])<<16)|((in[29]-in[28])<<28)), uint32((in[29]-in[28])>>4|((in[30]-in[29])<<8)|((in[31]-in[30])<<20))
}
...
func deltapack32_16[T uint32 | int32](out *[16]uint32, in *[32]T, initoffset T) {
	out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9], out[10], out[11], out[12], out[13], out[14], out[15] =
		uint32(in[0]-initoffset|((in[1]-in[0])<<16)), uint32(in[2]-in[1]|((in[3]-in[2])<<16)), uint32(in[4]-in[3]|((in[5]-in[4])<<16)), uint32(in[6]-in[5]|((in[7]-in[6])<<16)), uint32(in[8]-in[7]|((in[9]-in[8])<<16)), uint32(in[10]-in[9]|((in[11]-in[10])<<16)), uint32(in[12]-in[11]|((in[13]-in[12])<<16)), uint32(in[14]-in[13]|((in[15]-in[14])<<16)), uint32(in[16]-in[15]|((in[17]-in[16])<<16)), uint32(in[18]-in[17]|((in[19]-in[18])<<16)), uint32(in[20]-in[19]|((in[21]-in[20])<<16)), uint32(in[22]-in[21]|((in[23]-in[22])<<16)), uint32(in[24]-in[23]|((in[25]-in[24])<<16)), uint32(in[26]-in[25]|((in[27]-in[26])<<16)), uint32(in[28]-in[27]|((in[29]-in[28])<<16)), uint32(in[30]-in[29]|((in[31]-in[30])<<16))
}

func deltapack32_17[T uint32 | int32](out *[17]uint32, in *[32]T, initoffset T) {
	out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9], out[10], out[11], out[12], out[13], out[14], out[15], out[16] =
		uint32(in[0]-initoffset|((in[1]-in[0])<<17)), uint32((in[1]-in[0])>>15|((in[2]-in[1])<<2)|((in[3]-in[2])<<19)), uint32((in[3]-in[2])>>13|((in[4]-in[3])<<4)|((in[5]-in[4])<<21)), uint32((in[5]-in[4])>>11|((in[6]-in[5])<<6)|((in[7]-in[6])<<23)), uint32((in[7]-in[6])>>9|((in[8]-in[7])<<8)|((in[9]-in[8])<<25)), uint32((in[9]-in[8])>>7|((in[10]-in[9])<<10)|((in[11]-in[10])<<27)), uint32((in[11]-in[10])>>5|((in[12]-in[11])<<12)|((in[13]-in[12])<<29)), uint32((in[13]-in[12])>>3|((in[14]-in[13])<<14)|((in[15]-in[14])<<31)), uint32((in[15]-in[14])>>1|((in[16]-in[15])<<16)), uint32((in[16]-in[15])>>16|((in[17]-in[16])<<1)|((in[18]-in[17])<<18)), uint32((in[18]-in[17])>>14|((in[19]-in[18])<<3)|((in[20]-in[19])<<20)), uint32((in[20]-in[19])>>12|((in[21]-in[20])<<5)|((in[22]-in[21])<<22)), uint32((in[22]-in[21])>>10|((in[23]-in[22])<<7)|((in[24]-in[23])<<24)), uint32((in[24]-in[23])>>8|((in[25]-in[24])<<9)|((in[26]-in[25])<<26)), uint32((in[26]-in[25])>>6|((in[27]-in[26])<<11)|((in[28]-in[27])<<28)), uint32((in[28]-in[27])>>4|((in[29]-in[28])<<13)|((in[30]-in[29])<<30)), uint32((in[30]-in[29])>>2|((in[31]-in[30])<<15))
}

func deltapack32_18[T uint32 | int32](out *[18]uint32, in *[32]T, initoffset T) {
	out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9], out[10], out[11], out[12], out[13], out[14], out[15], out[16], out[17] =
		uint32(in[0]-initoffset|((in[1]-in[0])<<18)), uint32((in[1]-in[0])>>14|((in[2]-in[1])<<4)|((in[3]-in[2])<<22)), uint32((in[3]-in[2])>>10|((in[4]-in[3])<<8)|((in[5]-in[4])<<26)), uint32((in[5]-in[4])>>6|((in[6]-in[5])<<12)|((in[7]-in[6])<<30)), uint32((in[7]-in[6])>>2|((in[8]-in[7])<<16)), uint32((in[8]-in[7])>>16|((in[9]-in[8])<<2)|((in[10]-in[9])<<20)), uint32((in[10]-in[9])>>12|((in[11]-in[10])<<6)|((in[12]-in[11])<<24)), uint32((in[12]-in[11])>>8|((in[13]-in[12])<<10)|((in[14]-in[13])<<28)), uint32((in[14]-in[13])>>4|((in[15]-in[14])<<14)), uint32(in[16]-in[15]|((in[17]-in[16])<<18)), uint32((in[17]-in[16])>>14|((in[18]-in[17])<<4)|((in[19]-in[18])<<22)), uint32((in[19]-in[18])>>10|((in[20]-in[19])<<8)|((in[21]-in[20])<<26)), uint32((in[21]-in[20])>>6|((in[22]-in[21])<<12)|((in[23]-in[22])<<30)), uint32((in[23]-in[22])>>2|((in[24]-in[23])<<16)), uint32((in[24]-in[23])>>16|((in[25]-in[24])<<2)|((in[26]-in[25])<<20)), uint32((in[26]-in[25])>>12|((in[27]-in[26])<<6)|((in[28]-in[27])<<24)), uint32((in[28]-in[27])>>8|((in[29]-in[28])<<10)|((in[30]-in[29])<<28)), uint32((in[30]-in[29])>>4|((in[31]-in[30])<<14))
}

func deltapack32_19[T uint32 | int32](out *[19]uint32, in *[32]T, initoffset T) {
	out[0], out[1], out[2], out[3], out[4], out[5], out[6], out[7], out[8], out[9], out[10], out[11], out[12], out[13], out[14], out[15], out[16], out[17], out[18] =
		uint32(in[0]-initoffset|((in[1]-in[0])<<19)), uint32((in[1]-in[0])>>13|((in[2]-in[1])<<6)|((in[3]-in[2])<<25)), uint32((in[3]-in[2])>>7|((in[4]-in[3])<<12)|((in[5]-in[4])<<31)), uint32((in[5]-in[4])>>1|((in[6]-in[5])<<18)), uint32((in[6]-in[5])>>14|((in[7]-in[6])<<5)|((in[8]-in[7])<<24)), uint32((in[8]-in[7])>>8|((in[9]-in[8])<<11)|((in[10]-in[9])<<30)), uint32((in[10]-in[9])>>2|((in[11]-in[10])<<17)), uint32((in[11]-in[10])>>15|((in[12]-in[11])<<4)|((in[13]-in[12])<<23)), uint32((in[13]-in[12])>>9|((in[14]-in[13])<<10)|((in[15]-in[14])<<29)), uint32((in[15]-in[14])>>3|((in[16]-in[15])<<16)), uint32((in[16]-in[15])>>16|((in[17]-in[16])<<3)|((in[18]-in[17])<<22)), uint32((in[18]-in[17])>>10|((in[19]-in[18])<<9)|((in[20]-in[19])<<28)), uint32((in[20]-in[19])>>4|((in[21]-in[20])<<15)), uint32((in[21]-in[20])>>17|((in[22]-in[21])<<2)|((in[23]-in[22])<<21)), uint32((in[23]-in[22])>>11|((in[24]-in[23])<<8)|((in[25]-in[24])<<27)), uint32((in[25]-in[24])>>5|((in[26]-in[25])<<14)), uint32((in[26]-in[25])>>18|((in[27]-in[26])<<1)|((in[28]-in[27])<<20)), uint32((in[28]-in[27])>>12|((in[29]-in[28])<<7)|((in[30]-in[29])<<26)), uint32((in[30]-in[29])>>6|((in[31]-in[30])<<13))
}
