...
// AppendGroup_int32 Binary packing of one block of `in`, starting from `initoffset`
...
func appendGroup32_5[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[19]-in[18])>>1|((in[20]-in[19])<<4)|((in[21]-in[20])<<9)|((in[22]-in[21])<<14)|((in[23]-in[22])<<19)|((in[24]-in[23])<<24)|((in[25]-in[24])<<29)),
...
func appendGroup32_6[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(in[16]-in[15]|((in[17]-in[16])<<6)|((in[18]-in[17])<<12)|((in[19]-in[18])<<18)|((in[20]-in[19])<<24)|((in[21]-in[20])<<30)),
		uint32((in[21]-in[20])>>2|((in[22]-in[21])<<4)|((in[23]-in[22])<<10)|((in[24]-in[23])<<16)|((in[25]-in[24])<<22)|((in[26]-in[25])<<28)),
...
func appendGroup32_7[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[13]-in[12])>>5|((in[14]-in[13])<<2)|((in[15]-in[14])<<9)|((in[16]-in[15])<<16)|((in[17]-in[16])<<23)|((in[18]-in[17])<<30)),
		uint32((in[18]-in[17])>>2|((in[19]-in[18])<<5)|((in[20]-in[19])<<12)|((in[21]-in[20])<<19)|((in[22]-in[21])<<26)),
		uint32((in[22]-in[21])>>6|((in[23]-in[22])<<1)|((in[24]-in[23])<<8)|((in[25]-in[24])<<15)|((in[26]-in[25])<<22)|((in[27]-in[26])<<29)),
...
func appendGroup32_8[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(in[12]-in[11]|((in[13]-in[12])<<8)|((in[14]-in[13])<<16)|((in[15]-in[14])<<24)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<8)|((in[18]-in[17])<<16)|((in[19]-in[18])<<24)),
		uint32(in[20]-in[19]|((in[21]-in[20])<<8)|((in[22]-in[21])<<16)|((in[23]-in[22])<<24)),
		uint32(in[24]-in[23]|((in[25]-in[24])<<8)|((in[26]-in[25])<<16)|((in[27]-in[26])<<24)),
...
func appendGroup32_9[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[10]-in[9])>>6|((in[11]-in[10])<<3)|((in[12]-in[11])<<12)|((in[13]-in[12])<<21)|((in[14]-in[13])<<30)),
		uint32((in[14]-in[13])>>2|((in[15]-in[14])<<7)|((in[16]-in[15])<<16)|((in[17]-in[16])<<25)),
		uint32((in[17]-in[16])>>7|((in[18]-in[17])<<2)|((in[19]-in[18])<<11)|((in[20]-in[19])<<20)|((in[21]-in[20])<<29)),
		uint32((in[21]-in[20])>>3|((in[22]-in[21])<<6)|((in[23]-in[22])<<15)|((in[24]-in[23])<<24)),
		uint32((in[24]-in[23])>>8|((in[25]-in[24])<<1)|((in[26]-in[25])<<10)|((in[27]-in[26])<<19)|((in[28]-in[27])<<28)),
...
func appendGroup32_10[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[9]-in[8])>>6|((in[10]-in[9])<<4)|((in[11]-in[10])<<14)|((in[12]-in[11])<<24)),
		uint32((in[12]-in[11])>>8|((in[13]-in[12])<<2)|((in[14]-in[13])<<12)|((in[15]-in[14])<<22)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<10)|((in[18]-in[17])<<20)|((in[19]-in[18])<<30)),
		uint32((in[19]-in[18])>>2|((in[20]-in[19])<<8)|((in[21]-in[20])<<18)|((in[22]-in[21])<<28)),
		uint32((in[22]-in[21])>>4|((in[23]-in[22])<<6)|((in[24]-in[23])<<16)|((in[25]-in[24])<<26)),
		uint32((in[25]-in[24])>>6|((in[26]-in[25])<<4)|((in[27]-in[26])<<14)|((in[28]-in[27])<<24)),
...
func appendGroup32_11[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[8]-in[7])>>8|((in[9]-in[8])<<3)|((in[10]-in[9])<<14)|((in[11]-in[10])<<25)),
		uint32((in[11]-in[10])>>7|((in[12]-in[11])<<4)|((in[13]-in[12])<<15)|((in[14]-in[13])<<26)),
		uint32((in[14]-in[13])>>6|((in[15]-in[14])<<5)|((in[16]-in[15])<<16)|((in[17]-in[16])<<27)),
		uint32((in[17]-in[16])>>5|((in[18]-in[17])<<6)|((in[19]-in[18])<<17)|((in[20]-in[19])<<28)),
		uint32((in[20]-in[19])>>4|((in[21]-in[20])<<7)|((in[22]-in[21])<<18)|((in[23]-in[22])<<29)),
		uint32((in[23]-in[22])>>3|((in[24]-in[23])<<8)|((in[25]-in[24])<<19)|((in[26]-in[25])<<30)),
		uint32((in[26]-in[25])>>2|((in[27]-in[26])<<9)|((in[28]-in[27])<<20)|((in[29]-in[28])<<31)),
...
func appendGroup32_12[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(in[8]-in[7]|((in[9]-in[8])<<12)|((in[10]-in[9])<<24)),
		uint32((in[10]-in[9])>>8|((in[11]-in[10])<<4)|((in[12]-in[11])<<16)|((in[13]-in[12])<<28)),
		uint32((in[13]-in[12])>>4|((in[14]-in[13])<<8)|((in[15]-in[14])<<20)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<12)|((in[18]-in[17])<<24)),
		uint32((in[18]-in[17])>>8|((in[19]-in[18])<<4)|((in[20]-in[19])<<16)|((in[21]-in[20])<<28)),
		uint32((in[21]-in[20])>>4|((in[22]-in[21])<<8)|((in[23]-in[22])<<20)),
		uint32(in[24]-in[23]|((in[25]-in[24])<<12)|((in[26]-in[25])<<24)),
		uint32((in[26]-in[25])>>8|((in[27]-in[26])<<4)|((in[28]-in[27])<<16)|((in[29]-in[28])<<28)),
...
func appendGroup32_13[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[7]-in[6])>>5|((in[8]-in[7])<<8)|((in[9]-in[8])<<21)),
		uint32((in[9]-in[8])>>11|((in[10]-in[9])<<2)|((in[11]-in[10])<<15)|((in[12]-in[11])<<28)),
		uint32((in[12]-in[11])>>4|((in[13]-in[12])<<9)|((in[14]-in[13])<<22)),
		uint32((in[14]-in[13])>>10|((in[15]-in[14])<<3)|((in[16]-in[15])<<16)|((in[17]-in[16])<<29)),
		uint32((in[17]-in[16])>>3|((in[18]-in[17])<<10)|((in[19]-in[18])<<23)),
		uint32((in[19]-in[18])>>9|((in[20]-in[19])<<4)|((in[21]-in[20])<<17)|((in[22]-in[21])<<30)),
		uint32((in[22]-in[21])>>2|((in[23]-in[22])<<11)|((in[24]-in[23])<<24)),
		uint32((in[24]-in[23])>>8|((in[25]-in[24])<<5)|((in[26]-in[25])<<18)|((in[27]-in[26])<<31)),
		uint32((in[27]-in[26])>>1|((in[28]-in[27])<<12)|((in[29]-in[28])<<25)),
...
func appendGroup32_14[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[6]-in[5])>>12|((in[7]-in[6])<<2)|((in[8]-in[7])<<16)|((in[9]-in[8])<<30)),
		uint32((in[9]-in[8])>>2|((in[10]-in[9])<<12)|((in[11]-in[10])<<26)),
		uint32((in[11]-in[10])>>6|((in[12]-in[11])<<8)|((in[13]-in[12])<<22)),
		uint32((in[13]-in[12])>>10|((in[14]-in[13])<<4)|((in[15]-in[14])<<18)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<14)|((in[18]-in[17])<<28)),
		uint32((in[18]-in[17])>>4|((in[19]-in[18])<<10)|((in[20]-in[19])<<24)),
		uint32((in[20]-in[19])>>8|((in[21]-in[20])<<6)|((in[22]-in[21])<<20)),
		uint32((in[22]-in[21])>>12|((in[23]-in[22])<<2)|((in[24]-in[23])<<16)|((in[25]-in[24])<<30)),
		uint32((in[25]-in[24])>>2|((in[26]-in[25])<<12)|((in[27]-in[26])<<26)),
		uint32((in[27]-in[26])>>6|((in[28]-in[27])<<8)|((in[29]-in[28])<<22)),
...
func appendGroup32_15[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[6]-in[5])>>6|((in[7]-in[6])<<9)|((in[8]-in[7])<<24)),
		uint32((in[8]-in[7])>>8|((in[9]-in[8])<<7)|((in[10]-in[9])<<22)),
		uint32((in[10]-in[9])>>10|((in[11]-in[10])<<5)|((in[12]-in[11])<<20)),
		uint32((in[12]-in[11])>>12|((in[13]-in[12])<<3)|((in[14]-in[13])<<18)),
		uint32((in[14]-in[13])>>14|((in[15]-in[14])<<1)|((in[16]-in[15])<<16)|((in[17]-in[16])<<31)),
		uint32((in[17]-in[16])>>1|((in[18]-in[17])<<14)|((in[19]-in[18])<<29)),
		uint32((in[19]-in[18])>>3|((in[20]-in[19])<<12)|((in[21]-in[20])<<27)),
		uint32((in[21]-in[20])>>5|((in[22]-in[21])<<10)|((in[23]-in[22])<<25)),
		uint32((in[23]-in[22])>>7|((in[24]-in[23])<<8)|((in[25]-in[24])<<23)),
		uint32((in[25]-in[24])>>9|((in[26]-in[25])<<6)|((in[27]-in[26])<<21)),
		uint32((in[27]-in[26])>>11|((in[28]-in[27])<<4)|((in[29]-in[28])<<19)),
...
func appendGroup32_16[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(in[6]-in[5]|((in[7]-in[6])<<16)),
		uint32(in[8]-in[7]|((in[9]-in[8])<<16)),
		uint32(in[10]-in[9]|((in[11]-in[10])<<16)),
		uint32(in[12]-in[11]|((in[13]-in[12])<<16)),
		uint32(in[14]-in[13]|((in[15]-in[14])<<16)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<16)),
		uint32(in[18]-in[17]|((in[19]-in[18])<<16)),
		uint32(in[20]-in[19]|((in[21]-in[20])<<16)),
		uint32(in[22]-in[21]|((in[23]-in[22])<<16)),
		uint32(in[24]-in[23]|((in[25]-in[24])<<16)),
		uint32(in[26]-in[25]|((in[27]-in[26])<<16)),
		uint32(in[28]-in[27]|((in[29]-in[28])<<16)),
...
func appendGroup32_17[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[5]-in[4])>>11|((in[6]-in[5])<<6)|((in[7]-in[6])<<23)),
		uint32((in[7]-in[6])>>9|((in[8]-in[7])<<8)|((in[9]-in[8])<<25)),
		uint32((in[9]-in[8])>>7|((in[10]-in[9])<<10)|((in[11]-in[10])<<27)),
		uint32((in[11]-in[10])>>5|((in[12]-in[11])<<12)|((in[13]-in[12])<<29)),
		uint32((in[13]-in[12])>>3|((in[14]-in[13])<<14)|((in[15]-in[14])<<31)),
		uint32((in[15]-in[14])>>1|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<1)|((in[18]-in[17])<<18)),
		uint32((in[18]-in[17])>>14|((in[19]-in[18])<<3)|((in[20]-in[19])<<20)),
		uint32((in[20]-in[19])>>12|((in[21]-in[20])<<5)|((in[22]-in[21])<<22)),
		uint32((in[22]-in[21])>>10|((in[23]-in[22])<<7)|((in[24]-in[23])<<24)),
		uint32((in[24]-in[23])>>8|((in[25]-in[24])<<9)|((in[26]-in[25])<<26)),
		uint32((in[26]-in[25])>>6|((in[27]-in[26])<<11)|((in[28]-in[27])<<28)),
		uint32((in[28]-in[27])>>4|((in[29]-in[28])<<13)|((in[30]-in[29])<<30)),
...
func appendGroup32_18[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[5]-in[4])>>6|((in[6]-in[5])<<12)|((in[7]-in[6])<<30)),
		uint32((in[7]-in[6])>>2|((in[8]-in[7])<<16)),
		uint32((in[8]-in[7])>>16|((in[9]-in[8])<<2)|((in[10]-in[9])<<20)),
		uint32((in[10]-in[9])>>12|((in[11]-in[10])<<6)|((in[12]-in[11])<<24)),
		uint32((in[12]-in[11])>>8|((in[13]-in[12])<<10)|((in[14]-in[13])<<28)),
		uint32((in[14]-in[13])>>4|((in[15]-in[14])<<14)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<18)),
		uint32((in[17]-in[16])>>14|((in[18]-in[17])<<4)|((in[19]-in[18])<<22)),
		uint32((in[19]-in[18])>>10|((in[20]-in[19])<<8)|((in[21]-in[20])<<26)),
		uint32((in[21]-in[20])>>6|((in[22]-in[21])<<12)|((in[23]-in[22])<<30)),
		uint32((in[23]-in[22])>>2|((in[24]-in[23])<<16)),
		uint32((in[24]-in[23])>>16|((in[25]-in[24])<<2)|((in[26]-in[25])<<20)),
		uint32((in[26]-in[25])>>12|((in[27]-in[26])<<6)|((in[28]-in[27])<<24)),
		uint32((in[28]-in[27])>>8|((in[29]-in[28])<<10)|((in[30]-in[29])<<28)),
...
func appendGroup32_19[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[5]-in[4])>>1|((in[6]-in[5])<<18)),
		uint32((in[6]-in[5])>>14|((in[7]-in[6])<<5)|((in[8]-in[7])<<24)),
		uint32((in[8]-in[7])>>8|((in[9]-in[8])<<11)|((in[10]-in[9])<<30)),
		uint32((in[10]-in[9])>>2|((in[11]-in[10])<<17)),
		uint32((in[11]-in[10])>>15|((in[12]-in[11])<<4)|((in[13]-in[12])<<23)),
		uint32((in[13]-in[12])>>9|((in[14]-in[13])<<10)|((in[15]-in[14])<<29)),
		uint32((in[15]-in[14])>>3|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<3)|((in[18]-in[17])<<22)),
		uint32((in[18]-in[17])>>10|((in[19]-in[18])<<9)|((in[20]-in[19])<<28)),
		uint32((in[20]-in[19])>>4|((in[21]-in[20])<<15)),
		uint32((in[21]-in[20])>>17|((in[22]-in[21])<<2)|((in[23]-in[22])<<21)),
		uint32((in[23]-in[22])>>11|((in[24]-in[23])<<8)|((in[25]-in[24])<<27)),
		uint32((in[25]-in[24])>>5|((in[26]-in[25])<<14)),
		uint32((in[26]-in[25])>>18|((in[27]-in[26])<<1)|((in[28]-in[27])<<20)),
		uint32((in[28]-in[27])>>12|((in[29]-in[28])<<7)|((in[30]-in[29])<<26)),
...
func appendGroup32_20[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[4]-in[3])>>16|((in[5]-in[4])<<4)|((in[6]-in[5])<<24)),
		uint32((in[6]-in[5])>>8|((in[7]-in[6])<<12)),
		uint32(in[8]-in[7]|((in[9]-in[8])<<20)),
		uint32((in[9]-in[8])>>12|((in[10]-in[9])<<8)|((in[11]-in[10])<<28)),
		uint32((in[11]-in[10])>>4|((in[12]-in[11])<<16)),
		uint32((in[12]-in[11])>>16|((in[13]-in[12])<<4)|((in[14]-in[13])<<24)),
		uint32((in[14]-in[13])>>8|((in[15]-in[14])<<12)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<20)),
		uint32((in[17]-in[16])>>12|((in[18]-in[17])<<8)|((in[19]-in[18])<<28)),
		uint32((in[19]-in[18])>>4|((in[20]-in[19])<<16)),
		uint32((in[20]-in[19])>>16|((in[21]-in[20])<<4)|((in[22]-in[21])<<24)),
		uint32((in[22]-in[21])>>8|((in[23]-in[22])<<12)),
		uint32(in[24]-in[23]|((in[25]-in[24])<<20)),
		uint32((in[25]-in[24])>>12|((in[26]-in[25])<<8)|((in[27]-in[26])<<28)),
		uint32((in[27]-in[26])>>4|((in[28]-in[27])<<16)),
		uint32((in[28]-in[27])>>16|((in[29]-in[28])<<4)|((in[30]-in[29])<<24)),
...
func appendGroup32_21[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[4]-in[3])>>12|((in[5]-in[4])<<9)|((in[6]-in[5])<<30)),
		uint32((in[6]-in[5])>>2|((in[7]-in[6])<<19)),
		uint32((in[7]-in[6])>>13|((in[8]-in[7])<<8)|((in[9]-in[8])<<29)),
		uint32((in[9]-in[8])>>3|((in[10]-in[9])<<18)),
		uint32((in[10]-in[9])>>14|((in[11]-in[10])<<7)|((in[12]-in[11])<<28)),
		uint32((in[12]-in[11])>>4|((in[13]-in[12])<<17)),
		uint32((in[13]-in[12])>>15|((in[14]-in[13])<<6)|((in[15]-in[14])<<27)),
		uint32((in[15]-in[14])>>5|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<5)|((in[18]-in[17])<<26)),
		uint32((in[18]-in[17])>>6|((in[19]-in[18])<<15)),
		uint32((in[19]-in[18])>>17|((in[20]-in[19])<<4)|((in[21]-in[20])<<25)),
		uint32((in[21]-in[20])>>7|((in[22]-in[21])<<14)),
		uint32((in[22]-in[21])>>18|((in[23]-in[22])<<3)|((in[24]-in[23])<<24)),
		uint32((in[24]-in[23])>>8|((in[25]-in[24])<<13)),
		uint32((in[25]-in[24])>>19|((in[26]-in[25])<<2)|((in[27]-in[26])<<23)),
		uint32((in[27]-in[26])>>9|((in[28]-in[27])<<12)),
		uint32((in[28]-in[27])>>20|((in[29]-in[28])<<1)|((in[30]-in[29])<<22)),
...
func appendGroup32_22[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[4]-in[3])>>8|((in[5]-in[4])<<14)),
		uint32((in[5]-in[4])>>18|((in[6]-in[5])<<4)|((in[7]-in[6])<<26)),
		uint32((in[7]-in[6])>>6|((in[8]-in[7])<<16)),
		uint32((in[8]-in[7])>>16|((in[9]-in[8])<<6)|((in[10]-in[9])<<28)),
		uint32((in[10]-in[9])>>4|((in[11]-in[10])<<18)),
		uint32((in[11]-in[10])>>14|((in[12]-in[11])<<8)|((in[13]-in[12])<<30)),
		uint32((in[13]-in[12])>>2|((in[14]-in[13])<<20)),
		uint32((in[14]-in[13])>>12|((in[15]-in[14])<<10)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<22)),
		uint32((in[17]-in[16])>>10|((in[18]-in[17])<<12)),
		uint32((in[18]-in[17])>>20|((in[19]-in[18])<<2)|((in[20]-in[19])<<24)),
		uint32((in[20]-in[19])>>8|((in[21]-in[20])<<14)),
		uint32((in[21]-in[20])>>18|((in[22]-in[21])<<4)|((in[23]-in[22])<<26)),
		uint32((in[23]-in[22])>>6|((in[24]-in[23])<<16)),
		uint32((in[24]-in[23])>>16|((in[25]-in[24])<<6)|((in[26]-in[25])<<28)),
		uint32((in[26]-in[25])>>4|((in[27]-in[26])<<18)),
		uint32((in[27]-in[26])>>14|((in[28]-in[27])<<8)|((in[29]-in[28])<<30)),
		uint32((in[29]-in[28])>>2|((in[30]-in[29])<<20)),
...
func appendGroup32_23[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[4]-in[3])>>4|((in[5]-in[4])<<19)),
		uint32((in[5]-in[4])>>13|((in[6]-in[5])<<10)),
		uint32((in[6]-in[5])>>22|((in[7]-in[6])<<1)|((in[8]-in[7])<<24)),
		uint32((in[8]-in[7])>>8|((in[9]-in[8])<<15)),
		uint32((in[9]-in[8])>>17|((in[10]-in[9])<<6)|((in[11]-in[10])<<29)),
		uint32((in[11]-in[10])>>3|((in[12]-in[11])<<20)),
		uint32((in[12]-in[11])>>12|((in[13]-in[12])<<11)),
		uint32((in[13]-in[12])>>21|((in[14]-in[13])<<2)|((in[15]-in[14])<<25)),
		uint32((in[15]-in[14])>>7|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<7)|((in[18]-in[17])<<30)),
		uint32((in[18]-in[17])>>2|((in[19]-in[18])<<21)),
		uint32((in[19]-in[18])>>11|((in[20]-in[19])<<12)),
		uint32((in[20]-in[19])>>20|((in[21]-in[20])<<3)|((in[22]-in[21])<<26)),
		uint32((in[22]-in[21])>>6|((in[23]-in[22])<<17)),
		uint32((in[23]-in[22])>>15|((in[24]-in[23])<<8)|((in[25]-in[24])<<31)),
		uint32((in[25]-in[24])>>1|((in[26]-in[25])<<22)),
		uint32((in[26]-in[25])>>10|((in[27]-in[26])<<13)),
		uint32((in[27]-in[26])>>19|((in[28]-in[27])<<4)|((in[29]-in[28])<<27)),
		uint32((in[29]-in[28])>>5|((in[30]-in[29])<<18)),
...
func appendGroup32_24[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(in[4]-in[3]|((in[5]-in[4])<<24)),
		uint32((in[5]-in[4])>>8|((in[6]-in[5])<<16)),
		uint32((in[6]-in[5])>>16|((in[7]-in[6])<<8)),
		uint32(in[8]-in[7]|((in[9]-in[8])<<24)),
		uint32((in[9]-in[8])>>8|((in[10]-in[9])<<16)),
		uint32((in[10]-in[9])>>16|((in[11]-in[10])<<8)),
		uint32(in[12]-in[11]|((in[13]-in[12])<<24)),
		uint32((in[13]-in[12])>>8|((in[14]-in[13])<<16)),
		uint32((in[14]-in[13])>>16|((in[15]-in[14])<<8)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<24)),
		uint32((in[17]-in[16])>>8|((in[18]-in[17])<<16)),
		uint32((in[18]-in[17])>>16|((in[19]-in[18])<<8)),
		uint32(in[20]-in[19]|((in[21]-in[20])<<24)),
		uint32((in[21]-in[20])>>8|((in[22]-in[21])<<16)),
		uint32((in[22]-in[21])>>16|((in[23]-in[22])<<8)),
		uint32(in[24]-in[23]|((in[25]-in[24])<<24)),
		uint32((in[25]-in[24])>>8|((in[26]-in[25])<<16)),
		uint32((in[26]-in[25])>>16|((in[27]-in[26])<<8)),
		uint32(in[28]-in[27]|((in[29]-in[28])<<24)),
		uint32((in[29]-in[28])>>8|((in[30]-in[29])<<16)),
...
func appendGroup32_25[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>21|((in[4]-in[3])<<4)|((in[5]-in[4])<<29)),
		uint32((in[5]-in[4])>>3|((in[6]-in[5])<<22)),
		uint32((in[6]-in[5])>>10|((in[7]-in[6])<<15)),
		uint32((in[7]-in[6])>>17|((in[8]-in[7])<<8)),
		uint32((in[8]-in[7])>>24|((in[9]-in[8])<<1)|((in[10]-in[9])<<26)),
		uint32((in[10]-in[9])>>6|((in[11]-in[10])<<19)),
		uint32((in[11]-in[10])>>13|((in[12]-in[11])<<12)),
		uint32((in[12]-in[11])>>20|((in[13]-in[12])<<5)|((in[14]-in[13])<<30)),
		uint32((in[14]-in[13])>>2|((in[15]-in[14])<<23)),
		uint32((in[15]-in[14])>>9|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<9)),
		uint32((in[17]-in[16])>>23|((in[18]-in[17])<<2)|((in[19]-in[18])<<27)),
		uint32((in[19]-in[18])>>5|((in[20]-in[19])<<20)),
		uint32((in[20]-in[19])>>12|((in[21]-in[20])<<13)),
		uint32((in[21]-in[20])>>19|((in[22]-in[21])<<6)|((in[23]-in[22])<<31)),
		uint32((in[23]-in[22])>>1|((in[24]-in[23])<<24)),
		uint32((in[24]-in[23])>>8|((in[25]-in[24])<<17)),
		uint32((in[25]-in[24])>>15|((in[26]-in[25])<<10)),
		uint32((in[26]-in[25])>>22|((in[27]-in[26])<<3)|((in[28]-in[27])<<28)),
		uint32((in[28]-in[27])>>4|((in[29]-in[28])<<21)),
		uint32((in[29]-in[28])>>11|((in[30]-in[29])<<14)),
...
func appendGroup32_26[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>18|((in[4]-in[3])<<8)),
		uint32((in[4]-in[3])>>24|((in[5]-in[4])<<2)|((in[6]-in[5])<<28)),
		uint32((in[6]-in[5])>>4|((in[7]-in[6])<<22)),
		uint32((in[7]-in[6])>>10|((in[8]-in[7])<<16)),
		uint32((in[8]-in[7])>>16|((in[9]-in[8])<<10)),
		uint32((in[9]-in[8])>>22|((in[10]-in[9])<<4)|((in[11]-in[10])<<30)),
		uint32((in[11]-in[10])>>2|((in[12]-in[11])<<24)),
		uint32((in[12]-in[11])>>8|((in[13]-in[12])<<18)),
		uint32((in[13]-in[12])>>14|((in[14]-in[13])<<12)),
		uint32((in[14]-in[13])>>20|((in[15]-in[14])<<6)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<26)),
		uint32((in[17]-in[16])>>6|((in[18]-in[17])<<20)),
		uint32((in[18]-in[17])>>12|((in[19]-in[18])<<14)),
		uint32((in[19]-in[18])>>18|((in[20]-in[19])<<8)),
		uint32((in[20]-in[19])>>24|((in[21]-in[20])<<2)|((in[22]-in[21])<<28)),
		uint32((in[22]-in[21])>>4|((in[23]-in[22])<<22)),
		uint32((in[23]-in[22])>>10|((in[24]-in[23])<<16)),
		uint32((in[24]-in[23])>>16|((in[25]-in[24])<<10)),
		uint32((in[25]-in[24])>>22|((in[26]-in[25])<<4)|((in[27]-in[26])<<30)),
		uint32((in[27]-in[26])>>2|((in[28]-in[27])<<24)),
		uint32((in[28]-in[27])>>8|((in[29]-in[28])<<18)),
		uint32((in[29]-in[28])>>14|((in[30]-in[29])<<12)),
...
func appendGroup32_27[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>15|((in[4]-in[3])<<12)),
		uint32((in[4]-in[3])>>20|((in[5]-in[4])<<7)),
		uint32((in[5]-in[4])>>25|((in[6]-in[5])<<2)|((in[7]-in[6])<<29)),
		uint32((in[7]-in[6])>>3|((in[8]-in[7])<<24)),
		uint32((in[8]-in[7])>>8|((in[9]-in[8])<<19)),
		uint32((in[9]-in[8])>>13|((in[10]-in[9])<<14)),
		uint32((in[10]-in[9])>>18|((in[11]-in[10])<<9)),
		uint32((in[11]-in[10])>>23|((in[12]-in[11])<<4)|((in[13]-in[12])<<31)),
		uint32((in[13]-in[12])>>1|((in[14]-in[13])<<26)),
		uint32((in[14]-in[13])>>6|((in[15]-in[14])<<21)),
		uint32((in[15]-in[14])>>11|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<11)),
		uint32((in[17]-in[16])>>21|((in[18]-in[17])<<6)),
		uint32((in[18]-in[17])>>26|((in[19]-in[18])<<1)|((in[20]-in[19])<<28)),
		uint32((in[20]-in[19])>>4|((in[21]-in[20])<<23)),
		uint32((in[21]-in[20])>>9|((in[22]-in[21])<<18)),
		uint32((in[22]-in[21])>>14|((in[23]-in[22])<<13)),
		uint32((in[23]-in[22])>>19|((in[24]-in[23])<<8)),
		uint32((in[24]-in[23])>>24|((in[25]-in[24])<<3)|((in[26]-in[25])<<30)),
		uint32((in[26]-in[25])>>2|((in[27]-in[26])<<25)),
		uint32((in[27]-in[26])>>7|((in[28]-in[27])<<20)),
		uint32((in[28]-in[27])>>12|((in[29]-in[28])<<15)),
		uint32((in[29]-in[28])>>17|((in[30]-in[29])<<10)),
...
func appendGroup32_28[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>12|((in[4]-in[3])<<16)),
		uint32((in[4]-in[3])>>16|((in[5]-in[4])<<12)),
		uint32((in[5]-in[4])>>20|((in[6]-in[5])<<8)),
		uint32((in[6]-in[5])>>24|((in[7]-in[6])<<4)),
		uint32(in[8]-in[7]|((in[9]-in[8])<<28)),
		uint32((in[9]-in[8])>>4|((in[10]-in[9])<<24)),
		uint32((in[10]-in[9])>>8|((in[11]-in[10])<<20)),
		uint32((in[11]-in[10])>>12|((in[12]-in[11])<<16)),
		uint32((in[12]-in[11])>>16|((in[13]-in[12])<<12)),
		uint32((in[13]-in[12])>>20|((in[14]-in[13])<<8)),
		uint32((in[14]-in[13])>>24|((in[15]-in[14])<<4)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<28)),
		uint32((in[17]-in[16])>>4|((in[18]-in[17])<<24)),
		uint32((in[18]-in[17])>>8|((in[19]-in[18])<<20)),
		uint32((in[19]-in[18])>>12|((in[20]-in[19])<<16)),
		uint32((in[20]-in[19])>>16|((in[21]-in[20])<<12)),
		uint32((in[21]-in[20])>>20|((in[22]-in[21])<<8)),
		uint32((in[22]-in[21])>>24|((in[23]-in[22])<<4)),
		uint32(in[24]-in[23]|((in[25]-in[24])<<28)),
		uint32((in[25]-in[24])>>4|((in[26]-in[25])<<24)),
		uint32((in[26]-in[25])>>8|((in[27]-in[26])<<20)),
		uint32((in[27]-in[26])>>12|((in[28]-in[27])<<16)),
		uint32((in[28]-in[27])>>16|((in[29]-in[28])<<12)),
		uint32((in[29]-in[28])>>20|((in[30]-in[29])<<8)),
...
func appendGroup32_29[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>9|((in[4]-in[3])<<20)),
		uint32((in[4]-in[3])>>12|((in[5]-in[4])<<17)),
		uint32((in[5]-in[4])>>15|((in[6]-in[5])<<14)),
		uint32((in[6]-in[5])>>18|((in[7]-in[6])<<11)),
		uint32((in[7]-in[6])>>21|((in[8]-in[7])<<8)),
		uint32((in[8]-in[7])>>24|((in[9]-in[8])<<5)),
		uint32((in[9]-in[8])>>27|((in[10]-in[9])<<2)|((in[11]-in[10])<<31)),
		uint32((in[11]-in[10])>>1|((in[12]-in[11])<<28)),
		uint32((in[12]-in[11])>>4|((in[13]-in[12])<<25)),
		uint32((in[13]-in[12])>>7|((in[14]-in[13])<<22)),
		uint32((in[14]-in[13])>>10|((in[15]-in[14])<<19)),
		uint32((in[15]-in[14])>>13|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<13)),
		uint32((in[17]-in[16])>>19|((in[18]-in[17])<<10)),
		uint32((in[18]-in[17])>>22|((in[19]-in[18])<<7)),
		uint32((in[19]-in[18])>>25|((in[20]-in[19])<<4)),
		uint32((in[20]-in[19])>>28|((in[21]-in[20])<<1)|((in[22]-in[21])<<30)),
		uint32((in[22]-in[21])>>2|((in[23]-in[22])<<27)),
		uint32((in[23]-in[22])>>5|((in[24]-in[23])<<24)),
		uint32((in[24]-in[23])>>8|((in[25]-in[24])<<21)),
		uint32((in[25]-in[24])>>11|((in[26]-in[25])<<18)),
		uint32((in[26]-in[25])>>14|((in[27]-in[26])<<15)),
		uint32((in[27]-in[26])>>17|((in[28]-in[27])<<12)),
		uint32((in[28]-in[27])>>20|((in[29]-in[28])<<9)),
		uint32((in[29]-in[28])>>23|((in[30]-in[29])<<6)),
...
func appendGroup32_30[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>6|((in[4]-in[3])<<24)),
		uint32((in[4]-in[3])>>8|((in[5]-in[4])<<22)),
		uint32((in[5]-in[4])>>10|((in[6]-in[5])<<20)),
		uint32((in[6]-in[5])>>12|((in[7]-in[6])<<18)),
		uint32((in[7]-in[6])>>14|((in[8]-in[7])<<16)),
		uint32((in[8]-in[7])>>16|((in[9]-in[8])<<14)),
		uint32((in[9]-in[8])>>18|((in[10]-in[9])<<12)),
		uint32((in[10]-in[9])>>20|((in[11]-in[10])<<10)),
		uint32((in[11]-in[10])>>22|((in[12]-in[11])<<8)),
		uint32((in[12]-in[11])>>24|((in[13]-in[12])<<6)),
		uint32((in[13]-in[12])>>26|((in[14]-in[13])<<4)),
		uint32((in[14]-in[13])>>28|((in[15]-in[14])<<2)),
		uint32(in[16]-in[15]|((in[17]-in[16])<<30)),
		uint32((in[17]-in[16])>>2|((in[18]-in[17])<<28)),
		uint32((in[18]-in[17])>>4|((in[19]-in[18])<<26)),
		uint32((in[19]-in[18])>>6|((in[20]-in[19])<<24)),
		uint32((in[20]-in[19])>>8|((in[21]-in[20])<<22)),
		uint32((in[21]-in[20])>>10|((in[22]-in[21])<<20)),
		uint32((in[22]-in[21])>>12|((in[23]-in[22])<<18)),
		uint32((in[23]-in[22])>>14|((in[24]-in[23])<<16)),
		uint32((in[24]-in[23])>>16|((in[25]-in[24])<<14)),
		uint32((in[25]-in[24])>>18|((in[26]-in[25])<<12)),
		uint32((in[26]-in[25])>>20|((in[27]-in[26])<<10)),
		uint32((in[27]-in[26])>>22|((in[28]-in[27])<<8)),
		uint32((in[28]-in[27])>>24|((in[29]-in[28])<<6)),
		uint32((in[29]-in[28])>>26|((in[30]-in[29])<<4)),
...
func appendGroup32_31[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((in[3]-in[2])>>3|((in[4]-in[3])<<28)),
		uint32((in[4]-in[3])>>4|((in[5]-in[4])<<27)),
		uint32((in[5]-in[4])>>5|((in[6]-in[5])<<26)),
		uint32((in[6]-in[5])>>6|((in[7]-in[6])<<25)),
		uint32((in[7]-in[6])>>7|((in[8]-in[7])<<24)),
		uint32((in[8]-in[7])>>8|((in[9]-in[8])<<23)),
		uint32((in[9]-in[8])>>9|((in[10]-in[9])<<22)),
		uint32((in[10]-in[9])>>10|((in[11]-in[10])<<21)),
		uint32((in[11]-in[10])>>11|((in[12]-in[11])<<20)),
		uint32((in[12]-in[11])>>12|((in[13]-in[12])<<19)),
		uint32((in[13]-in[12])>>13|((in[14]-in[13])<<18)),
		uint32((in[14]-in[13])>>14|((in[15]-in[14])<<17)),
		uint32((in[15]-in[14])>>15|((in[16]-in[15])<<16)),
		uint32((in[16]-in[15])>>16|((in[17]-in[16])<<15)),
		uint32((in[17]-in[16])>>17|((in[18]-in[17])<<14)),
		uint32((in[18]-in[17])>>18|((in[19]-in[18])<<13)),
		uint32((in[19]-in[18])>>19|((in[20]-in[19])<<12)),
		uint32((in[20]-in[19])>>20|((in[21]-in[20])<<11)),
		uint32((in[21]-in[20])>>21|((in[22]-in[21])<<10)),
		uint32((in[22]-in[21])>>22|((in[23]-in[22])<<9)),
		uint32((in[23]-in[22])>>23|((in[24]-in[23])<<8)),
		uint32((in[24]-in[23])>>24|((in[25]-in[24])<<7)),
		uint32((in[25]-in[24])>>25|((in[26]-in[25])<<6)),
		uint32((in[26]-in[25])>>26|((in[27]-in[26])<<5)),
		uint32((in[27]-in[26])>>27|((in[28]-in[27])<<4)),
		uint32((in[28]-in[27])>>28|((in[29]-in[28])<<3)),
		uint32((in[29]-in[28])>>29|((in[30]-in[29])<<2)),
		uint32((in[30]-in[29])>>30|((in[31]-in[30])<<1)))
}
...
// AppendGroupZigZag_int32 Binary packing of one block of `in`, starting from `initoffset`
...
func appendGroupZigZag32_5[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>1|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<4)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<9)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<14)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<19)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<29)),
...
func appendGroupZigZag32_6[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<6)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<12)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<18)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<24)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<30)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>2|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<4)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<10)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<22)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<28)),
...
func appendGroupZigZag32_7[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>5|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<2)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<9)|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<23)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<30)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>2|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<5)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<12)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<19)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<26)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>6|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<1)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<15)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<22)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<29)),
...
func appendGroupZigZag32_8[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<8)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<16)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<24)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<8)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<16)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<24)),
		uint32(((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<8)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<16)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<24)),
		uint32(((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<8)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<16)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<24)),
...
func appendGroupZigZag32_9[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>6|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<3)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<12)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<21)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<30)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>2|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<7)|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<25)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>7|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<2)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<11)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<20)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<29)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>3|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<6)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<15)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>8|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<1)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<10)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<19)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<28)),
...
func appendGroupZigZag32_10[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>6|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<4)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<14)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<24)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>8|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<2)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<12)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<22)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<10)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<20)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<30)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>2|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<8)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<18)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<28)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>4|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<6)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<26)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>6|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<4)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<14)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<24)),
...
func appendGroupZigZag32_11[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>8|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<3)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<14)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<25)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>7|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<4)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<15)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<26)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>6|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<5)|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<27)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>5|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<6)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<17)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<28)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>4|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<7)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<18)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<29)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>3|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<19)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<30)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>2|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<9)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<20)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<31)),
...
func appendGroupZigZag32_12[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<12)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<24)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>8|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<4)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<16)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<28)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>4|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<8)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<20)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<12)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<24)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>8|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<4)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<16)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<28)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>4|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<8)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<20)),
		uint32(((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<12)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<24)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>8|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<4)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<16)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<28)),
...
func appendGroupZigZag32_13[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>5|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<8)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<21)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>11|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<2)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<15)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<28)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>4|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<9)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<22)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>10|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<3)|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<29)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>3|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<10)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<23)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>9|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<4)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<17)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<30)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>2|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<11)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>8|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<5)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<18)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<31)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>1|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<12)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<25)),
...
func appendGroupZigZag32_14[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>12|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<2)|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<16)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<30)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>2|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<12)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<26)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>6|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<8)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<22)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>10|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<4)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<18)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<14)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<28)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>4|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<10)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<24)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>8|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<6)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<20)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>12|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<2)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<30)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>2|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<12)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<26)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>6|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<8)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<22)),
...
func appendGroupZigZag32_15[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>6|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<9)|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<24)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>8|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<7)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<22)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>10|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<5)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<20)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>12|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<3)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<18)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>14|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<1)|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<31)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>1|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<14)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<29)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>3|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<12)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<27)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>5|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<10)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<25)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>7|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<23)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>9|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<6)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<21)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>11|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<4)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<19)),
...
func appendGroupZigZag32_16[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31)|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<16)),
		uint32(((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<16)),
		uint32(((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<16)),
		uint32(((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<16)),
		uint32(((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<16)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<16)),
		uint32(((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<16)),
		uint32(((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<16)),
		uint32(((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<16)),
		uint32(((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<16)),
		uint32(((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<16)),
		uint32(((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<16)),
...
func appendGroupZigZag32_17[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>11|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<6)|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<23)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>9|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<8)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<25)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>7|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<10)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<27)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>5|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<12)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<29)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>3|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<14)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<31)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>1|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<1)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<18)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>14|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<3)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<20)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>12|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<5)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<22)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>10|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<7)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>8|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<9)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<26)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>6|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<11)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<28)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>4|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<13)|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<30)),
...
func appendGroupZigZag32_18[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>6|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<12)|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<30)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>2|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<16)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>16|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<2)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<20)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>12|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<6)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<24)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>8|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<10)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<28)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>4|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<14)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<18)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>14|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<4)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<22)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>10|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<8)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<26)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>6|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<12)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<30)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>2|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>16|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<2)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<20)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>12|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<6)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<24)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>8|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<10)|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<28)),
...
func appendGroupZigZag32_19[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>1|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<18)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>14|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<5)|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<24)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>8|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<11)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<30)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>2|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<17)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>15|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<4)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<23)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>9|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<10)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<29)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>3|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<3)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<22)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>10|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<9)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<28)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>4|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<15)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>17|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<2)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<21)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>11|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<27)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>5|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<14)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>18|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<1)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<20)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>12|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<7)|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<26)),
...
func appendGroupZigZag32_20[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>16|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<4)|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<24)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>8|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<12)),
		uint32(((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<20)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>12|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<8)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<28)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>4|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<16)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>16|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<4)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<24)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>8|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<12)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<20)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>12|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<8)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<28)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>4|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<16)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>16|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<4)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<24)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>8|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<12)),
		uint32(((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<20)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>12|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<8)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<28)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>4|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<16)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>16|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<4)|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<24)),
...
func appendGroupZigZag32_21[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>12|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<9)|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<30)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>2|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<19)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>13|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<8)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<29)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>3|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<18)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>14|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<7)|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<28)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>4|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<17)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>15|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<6)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<27)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>5|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<5)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<26)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>6|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<15)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>17|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<4)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<25)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>7|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<14)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>18|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<3)|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>8|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<13)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>19|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<2)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<23)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>9|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<12)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>20|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<1)|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<22)),
...
func appendGroupZigZag32_22[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>8|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<14)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>18|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<4)|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<26)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>6|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<16)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>16|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<6)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<28)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>4|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<18)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>14|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<8)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<30)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>2|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<20)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>12|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<10)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<22)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>10|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<12)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>20|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<2)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<24)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>8|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<14)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>18|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<4)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<26)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>6|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>16|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<6)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<28)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>4|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<18)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>14|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<8)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<30)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>2|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<20)),
...
func appendGroupZigZag32_23[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>4|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<19)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>13|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<10)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>22|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<1)|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<24)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>8|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<15)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>17|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<6)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<29)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>3|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<20)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>12|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<11)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>21|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<2)|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<25)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>7|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<7)|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<30)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>2|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<21)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>11|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<12)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>20|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<3)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<26)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>6|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<17)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>15|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<31)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>1|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<22)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>10|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<13)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>19|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<4)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<27)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>5|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<18)),
...
func appendGroupZigZag32_24[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32(((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31)|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<24)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>8|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<16)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>16|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<8)),
		uint32(((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<24)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>8|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<16)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>16|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<8)),
		uint32(((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<24)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>8|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<16)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>16|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<8)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<24)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>8|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<16)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>16|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<8)),
		uint32(((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31)|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<24)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>8|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<16)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>16|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<8)),
		uint32(((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<24)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>8|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<16)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>16|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<8)),
		uint32(((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31)|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<24)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>8|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<16)),
...
func appendGroupZigZag32_25[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>21|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<4)|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<29)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>3|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<22)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>10|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<15)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>17|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<8)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>24|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<1)|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<26)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>6|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<19)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>13|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<12)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>20|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<5)|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<30)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>2|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<23)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>9|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<9)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>23|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<2)|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<27)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>5|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<20)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>12|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<13)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>19|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<6)|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<31)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>1|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>8|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<17)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>15|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<10)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>22|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<3)|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<28)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>4|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<21)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>11|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<14)),
...
func appendGroupZigZag32_26[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>18|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<8)),
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>24|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<2)|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<28)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>4|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<22)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>10|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<16)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>16|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<10)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>22|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<4)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<30)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>2|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<24)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>8|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<18)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>14|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<12)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>20|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<6)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<26)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>6|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<20)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>12|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<14)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>18|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<8)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>24|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<2)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<28)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>4|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<22)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>10|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>16|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<10)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>22|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<4)|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<30)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>2|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<24)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>8|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<18)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>14|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<12)),
...
func appendGroupZigZag32_27[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>15|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<12)),
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>20|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<7)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>25|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<2)|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<29)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>3|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<24)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>8|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<19)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>13|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<14)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>18|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<9)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>23|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<4)|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<31)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>1|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<26)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>6|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<21)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>11|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<11)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>21|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<6)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>26|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<1)|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<28)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>4|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<23)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>9|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<18)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>14|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<13)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>19|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>24|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<3)|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<30)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>2|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<25)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>7|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<20)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>12|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<15)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>17|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<10)),
...
func appendGroupZigZag32_28[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>12|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<16)),
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>16|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<12)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>20|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<8)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>24|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<4)),
		uint32(((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31)|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<28)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>4|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<24)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>8|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<20)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>12|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<16)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>16|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<12)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>20|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<8)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>24|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<4)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<28)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>4|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<24)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>8|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<20)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>12|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<16)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>16|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<12)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>20|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<8)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>24|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<4)),
		uint32(((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31)|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<28)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>4|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<24)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>8|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<20)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>12|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<16)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>16|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<12)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>20|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<8)),
...
func appendGroupZigZag32_29[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>9|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<20)),
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>12|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<17)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>15|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<14)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>18|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<11)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>21|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<8)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>24|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<5)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>27|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<2)|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<31)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>1|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<28)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>4|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<25)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>7|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<22)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>10|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<19)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>13|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<13)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>19|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<10)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>22|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<7)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>25|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<4)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>28|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<1)|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<30)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>2|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<27)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>5|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<24)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>8|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<21)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>11|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<18)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>14|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<15)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>17|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<12)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>20|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<9)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>23|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<6)),
...
func appendGroupZigZag32_30[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>6|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<24)),
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>8|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<22)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>10|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<20)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>12|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<18)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>14|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<16)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>16|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<14)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>18|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<12)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>20|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<10)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>22|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<8)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>24|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<6)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>26|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<4)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>28|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<2)),
		uint32(((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31)|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<30)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>2|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<28)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>4|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<26)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>6|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<24)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>8|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<22)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>10|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<20)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>12|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<18)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>14|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<16)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>16|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<14)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>18|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<12)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>20|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<10)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>22|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<8)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>24|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<6)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>26|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<4)),
...
func appendGroupZigZag32_31[T uint32 | int32](dst []uint32, in *[32]T, initoffset T) []uint32 {
	return append(dst,
		...
		uint32((((int32(in[3]-in[2]))<<1)^((int32(in[3]-in[2]))>>31))>>3|((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))<<28)),
		uint32((((int32(in[4]-in[3]))<<1)^((int32(in[4]-in[3]))>>31))>>4|((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))<<27)),
		uint32((((int32(in[5]-in[4]))<<1)^((int32(in[5]-in[4]))>>31))>>5|((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))<<26)),
		uint32((((int32(in[6]-in[5]))<<1)^((int32(in[6]-in[5]))>>31))>>6|((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))<<25)),
		uint32((((int32(in[7]-in[6]))<<1)^((int32(in[7]-in[6]))>>31))>>7|((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))<<24)),
		uint32((((int32(in[8]-in[7]))<<1)^((int32(in[8]-in[7]))>>31))>>8|((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))<<23)),
		uint32((((int32(in[9]-in[8]))<<1)^((int32(in[9]-in[8]))>>31))>>9|((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))<<22)),
		uint32((((int32(in[10]-in[9]))<<1)^((int32(in[10]-in[9]))>>31))>>10|((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))<<21)),
		uint32((((int32(in[11]-in[10]))<<1)^((int32(in[11]-in[10]))>>31))>>11|((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))<<20)),
		uint32((((int32(in[12]-in[11]))<<1)^((int32(in[12]-in[11]))>>31))>>12|((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))<<19)),
		uint32((((int32(in[13]-in[12]))<<1)^((int32(in[13]-in[12]))>>31))>>13|((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))<<18)),
		uint32((((int32(in[14]-in[13]))<<1)^((int32(in[14]-in[13]))>>31))>>14|((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))<<17)),
		uint32((((int32(in[15]-in[14]))<<1)^((int32(in[15]-in[14]))>>31))>>15|((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))<<16)),
		uint32((((int32(in[16]-in[15]))<<1)^((int32(in[16]-in[15]))>>31))>>16|((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))<<15)),
		uint32((((int32(in[17]-in[16]))<<1)^((int32(in[17]-in[16]))>>31))>>17|((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))<<14)),
		uint32((((int32(in[18]-in[17]))<<1)^((int32(in[18]-in[17]))>>31))>>18|((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))<<13)),
		uint32((((int32(in[19]-in[18]))<<1)^((int32(in[19]-in[18]))>>31))>>19|((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))<<12)),
		uint32((((int32(in[20]-in[19]))<<1)^((int32(in[20]-in[19]))>>31))>>20|((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))<<11)),
		uint32((((int32(in[21]-in[20]))<<1)^((int32(in[21]-in[20]))>>31))>>21|((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))<<10)),
		uint32((((int32(in[22]-in[21]))<<1)^((int32(in[22]-in[21]))>>31))>>22|((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))<<9)),
		uint32((((int32(in[23]-in[22]))<<1)^((int32(in[23]-in[22]))>>31))>>23|((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))<<8)),
		uint32((((int32(in[24]-in[23]))<<1)^((int32(in[24]-in[23]))>>31))>>24|((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))<<7)),
		uint32((((int32(in[25]-in[24]))<<1)^((int32(in[25]-in[24]))>>31))>>25|((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))<<6)),
		uint32((((int32(in[26]-in[25]))<<1)^((int32(in[26]-in[25]))>>31))>>26|((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))<<5)),
		uint32((((int32(in[27]-in[26]))<<1)^((int32(in[27]-in[26]))>>31))>>27|((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))<<4)),
		uint32((((int32(in[28]-in[27]))<<1)^((int32(in[28]-in[27]))>>31))>>28|((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))<<3)),
		uint32((((int32(in[29]-in[28]))<<1)^((int32(in[29]-in[28]))>>31))>>29|((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))<<2)),
		uint32((((int32(in[30]-in[29]))<<1)^((int32(in[30]-in[29]))>>31))>>30|((((int32(in[31]-in[30]))<<1)^((int32(in[31]-in[30]))>>31))<<1)))
}
