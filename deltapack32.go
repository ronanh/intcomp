...
func deltaunpackzigzag32_1[T uint32 | int32](initoffset T, in *[1]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1)) & 1)) ^ ((int32((in[0] >> 0) & 0x1)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 1) & 0x1)) & 1)) ^ ((int32((in[0] >> 1) & 0x1)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 2) & 0x1)) & 1)) ^ ((int32((in[0] >> 2) & 0x1)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 3) & 0x1)) & 1)) ^ ((int32((in[0] >> 3) & 0x1)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[0] >> 4) & 0x1)) & 1)) ^ ((int32((in[0] >> 4) & 0x1)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[0] >> 5) & 0x1)) & 1)) ^ ((int32((in[0] >> 5) & 0x1)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[0] >> 6) & 0x1)) & 1)) ^ ((int32((in[0] >> 6) & 0x1)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[0] >> 7) & 0x1)) & 1)) ^ ((int32((in[0] >> 7) & 0x1)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[0] >> 8) & 0x1)) & 1)) ^ ((int32((in[0] >> 8) & 0x1)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[0] >> 9) & 0x1)) & 1)) ^ ((int32((in[0] >> 9) & 0x1)) >> 1))) + out[8]
	out[10] = T(((-((int32((in[0] >> 10) & 0x1)) & 1)) ^ ((int32((in[0] >> 10) & 0x1)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[0] >> 11) & 0x1)) & 1)) ^ ((int32((in[0] >> 11) & 0x1)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[0] >> 12) & 0x1)) & 1)) ^ ((int32((in[0] >> 12) & 0x1)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[0] >> 13) & 0x1)) & 1)) ^ ((int32((in[0] >> 13) & 0x1)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[0] >> 14) & 0x1)) & 1)) ^ ((int32((in[0] >> 14) & 0x1)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[0] >> 15) & 0x1)) & 1)) ^ ((int32((in[0] >> 15) & 0x1)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[0] >> 16) & 0x1)) & 1)) ^ ((int32((in[0] >> 16) & 0x1)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[0] >> 17) & 0x1)) & 1)) ^ ((int32((in[0] >> 17) & 0x1)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[0] >> 18) & 0x1)) & 1)) ^ ((int32((in[0] >> 18) & 0x1)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[0] >> 19) & 0x1)) & 1)) ^ ((int32((in[0] >> 19) & 0x1)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[0] >> 20) & 0x1)) & 1)) ^ ((int32((in[0] >> 20) & 0x1)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[0] >> 21) & 0x1)) & 1)) ^ ((int32((in[0] >> 21) & 0x1)) >> 1))) + out[20]
	out[22] = T(((-((int32((in[0] >> 22) & 0x1)) & 1)) ^ ((int32((in[0] >> 22) & 0x1)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[0] >> 23) & 0x1)) & 1)) ^ ((int32((in[0] >> 23) & 0x1)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[0] >> 24) & 0x1)) & 1)) ^ ((int32((in[0] >> 24) & 0x1)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[0] >> 25) & 0x1)) & 1)) ^ ((int32((in[0] >> 25) & 0x1)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[0] >> 26) & 0x1)) & 1)) ^ ((int32((in[0] >> 26) & 0x1)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[0] >> 27) & 0x1)) & 1)) ^ ((int32((in[0] >> 27) & 0x1)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[0] >> 28) & 0x1)) & 1)) ^ ((int32((in[0] >> 28) & 0x1)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[0] >> 29) & 0x1)) & 1)) ^ ((int32((in[0] >> 29) & 0x1)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[0] >> 30) & 0x1)) & 1)) ^ ((int32((in[0] >> 30) & 0x1)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[0] >> 31))) & 1)) ^ ((int32((in[0] >> 31))) >> 1))) + out[30]
}

func deltaunpackzigzag32_2[T uint32 | int32](initoffset T, in *[2]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3)) & 1)) ^ ((int32((in[0] >> 0) & 0x3)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 2) & 0x3)) & 1)) ^ ((int32((in[0] >> 2) & 0x3)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 4) & 0x3)) & 1)) ^ ((int32((in[0] >> 4) & 0x3)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 6) & 0x3)) & 1)) ^ ((int32((in[0] >> 6) & 0x3)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[0] >> 8) & 0x3)) & 1)) ^ ((int32((in[0] >> 8) & 0x3)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[0] >> 10) & 0x3)) & 1)) ^ ((int32((in[0] >> 10) & 0x3)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[0] >> 12) & 0x3)) & 1)) ^ ((int32((in[0] >> 12) & 0x3)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[0] >> 14) & 0x3)) & 1)) ^ ((int32((in[0] >> 14) & 0x3)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[0] >> 16) & 0x3)) & 1)) ^ ((int32((in[0] >> 16) & 0x3)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[0] >> 18) & 0x3)) & 1)) ^ ((int32((in[0] >> 18) & 0x3)) >> 1))) + out[8]
	out[10] = T(((-((int32((in[0] >> 20) & 0x3)) & 1)) ^ ((int32((in[0] >> 20) & 0x3)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[0] >> 22) & 0x3)) & 1)) ^ ((int32((in[0] >> 22) & 0x3)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[0] >> 24) & 0x3)) & 1)) ^ ((int32((in[0] >> 24) & 0x3)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[0] >> 26) & 0x3)) & 1)) ^ ((int32((in[0] >> 26) & 0x3)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[0] >> 28) & 0x3)) & 1)) ^ ((int32((in[0] >> 28) & 0x3)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[0] >> 30))) & 1)) ^ ((int32((in[0] >> 30))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[1] >> 0) & 0x3)) & 1)) ^ ((int32((in[1] >> 0) & 0x3)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[1] >> 2) & 0x3)) & 1)) ^ ((int32((in[1] >> 2) & 0x3)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[1] >> 4) & 0x3)) & 1)) ^ ((int32((in[1] >> 4) & 0x3)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[1] >> 6) & 0x3)) & 1)) ^ ((int32((in[1] >> 6) & 0x3)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[1] >> 8) & 0x3)) & 1)) ^ ((int32((in[1] >> 8) & 0x3)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[1] >> 10) & 0x3)) & 1)) ^ ((int32((in[1] >> 10) & 0x3)) >> 1))) + out[20]
	out[22] = T(((-((int32((in[1] >> 12) & 0x3)) & 1)) ^ ((int32((in[1] >> 12) & 0x3)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[1] >> 14) & 0x3)) & 1)) ^ ((int32((in[1] >> 14) & 0x3)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[1] >> 16) & 0x3)) & 1)) ^ ((int32((in[1] >> 16) & 0x3)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[1] >> 18) & 0x3)) & 1)) ^ ((int32((in[1] >> 18) & 0x3)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[1] >> 20) & 0x3)) & 1)) ^ ((int32((in[1] >> 20) & 0x3)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[1] >> 22) & 0x3)) & 1)) ^ ((int32((in[1] >> 22) & 0x3)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[1] >> 24) & 0x3)) & 1)) ^ ((int32((in[1] >> 24) & 0x3)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[1] >> 26) & 0x3)) & 1)) ^ ((int32((in[1] >> 26) & 0x3)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[1] >> 28) & 0x3)) & 1)) ^ ((int32((in[1] >> 28) & 0x3)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[1] >> 30))) & 1)) ^ ((int32((in[1] >> 30))) >> 1))) + out[30]
}

func deltaunpackzigzag32_3[T uint32 | int32](initoffset T, in *[3]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7)) & 1)) ^ ((int32((in[0] >> 0) & 0x7)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 3) & 0x7)) & 1)) ^ ((int32((in[0] >> 3) & 0x7)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 6) & 0x7)) & 1)) ^ ((int32((in[0] >> 6) & 0x7)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 9) & 0x7)) & 1)) ^ ((int32((in[0] >> 9) & 0x7)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[0] >> 12) & 0x7)) & 1)) ^ ((int32((in[0] >> 12) & 0x7)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[0] >> 15) & 0x7)) & 1)) ^ ((int32((in[0] >> 15) & 0x7)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[0] >> 18) & 0x7)) & 1)) ^ ((int32((in[0] >> 18) & 0x7)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[0] >> 21) & 0x7)) & 1)) ^ ((int32((in[0] >> 21) & 0x7)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[0] >> 24) & 0x7)) & 1)) ^ ((int32((in[0] >> 24) & 0x7)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[0] >> 27) & 0x7)) & 1)) ^ ((int32((in[0] >> 27) & 0x7)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[0] >> 30) | ((in[1] & 0x1) << 2)))) & 1)) ^ ((int32(((in[0] >> 30) | ((in[1] & 0x1) << 2)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[1] >> 1) & 0x7)) & 1)) ^ ((int32((in[1] >> 1) & 0x7)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[1] >> 4) & 0x7)) & 1)) ^ ((int32((in[1] >> 4) & 0x7)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[1] >> 7) & 0x7)) & 1)) ^ ((int32((in[1] >> 7) & 0x7)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[1] >> 10) & 0x7)) & 1)) ^ ((int32((in[1] >> 10) & 0x7)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[1] >> 13) & 0x7)) & 1)) ^ ((int32((in[1] >> 13) & 0x7)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[1] >> 16) & 0x7)) & 1)) ^ ((int32((in[1] >> 16) & 0x7)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[1] >> 19) & 0x7)) & 1)) ^ ((int32((in[1] >> 19) & 0x7)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[1] >> 22) & 0x7)) & 1)) ^ ((int32((in[1] >> 22) & 0x7)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[1] >> 25) & 0x7)) & 1)) ^ ((int32((in[1] >> 25) & 0x7)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[1] >> 28) & 0x7)) & 1)) ^ ((int32((in[1] >> 28) & 0x7)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[1] >> 31) | ((in[2] & 0x3) << 1)))) & 1)) ^ ((int32(((in[1] >> 31) | ((in[2] & 0x3) << 1)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[2] >> 2) & 0x7)) & 1)) ^ ((int32((in[2] >> 2) & 0x7)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[2] >> 5) & 0x7)) & 1)) ^ ((int32((in[2] >> 5) & 0x7)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[2] >> 8) & 0x7)) & 1)) ^ ((int32((in[2] >> 8) & 0x7)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[2] >> 11) & 0x7)) & 1)) ^ ((int32((in[2] >> 11) & 0x7)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[2] >> 14) & 0x7)) & 1)) ^ ((int32((in[2] >> 14) & 0x7)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[2] >> 17) & 0x7)) & 1)) ^ ((int32((in[2] >> 17) & 0x7)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[2] >> 20) & 0x7)) & 1)) ^ ((int32((in[2] >> 20) & 0x7)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[2] >> 23) & 0x7)) & 1)) ^ ((int32((in[2] >> 23) & 0x7)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[2] >> 26) & 0x7)) & 1)) ^ ((int32((in[2] >> 26) & 0x7)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[2] >> 29))) & 1)) ^ ((int32((in[2] >> 29))) >> 1))) + out[30]
}

func deltaunpackzigzag32_4[T uint32 | int32](initoffset T, in *[4]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xF)) & 1)) ^ ((int32((in[0] >> 0) & 0xF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 4) & 0xF)) & 1)) ^ ((int32((in[0] >> 4) & 0xF)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 8) & 0xF)) & 1)) ^ ((int32((in[0] >> 8) & 0xF)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 12) & 0xF)) & 1)) ^ ((int32((in[0] >> 12) & 0xF)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[0] >> 16) & 0xF)) & 1)) ^ ((int32((in[0] >> 16) & 0xF)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[0] >> 20) & 0xF)) & 1)) ^ ((int32((in[0] >> 20) & 0xF)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[0] >> 24) & 0xF)) & 1)) ^ ((int32((in[0] >> 24) & 0xF)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[0] >> 28))) & 1)) ^ ((int32((in[0] >> 28))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[1] >> 0) & 0xF)) & 1)) ^ ((int32((in[1] >> 0) & 0xF)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[1] >> 4) & 0xF)) & 1)) ^ ((int32((in[1] >> 4) & 0xF)) >> 1))) + out[8]
	out[10] = T(((-((int32((in[1] >> 8) & 0xF)) & 1)) ^ ((int32((in[1] >> 8) & 0xF)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[1] >> 12) & 0xF)) & 1)) ^ ((int32((in[1] >> 12) & 0xF)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[1] >> 16) & 0xF)) & 1)) ^ ((int32((in[1] >> 16) & 0xF)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[1] >> 20) & 0xF)) & 1)) ^ ((int32((in[1] >> 20) & 0xF)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[1] >> 24) & 0xF)) & 1)) ^ ((int32((in[1] >> 24) & 0xF)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[1] >> 28))) & 1)) ^ ((int32((in[1] >> 28))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[2] >> 0) & 0xF)) & 1)) ^ ((int32((in[2] >> 0) & 0xF)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[2] >> 4) & 0xF)) & 1)) ^ ((int32((in[2] >> 4) & 0xF)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[2] >> 8) & 0xF)) & 1)) ^ ((int32((in[2] >> 8) & 0xF)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[2] >> 12) & 0xF)) & 1)) ^ ((int32((in[2] >> 12) & 0xF)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[2] >> 16) & 0xF)) & 1)) ^ ((int32((in[2] >> 16) & 0xF)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[2] >> 20) & 0xF)) & 1)) ^ ((int32((in[2] >> 20) & 0xF)) >> 1))) + out[20]
	out[22] = T(((-((int32((in[2] >> 24) & 0xF)) & 1)) ^ ((int32((in[2] >> 24) & 0xF)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[2] >> 28))) & 1)) ^ ((int32((in[2] >> 28))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[3] >> 0) & 0xF)) & 1)) ^ ((int32((in[3] >> 0) & 0xF)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[3] >> 4) & 0xF)) & 1)) ^ ((int32((in[3] >> 4) & 0xF)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[3] >> 8) & 0xF)) & 1)) ^ ((int32((in[3] >> 8) & 0xF)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[3] >> 12) & 0xF)) & 1)) ^ ((int32((in[3] >> 12) & 0xF)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[3] >> 16) & 0xF)) & 1)) ^ ((int32((in[3] >> 16) & 0xF)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[3] >> 20) & 0xF)) & 1)) ^ ((int32((in[3] >> 20) & 0xF)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[3] >> 24) & 0xF)) & 1)) ^ ((int32((in[3] >> 24) & 0xF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[3] >> 28))) & 1)) ^ ((int32((in[3] >> 28))) >> 1))) + out[30]
}

func deltaunpackzigzag32_5[T uint32 | int32](initoffset T, in *[5]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1F)) & 1)) ^ ((int32((in[0] >> 0) & 0x1F)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 5) & 0x1F)) & 1)) ^ ((int32((in[0] >> 5) & 0x1F)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 10) & 0x1F)) & 1)) ^ ((int32((in[0] >> 10) & 0x1F)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 15) & 0x1F)) & 1)) ^ ((int32((in[0] >> 15) & 0x1F)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[0] >> 20) & 0x1F)) & 1)) ^ ((int32((in[0] >> 20) & 0x1F)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[0] >> 25) & 0x1F)) & 1)) ^ ((int32((in[0] >> 25) & 0x1F)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[0] >> 30) | ((in[1] & 0x7) << 2)))) & 1)) ^ ((int32(((in[0] >> 30) | ((in[1] & 0x7) << 2)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[1] >> 3) & 0x1F)) & 1)) ^ ((int32((in[1] >> 3) & 0x1F)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[1] >> 8) & 0x1F)) & 1)) ^ ((int32((in[1] >> 8) & 0x1F)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[1] >> 13) & 0x1F)) & 1)) ^ ((int32((in[1] >> 13) & 0x1F)) >> 1))) + out[8]
	out[10] = T(((-((int32((in[1] >> 18) & 0x1F)) & 1)) ^ ((int32((in[1] >> 18) & 0x1F)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[1] >> 23) & 0x1F)) & 1)) ^ ((int32((in[1] >> 23) & 0x1F)) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0x1) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0x1) << 4)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[2] >> 1) & 0x1F)) & 1)) ^ ((int32((in[2] >> 1) & 0x1F)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[2] >> 6) & 0x1F)) & 1)) ^ ((int32((in[2] >> 6) & 0x1F)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[2] >> 11) & 0x1F)) & 1)) ^ ((int32((in[2] >> 11) & 0x1F)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[2] >> 16) & 0x1F)) & 1)) ^ ((int32((in[2] >> 16) & 0x1F)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[2] >> 21) & 0x1F)) & 1)) ^ ((int32((in[2] >> 21) & 0x1F)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[2] >> 26) & 0x1F)) & 1)) ^ ((int32((in[2] >> 26) & 0x1F)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[2] >> 31) | ((in[3] & 0xF) << 1)))) & 1)) ^ ((int32(((in[2] >> 31) | ((in[3] & 0xF) << 1)))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[3] >> 4) & 0x1F)) & 1)) ^ ((int32((in[3] >> 4) & 0x1F)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[3] >> 9) & 0x1F)) & 1)) ^ ((int32((in[3] >> 9) & 0x1F)) >> 1))) + out[20]
	out[22] = T(((-((int32((in[3] >> 14) & 0x1F)) & 1)) ^ ((int32((in[3] >> 14) & 0x1F)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[3] >> 19) & 0x1F)) & 1)) ^ ((int32((in[3] >> 19) & 0x1F)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[3] >> 24) & 0x1F)) & 1)) ^ ((int32((in[3] >> 24) & 0x1F)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[3] >> 29) | ((in[4] & 0x3) << 3)))) & 1)) ^ ((int32(((in[3] >> 29) | ((in[4] & 0x3) << 3)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[4] >> 2) & 0x1F)) & 1)) ^ ((int32((in[4] >> 2) & 0x1F)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[4] >> 7) & 0x1F)) & 1)) ^ ((int32((in[4] >> 7) & 0x1F)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[4] >> 12) & 0x1F)) & 1)) ^ ((int32((in[4] >> 12) & 0x1F)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[4] >> 17) & 0x1F)) & 1)) ^ ((int32((in[4] >> 17) & 0x1F)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[4] >> 22) & 0x1F)) & 1)) ^ ((int32((in[4] >> 22) & 0x1F)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[4] >> 27))) & 1)) ^ ((int32((in[4] >> 27))) >> 1))) + out[30]
}

func deltaunpackzigzag32_6[T uint32 | int32](initoffset T, in *[6]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3F)) & 1)) ^ ((int32((in[0] >> 0) & 0x3F)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 6) & 0x3F)) & 1)) ^ ((int32((in[0] >> 6) & 0x3F)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 12) & 0x3F)) & 1)) ^ ((int32((in[0] >> 12) & 0x3F)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 18) & 0x3F)) & 1)) ^ ((int32((in[0] >> 18) & 0x3F)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[0] >> 24) & 0x3F)) & 1)) ^ ((int32((in[0] >> 24) & 0x3F)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[0] >> 30) | ((in[1] & 0xF) << 2)))) & 1)) ^ ((int32(((in[0] >> 30) | ((in[1] & 0xF) << 2)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[1] >> 4) & 0x3F)) & 1)) ^ ((int32((in[1] >> 4) & 0x3F)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[1] >> 10) & 0x3F)) & 1)) ^ ((int32((in[1] >> 10) & 0x3F)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[1] >> 16) & 0x3F)) & 1)) ^ ((int32((in[1] >> 16) & 0x3F)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[1] >> 22) & 0x3F)) & 1)) ^ ((int32((in[1] >> 22) & 0x3F)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0x3) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0x3) << 4)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[2] >> 2) & 0x3F)) & 1)) ^ ((int32((in[2] >> 2) & 0x3F)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[2] >> 8) & 0x3F)) & 1)) ^ ((int32((in[2] >> 8) & 0x3F)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[2] >> 14) & 0x3F)) & 1)) ^ ((int32((in[2] >> 14) & 0x3F)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[2] >> 20) & 0x3F)) & 1)) ^ ((int32((in[2] >> 20) & 0x3F)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[2] >> 26))) & 1)) ^ ((int32((in[2] >> 26))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[3] >> 0) & 0x3F)) & 1)) ^ ((int32((in[3] >> 0) & 0x3F)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[3] >> 6) & 0x3F)) & 1)) ^ ((int32((in[3] >> 6) & 0x3F)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[3] >> 12) & 0x3F)) & 1)) ^ ((int32((in[3] >> 12) & 0x3F)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[3] >> 18) & 0x3F)) & 1)) ^ ((int32((in[3] >> 18) & 0x3F)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[3] >> 24) & 0x3F)) & 1)) ^ ((int32((in[3] >> 24) & 0x3F)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[3] >> 30) | ((in[4] & 0xF) << 2)))) & 1)) ^ ((int32(((in[3] >> 30) | ((in[4] & 0xF) << 2)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[4] >> 4) & 0x3F)) & 1)) ^ ((int32((in[4] >> 4) & 0x3F)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[4] >> 10) & 0x3F)) & 1)) ^ ((int32((in[4] >> 10) & 0x3F)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[4] >> 16) & 0x3F)) & 1)) ^ ((int32((in[4] >> 16) & 0x3F)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[4] >> 22) & 0x3F)) & 1)) ^ ((int32((in[4] >> 22) & 0x3F)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[4] >> 28) | ((in[5] & 0x3) << 4)))) & 1)) ^ ((int32(((in[4] >> 28) | ((in[5] & 0x3) << 4)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[5] >> 2) & 0x3F)) & 1)) ^ ((int32((in[5] >> 2) & 0x3F)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[5] >> 8) & 0x3F)) & 1)) ^ ((int32((in[5] >> 8) & 0x3F)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[5] >> 14) & 0x3F)) & 1)) ^ ((int32((in[5] >> 14) & 0x3F)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[5] >> 20) & 0x3F)) & 1)) ^ ((int32((in[5] >> 20) & 0x3F)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[5] >> 26))) & 1)) ^ ((int32((in[5] >> 26))) >> 1))) + out[30]
}

func deltaunpackzigzag32_7[T uint32 | int32](initoffset T, in *[7]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7F)) & 1)) ^ ((int32((in[0] >> 0) & 0x7F)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 7) & 0x7F)) & 1)) ^ ((int32((in[0] >> 7) & 0x7F)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 14) & 0x7F)) & 1)) ^ ((int32((in[0] >> 14) & 0x7F)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 21) & 0x7F)) & 1)) ^ ((int32((in[0] >> 21) & 0x7F)) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[0] >> 28) | ((in[1] & 0x7) << 4)))) & 1)) ^ ((int32(((in[0] >> 28) | ((in[1] & 0x7) << 4)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[1] >> 3) & 0x7F)) & 1)) ^ ((int32((in[1] >> 3) & 0x7F)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[1] >> 10) & 0x7F)) & 1)) ^ ((int32((in[1] >> 10) & 0x7F)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[1] >> 17) & 0x7F)) & 1)) ^ ((int32((in[1] >> 17) & 0x7F)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[1] >> 24) & 0x7F)) & 1)) ^ ((int32((in[1] >> 24) & 0x7F)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[1] >> 31) | ((in[2] & 0x3F) << 1)))) & 1)) ^ ((int32(((in[1] >> 31) | ((in[2] & 0x3F) << 1)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[2] >> 6) & 0x7F)) & 1)) ^ ((int32((in[2] >> 6) & 0x7F)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[2] >> 13) & 0x7F)) & 1)) ^ ((int32((in[2] >> 13) & 0x7F)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[2] >> 20) & 0x7F)) & 1)) ^ ((int32((in[2] >> 20) & 0x7F)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[2] >> 27) | ((in[3] & 0x3) << 5)))) & 1)) ^ ((int32(((in[2] >> 27) | ((in[3] & 0x3) << 5)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[3] >> 2) & 0x7F)) & 1)) ^ ((int32((in[3] >> 2) & 0x7F)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[3] >> 9) & 0x7F)) & 1)) ^ ((int32((in[3] >> 9) & 0x7F)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[3] >> 16) & 0x7F)) & 1)) ^ ((int32((in[3] >> 16) & 0x7F)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[3] >> 23) & 0x7F)) & 1)) ^ ((int32((in[3] >> 23) & 0x7F)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[3] >> 30) | ((in[4] & 0x1F) << 2)))) & 1)) ^ ((int32(((in[3] >> 30) | ((in[4] & 0x1F) << 2)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[4] >> 5) & 0x7F)) & 1)) ^ ((int32((in[4] >> 5) & 0x7F)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[4] >> 12) & 0x7F)) & 1)) ^ ((int32((in[4] >> 12) & 0x7F)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[4] >> 19) & 0x7F)) & 1)) ^ ((int32((in[4] >> 19) & 0x7F)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[4] >> 26) | ((in[5] & 0x1) << 6)))) & 1)) ^ ((int32(((in[4] >> 26) | ((in[5] & 0x1) << 6)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[5] >> 1) & 0x7F)) & 1)) ^ ((int32((in[5] >> 1) & 0x7F)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[5] >> 8) & 0x7F)) & 1)) ^ ((int32((in[5] >> 8) & 0x7F)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[5] >> 15) & 0x7F)) & 1)) ^ ((int32((in[5] >> 15) & 0x7F)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[5] >> 22) & 0x7F)) & 1)) ^ ((int32((in[5] >> 22) & 0x7F)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[5] >> 29) | ((in[6] & 0xF) << 3)))) & 1)) ^ ((int32(((in[5] >> 29) | ((in[6] & 0xF) << 3)))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[6] >> 4) & 0x7F)) & 1)) ^ ((int32((in[6] >> 4) & 0x7F)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[6] >> 11) & 0x7F)) & 1)) ^ ((int32((in[6] >> 11) & 0x7F)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[6] >> 18) & 0x7F)) & 1)) ^ ((int32((in[6] >> 18) & 0x7F)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[6] >> 25))) & 1)) ^ ((int32((in[6] >> 25))) >> 1))) + out[30]
}

func deltaunpackzigzag32_8[T uint32 | int32](initoffset T, in *[8]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xFF)) & 1)) ^ ((int32((in[0] >> 0) & 0xFF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 8) & 0xFF)) & 1)) ^ ((int32((in[0] >> 8) & 0xFF)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 16) & 0xFF)) & 1)) ^ ((int32((in[0] >> 16) & 0xFF)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[0] >> 24))) & 1)) ^ ((int32((in[0] >> 24))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[1] >> 0) & 0xFF)) & 1)) ^ ((int32((in[1] >> 0) & 0xFF)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[1] >> 8) & 0xFF)) & 1)) ^ ((int32((in[1] >> 8) & 0xFF)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[1] >> 16) & 0xFF)) & 1)) ^ ((int32((in[1] >> 16) & 0xFF)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[1] >> 24))) & 1)) ^ ((int32((in[1] >> 24))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[2] >> 0) & 0xFF)) & 1)) ^ ((int32((in[2] >> 0) & 0xFF)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[2] >> 8) & 0xFF)) & 1)) ^ ((int32((in[2] >> 8) & 0xFF)) >> 1))) + out[8]
	out[10] = T(((-((int32((in[2] >> 16) & 0xFF)) & 1)) ^ ((int32((in[2] >> 16) & 0xFF)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[2] >> 24))) & 1)) ^ ((int32((in[2] >> 24))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[3] >> 0) & 0xFF)) & 1)) ^ ((int32((in[3] >> 0) & 0xFF)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[3] >> 8) & 0xFF)) & 1)) ^ ((int32((in[3] >> 8) & 0xFF)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[3] >> 16) & 0xFF)) & 1)) ^ ((int32((in[3] >> 16) & 0xFF)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[3] >> 24))) & 1)) ^ ((int32((in[3] >> 24))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[4] >> 0) & 0xFF)) & 1)) ^ ((int32((in[4] >> 0) & 0xFF)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[4] >> 8) & 0xFF)) & 1)) ^ ((int32((in[4] >> 8) & 0xFF)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[4] >> 16) & 0xFF)) & 1)) ^ ((int32((in[4] >> 16) & 0xFF)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[4] >> 24))) & 1)) ^ ((int32((in[4] >> 24))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[5] >> 0) & 0xFF)) & 1)) ^ ((int32((in[5] >> 0) & 0xFF)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[5] >> 8) & 0xFF)) & 1)) ^ ((int32((in[5] >> 8) & 0xFF)) >> 1))) + out[20]
	out[22] = T(((-((int32((in[5] >> 16) & 0xFF)) & 1)) ^ ((int32((in[5] >> 16) & 0xFF)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[5] >> 24))) & 1)) ^ ((int32((in[5] >> 24))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[6] >> 0) & 0xFF)) & 1)) ^ ((int32((in[6] >> 0) & 0xFF)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[6] >> 8) & 0xFF)) & 1)) ^ ((int32((in[6] >> 8) & 0xFF)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[6] >> 16) & 0xFF)) & 1)) ^ ((int32((in[6] >> 16) & 0xFF)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[6] >> 24))) & 1)) ^ ((int32((in[6] >> 24))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[7] >> 0) & 0xFF)) & 1)) ^ ((int32((in[7] >> 0) & 0xFF)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[7] >> 8) & 0xFF)) & 1)) ^ ((int32((in[7] >> 8) & 0xFF)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[7] >> 16) & 0xFF)) & 1)) ^ ((int32((in[7] >> 16) & 0xFF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[7] >> 24))) & 1)) ^ ((int32((in[7] >> 24))) >> 1))) + out[30]
}

func deltaunpackzigzag32_9[T uint32 | int32](initoffset T, in *[9]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1FF)) & 1)) ^ ((int32((in[0] >> 0) & 0x1FF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 9) & 0x1FF)) & 1)) ^ ((int32((in[0] >> 9) & 0x1FF)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 18) & 0x1FF)) & 1)) ^ ((int32((in[0] >> 18) & 0x1FF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[0] >> 27) | ((in[1] & 0xF) << 5)))) & 1)) ^ ((int32(((in[0] >> 27) | ((in[1] & 0xF) << 5)))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[1] >> 4) & 0x1FF)) & 1)) ^ ((int32((in[1] >> 4) & 0x1FF)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[1] >> 13) & 0x1FF)) & 1)) ^ ((int32((in[1] >> 13) & 0x1FF)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[1] >> 22) & 0x1FF)) & 1)) ^ ((int32((in[1] >> 22) & 0x1FF)) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[1] >> 31) | ((in[2] & 0xFF) << 1)))) & 1)) ^ ((int32(((in[1] >> 31) | ((in[2] & 0xFF) << 1)))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[2] >> 8) & 0x1FF)) & 1)) ^ ((int32((in[2] >> 8) & 0x1FF)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[2] >> 17) & 0x1FF)) & 1)) ^ ((int32((in[2] >> 17) & 0x1FF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[2] >> 26) | ((in[3] & 0x7) << 6)))) & 1)) ^ ((int32(((in[2] >> 26) | ((in[3] & 0x7) << 6)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[3] >> 3) & 0x1FF)) & 1)) ^ ((int32((in[3] >> 3) & 0x1FF)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[3] >> 12) & 0x1FF)) & 1)) ^ ((int32((in[3] >> 12) & 0x1FF)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[3] >> 21) & 0x1FF)) & 1)) ^ ((int32((in[3] >> 21) & 0x1FF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[3] >> 30) | ((in[4] & 0x7F) << 2)))) & 1)) ^ ((int32(((in[3] >> 30) | ((in[4] & 0x7F) << 2)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[4] >> 7) & 0x1FF)) & 1)) ^ ((int32((in[4] >> 7) & 0x1FF)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[4] >> 16) & 0x1FF)) & 1)) ^ ((int32((in[4] >> 16) & 0x1FF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[4] >> 25) | ((in[5] & 0x3) << 7)))) & 1)) ^ ((int32(((in[4] >> 25) | ((in[5] & 0x3) << 7)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[5] >> 2) & 0x1FF)) & 1)) ^ ((int32((in[5] >> 2) & 0x1FF)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[5] >> 11) & 0x1FF)) & 1)) ^ ((int32((in[5] >> 11) & 0x1FF)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[5] >> 20) & 0x1FF)) & 1)) ^ ((int32((in[5] >> 20) & 0x1FF)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[5] >> 29) | ((in[6] & 0x3F) << 3)))) & 1)) ^ ((int32(((in[5] >> 29) | ((in[6] & 0x3F) << 3)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[6] >> 6) & 0x1FF)) & 1)) ^ ((int32((in[6] >> 6) & 0x1FF)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[6] >> 15) & 0x1FF)) & 1)) ^ ((int32((in[6] >> 15) & 0x1FF)) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[6] >> 24) | ((in[7] & 0x1) << 8)))) & 1)) ^ ((int32(((in[6] >> 24) | ((in[7] & 0x1) << 8)))) >> 1))) + out[23]
	out[25] = T(((-((int32((in[7] >> 1) & 0x1FF)) & 1)) ^ ((int32((in[7] >> 1) & 0x1FF)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[7] >> 10) & 0x1FF)) & 1)) ^ ((int32((in[7] >> 10) & 0x1FF)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[7] >> 19) & 0x1FF)) & 1)) ^ ((int32((in[7] >> 19) & 0x1FF)) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[7] >> 28) | ((in[8] & 0x1F) << 4)))) & 1)) ^ ((int32(((in[7] >> 28) | ((in[8] & 0x1F) << 4)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[8] >> 5) & 0x1FF)) & 1)) ^ ((int32((in[8] >> 5) & 0x1FF)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[8] >> 14) & 0x1FF)) & 1)) ^ ((int32((in[8] >> 14) & 0x1FF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[8] >> 23))) & 1)) ^ ((int32((in[8] >> 23))) >> 1))) + out[30]
}

func deltaunpackzigzag32_10[T uint32 | int32](initoffset T, in *[10]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3FF)) & 1)) ^ ((int32((in[0] >> 0) & 0x3FF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 10) & 0x3FF)) & 1)) ^ ((int32((in[0] >> 10) & 0x3FF)) >> 1))) + out[0]
	out[2] = T(((-((int32((in[0] >> 20) & 0x3FF)) & 1)) ^ ((int32((in[0] >> 20) & 0x3FF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[0] >> 30) | ((in[1] & 0xFF) << 2)))) & 1)) ^ ((int32(((in[0] >> 30) | ((in[1] & 0xFF) << 2)))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[1] >> 8) & 0x3FF)) & 1)) ^ ((int32((in[1] >> 8) & 0x3FF)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[1] >> 18) & 0x3FF)) & 1)) ^ ((int32((in[1] >> 18) & 0x3FF)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0x3F) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0x3F) << 4)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[2] >> 6) & 0x3FF)) & 1)) ^ ((int32((in[2] >> 6) & 0x3FF)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[2] >> 16) & 0x3FF)) & 1)) ^ ((int32((in[2] >> 16) & 0x3FF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[2] >> 26) | ((in[3] & 0xF) << 6)))) & 1)) ^ ((int32(((in[2] >> 26) | ((in[3] & 0xF) << 6)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[3] >> 4) & 0x3FF)) & 1)) ^ ((int32((in[3] >> 4) & 0x3FF)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[3] >> 14) & 0x3FF)) & 1)) ^ ((int32((in[3] >> 14) & 0x3FF)) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[3] >> 24) | ((in[4] & 0x3) << 8)))) & 1)) ^ ((int32(((in[3] >> 24) | ((in[4] & 0x3) << 8)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[4] >> 2) & 0x3FF)) & 1)) ^ ((int32((in[4] >> 2) & 0x3FF)) >> 1))) + out[12]
	out[14] = T(((-((int32((in[4] >> 12) & 0x3FF)) & 1)) ^ ((int32((in[4] >> 12) & 0x3FF)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[4] >> 22))) & 1)) ^ ((int32((in[4] >> 22))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[5] >> 0) & 0x3FF)) & 1)) ^ ((int32((in[5] >> 0) & 0x3FF)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[5] >> 10) & 0x3FF)) & 1)) ^ ((int32((in[5] >> 10) & 0x3FF)) >> 1))) + out[16]
	out[18] = T(((-((int32((in[5] >> 20) & 0x3FF)) & 1)) ^ ((int32((in[5] >> 20) & 0x3FF)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[5] >> 30) | ((in[6] & 0xFF) << 2)))) & 1)) ^ ((int32(((in[5] >> 30) | ((in[6] & 0xFF) << 2)))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[6] >> 8) & 0x3FF)) & 1)) ^ ((int32((in[6] >> 8) & 0x3FF)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[6] >> 18) & 0x3FF)) & 1)) ^ ((int32((in[6] >> 18) & 0x3FF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[6] >> 28) | ((in[7] & 0x3F) << 4)))) & 1)) ^ ((int32(((in[6] >> 28) | ((in[7] & 0x3F) << 4)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[7] >> 6) & 0x3FF)) & 1)) ^ ((int32((in[7] >> 6) & 0x3FF)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[7] >> 16) & 0x3FF)) & 1)) ^ ((int32((in[7] >> 16) & 0x3FF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[7] >> 26) | ((in[8] & 0xF) << 6)))) & 1)) ^ ((int32(((in[7] >> 26) | ((in[8] & 0xF) << 6)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[8] >> 4) & 0x3FF)) & 1)) ^ ((int32((in[8] >> 4) & 0x3FF)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[8] >> 14) & 0x3FF)) & 1)) ^ ((int32((in[8] >> 14) & 0x3FF)) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[8] >> 24) | ((in[9] & 0x3) << 8)))) & 1)) ^ ((int32(((in[8] >> 24) | ((in[9] & 0x3) << 8)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[9] >> 2) & 0x3FF)) & 1)) ^ ((int32((in[9] >> 2) & 0x3FF)) >> 1))) + out[28]
	out[30] = T(((-((int32((in[9] >> 12) & 0x3FF)) & 1)) ^ ((int32((in[9] >> 12) & 0x3FF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[9] >> 22))) & 1)) ^ ((int32((in[9] >> 22))) >> 1))) + out[30]
}

func deltaunpackzigzag32_11[T uint32 | int32](initoffset T, in *[11]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7FF)) & 1)) ^ ((int32((in[0] >> 0) & 0x7FF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 11) & 0x7FF)) & 1)) ^ ((int32((in[0] >> 11) & 0x7FF)) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[0] >> 22) | ((in[1] & 0x1) << 10)))) & 1)) ^ ((int32(((in[0] >> 22) | ((in[1] & 0x1) << 10)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[1] >> 1) & 0x7FF)) & 1)) ^ ((int32((in[1] >> 1) & 0x7FF)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[1] >> 12) & 0x7FF)) & 1)) ^ ((int32((in[1] >> 12) & 0x7FF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[1] >> 23) | ((in[2] & 0x3) << 9)))) & 1)) ^ ((int32(((in[1] >> 23) | ((in[2] & 0x3) << 9)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[2] >> 2) & 0x7FF)) & 1)) ^ ((int32((in[2] >> 2) & 0x7FF)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[2] >> 13) & 0x7FF)) & 1)) ^ ((int32((in[2] >> 13) & 0x7FF)) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[2] >> 24) | ((in[3] & 0x7) << 8)))) & 1)) ^ ((int32(((in[2] >> 24) | ((in[3] & 0x7) << 8)))) >> 1))) + out[7]
	out[9] = T(((-((int32((in[3] >> 3) & 0x7FF)) & 1)) ^ ((int32((in[3] >> 3) & 0x7FF)) >> 1))) + out[8]
	out[10] = T(((-((int32((in[3] >> 14) & 0x7FF)) & 1)) ^ ((int32((in[3] >> 14) & 0x7FF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[3] >> 25) | ((in[4] & 0xF) << 7)))) & 1)) ^ ((int32(((in[3] >> 25) | ((in[4] & 0xF) << 7)))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[4] >> 4) & 0x7FF)) & 1)) ^ ((int32((in[4] >> 4) & 0x7FF)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[4] >> 15) & 0x7FF)) & 1)) ^ ((int32((in[4] >> 15) & 0x7FF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[4] >> 26) | ((in[5] & 0x1F) << 6)))) & 1)) ^ ((int32(((in[4] >> 26) | ((in[5] & 0x1F) << 6)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[5] >> 5) & 0x7FF)) & 1)) ^ ((int32((in[5] >> 5) & 0x7FF)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[5] >> 16) & 0x7FF)) & 1)) ^ ((int32((in[5] >> 16) & 0x7FF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[5] >> 27) | ((in[6] & 0x3F) << 5)))) & 1)) ^ ((int32(((in[5] >> 27) | ((in[6] & 0x3F) << 5)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[6] >> 6) & 0x7FF)) & 1)) ^ ((int32((in[6] >> 6) & 0x7FF)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[6] >> 17) & 0x7FF)) & 1)) ^ ((int32((in[6] >> 17) & 0x7FF)) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[6] >> 28) | ((in[7] & 0x7F) << 4)))) & 1)) ^ ((int32(((in[6] >> 28) | ((in[7] & 0x7F) << 4)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[7] >> 7) & 0x7FF)) & 1)) ^ ((int32((in[7] >> 7) & 0x7FF)) >> 1))) + out[20]
	out[22] = T(((-((int32((in[7] >> 18) & 0x7FF)) & 1)) ^ ((int32((in[7] >> 18) & 0x7FF)) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[7] >> 29) | ((in[8] & 0xFF) << 3)))) & 1)) ^ ((int32(((in[7] >> 29) | ((in[8] & 0xFF) << 3)))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[8] >> 8) & 0x7FF)) & 1)) ^ ((int32((in[8] >> 8) & 0x7FF)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[8] >> 19) & 0x7FF)) & 1)) ^ ((int32((in[8] >> 19) & 0x7FF)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[8] >> 30) | ((in[9] & 0x1FF) << 2)))) & 1)) ^ ((int32(((in[8] >> 30) | ((in[9] & 0x1FF) << 2)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[9] >> 9) & 0x7FF)) & 1)) ^ ((int32((in[9] >> 9) & 0x7FF)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[9] >> 20) & 0x7FF)) & 1)) ^ ((int32((in[9] >> 20) & 0x7FF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[9] >> 31) | ((in[10] & 0x3FF) << 1)))) & 1)) ^ ((int32(((in[9] >> 31) | ((in[10] & 0x3FF) << 1)))) >> 1))) + out[28]
	out[30] = T(((-((int32((in[10] >> 10) & 0x7FF)) & 1)) ^ ((int32((in[10] >> 10) & 0x7FF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[10] >> 21))) & 1)) ^ ((int32((in[10] >> 21))) >> 1))) + out[30]
}

func deltaunpackzigzag32_12[T uint32 | int32](initoffset T, in *[12]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0xFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 12) & 0xFFF)) & 1)) ^ ((int32((in[0] >> 12) & 0xFFF)) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[0] >> 24) | ((in[1] & 0xF) << 8)))) & 1)) ^ ((int32(((in[0] >> 24) | ((in[1] & 0xF) << 8)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[1] >> 4) & 0xFFF)) & 1)) ^ ((int32((in[1] >> 4) & 0xFFF)) >> 1))) + out[2]
	out[4] = T(((-((int32((in[1] >> 16) & 0xFFF)) & 1)) ^ ((int32((in[1] >> 16) & 0xFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0xFF) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0xFF) << 4)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[2] >> 8) & 0xFFF)) & 1)) ^ ((int32((in[2] >> 8) & 0xFFF)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[2] >> 20))) & 1)) ^ ((int32((in[2] >> 20))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[3] >> 0) & 0xFFF)) & 1)) ^ ((int32((in[3] >> 0) & 0xFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[3] >> 12) & 0xFFF)) & 1)) ^ ((int32((in[3] >> 12) & 0xFFF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[3] >> 24) | ((in[4] & 0xF) << 8)))) & 1)) ^ ((int32(((in[3] >> 24) | ((in[4] & 0xF) << 8)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[4] >> 4) & 0xFFF)) & 1)) ^ ((int32((in[4] >> 4) & 0xFFF)) >> 1))) + out[10]
	out[12] = T(((-((int32((in[4] >> 16) & 0xFFF)) & 1)) ^ ((int32((in[4] >> 16) & 0xFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[4] >> 28) | ((in[5] & 0xFF) << 4)))) & 1)) ^ ((int32(((in[4] >> 28) | ((in[5] & 0xFF) << 4)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[5] >> 8) & 0xFFF)) & 1)) ^ ((int32((in[5] >> 8) & 0xFFF)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[5] >> 20))) & 1)) ^ ((int32((in[5] >> 20))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[6] >> 0) & 0xFFF)) & 1)) ^ ((int32((in[6] >> 0) & 0xFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[6] >> 12) & 0xFFF)) & 1)) ^ ((int32((in[6] >> 12) & 0xFFF)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[6] >> 24) | ((in[7] & 0xF) << 8)))) & 1)) ^ ((int32(((in[6] >> 24) | ((in[7] & 0xF) << 8)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[7] >> 4) & 0xFFF)) & 1)) ^ ((int32((in[7] >> 4) & 0xFFF)) >> 1))) + out[18]
	out[20] = T(((-((int32((in[7] >> 16) & 0xFFF)) & 1)) ^ ((int32((in[7] >> 16) & 0xFFF)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[7] >> 28) | ((in[8] & 0xFF) << 4)))) & 1)) ^ ((int32(((in[7] >> 28) | ((in[8] & 0xFF) << 4)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[8] >> 8) & 0xFFF)) & 1)) ^ ((int32((in[8] >> 8) & 0xFFF)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[8] >> 20))) & 1)) ^ ((int32((in[8] >> 20))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[9] >> 0) & 0xFFF)) & 1)) ^ ((int32((in[9] >> 0) & 0xFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[9] >> 12) & 0xFFF)) & 1)) ^ ((int32((in[9] >> 12) & 0xFFF)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[9] >> 24) | ((in[10] & 0xF) << 8)))) & 1)) ^ ((int32(((in[9] >> 24) | ((in[10] & 0xF) << 8)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[10] >> 4) & 0xFFF)) & 1)) ^ ((int32((in[10] >> 4) & 0xFFF)) >> 1))) + out[26]
	out[28] = T(((-((int32((in[10] >> 16) & 0xFFF)) & 1)) ^ ((int32((in[10] >> 16) & 0xFFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[10] >> 28) | ((in[11] & 0xFF) << 4)))) & 1)) ^ ((int32(((in[10] >> 28) | ((in[11] & 0xFF) << 4)))) >> 1))) + out[28]
	out[30] = T(((-((int32((in[11] >> 8) & 0xFFF)) & 1)) ^ ((int32((in[11] >> 8) & 0xFFF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[11] >> 20))) & 1)) ^ ((int32((in[11] >> 20))) >> 1))) + out[30]
}

func deltaunpackzigzag32_13[T uint32 | int32](initoffset T, in *[13]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1FFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x1FFF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 13) & 0x1FFF)) & 1)) ^ ((int32((in[0] >> 13) & 0x1FFF)) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[0] >> 26) | ((in[1] & 0x7F) << 6)))) & 1)) ^ ((int32(((in[0] >> 26) | ((in[1] & 0x7F) << 6)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[1] >> 7) & 0x1FFF)) & 1)) ^ ((int32((in[1] >> 7) & 0x1FFF)) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[1] >> 20) | ((in[2] & 0x1) << 12)))) & 1)) ^ ((int32(((in[1] >> 20) | ((in[2] & 0x1) << 12)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[2] >> 1) & 0x1FFF)) & 1)) ^ ((int32((in[2] >> 1) & 0x1FFF)) >> 1))) + out[4]
	out[6] = T(((-((int32((in[2] >> 14) & 0x1FFF)) & 1)) ^ ((int32((in[2] >> 14) & 0x1FFF)) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[2] >> 27) | ((in[3] & 0xFF) << 5)))) & 1)) ^ ((int32(((in[2] >> 27) | ((in[3] & 0xFF) << 5)))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[3] >> 8) & 0x1FFF)) & 1)) ^ ((int32((in[3] >> 8) & 0x1FFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[3] >> 21) | ((in[4] & 0x3) << 11)))) & 1)) ^ ((int32(((in[3] >> 21) | ((in[4] & 0x3) << 11)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[4] >> 2) & 0x1FFF)) & 1)) ^ ((int32((in[4] >> 2) & 0x1FFF)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[4] >> 15) & 0x1FFF)) & 1)) ^ ((int32((in[4] >> 15) & 0x1FFF)) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[4] >> 28) | ((in[5] & 0x1FF) << 4)))) & 1)) ^ ((int32(((in[4] >> 28) | ((in[5] & 0x1FF) << 4)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[5] >> 9) & 0x1FFF)) & 1)) ^ ((int32((in[5] >> 9) & 0x1FFF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[5] >> 22) | ((in[6] & 0x7) << 10)))) & 1)) ^ ((int32(((in[5] >> 22) | ((in[6] & 0x7) << 10)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[6] >> 3) & 0x1FFF)) & 1)) ^ ((int32((in[6] >> 3) & 0x1FFF)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[6] >> 16) & 0x1FFF)) & 1)) ^ ((int32((in[6] >> 16) & 0x1FFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[6] >> 29) | ((in[7] & 0x3FF) << 3)))) & 1)) ^ ((int32(((in[6] >> 29) | ((in[7] & 0x3FF) << 3)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[7] >> 10) & 0x1FFF)) & 1)) ^ ((int32((in[7] >> 10) & 0x1FFF)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[7] >> 23) | ((in[8] & 0xF) << 9)))) & 1)) ^ ((int32(((in[7] >> 23) | ((in[8] & 0xF) << 9)))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[8] >> 4) & 0x1FFF)) & 1)) ^ ((int32((in[8] >> 4) & 0x1FFF)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[8] >> 17) & 0x1FFF)) & 1)) ^ ((int32((in[8] >> 17) & 0x1FFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[8] >> 30) | ((in[9] & 0x7FF) << 2)))) & 1)) ^ ((int32(((in[8] >> 30) | ((in[9] & 0x7FF) << 2)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[9] >> 11) & 0x1FFF)) & 1)) ^ ((int32((in[9] >> 11) & 0x1FFF)) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[9] >> 24) | ((in[10] & 0x1F) << 8)))) & 1)) ^ ((int32(((in[9] >> 24) | ((in[10] & 0x1F) << 8)))) >> 1))) + out[23]
	out[25] = T(((-((int32((in[10] >> 5) & 0x1FFF)) & 1)) ^ ((int32((in[10] >> 5) & 0x1FFF)) >> 1))) + out[24]
	out[26] = T(((-((int32((in[10] >> 18) & 0x1FFF)) & 1)) ^ ((int32((in[10] >> 18) & 0x1FFF)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[10] >> 31) | ((in[11] & 0xFFF) << 1)))) & 1)) ^ ((int32(((in[10] >> 31) | ((in[11] & 0xFFF) << 1)))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[11] >> 12) & 0x1FFF)) & 1)) ^ ((int32((in[11] >> 12) & 0x1FFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[11] >> 25) | ((in[12] & 0x3F) << 7)))) & 1)) ^ ((int32(((in[11] >> 25) | ((in[12] & 0x3F) << 7)))) >> 1))) + out[28]
	out[30] = T(((-((int32((in[12] >> 6) & 0x1FFF)) & 1)) ^ ((int32((in[12] >> 6) & 0x1FFF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[12] >> 19))) & 1)) ^ ((int32((in[12] >> 19))) >> 1))) + out[30]
}

func deltaunpackzigzag32_14[T uint32 | int32](initoffset T, in *[14]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3FFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x3FFF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 14) & 0x3FFF)) & 1)) ^ ((int32((in[0] >> 14) & 0x3FFF)) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[0] >> 28) | ((in[1] & 0x3FF) << 4)))) & 1)) ^ ((int32(((in[0] >> 28) | ((in[1] & 0x3FF) << 4)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[1] >> 10) & 0x3FFF)) & 1)) ^ ((int32((in[1] >> 10) & 0x3FFF)) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[1] >> 24) | ((in[2] & 0x3F) << 8)))) & 1)) ^ ((int32(((in[1] >> 24) | ((in[2] & 0x3F) << 8)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[2] >> 6) & 0x3FFF)) & 1)) ^ ((int32((in[2] >> 6) & 0x3FFF)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[2] >> 20) | ((in[3] & 0x3) << 12)))) & 1)) ^ ((int32(((in[2] >> 20) | ((in[3] & 0x3) << 12)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[3] >> 2) & 0x3FFF)) & 1)) ^ ((int32((in[3] >> 2) & 0x3FFF)) >> 1))) + out[6]
	out[8] = T(((-((int32((in[3] >> 16) & 0x3FFF)) & 1)) ^ ((int32((in[3] >> 16) & 0x3FFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[3] >> 30) | ((in[4] & 0xFFF) << 2)))) & 1)) ^ ((int32(((in[3] >> 30) | ((in[4] & 0xFFF) << 2)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[4] >> 12) & 0x3FFF)) & 1)) ^ ((int32((in[4] >> 12) & 0x3FFF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[4] >> 26) | ((in[5] & 0xFF) << 6)))) & 1)) ^ ((int32(((in[4] >> 26) | ((in[5] & 0xFF) << 6)))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[5] >> 8) & 0x3FFF)) & 1)) ^ ((int32((in[5] >> 8) & 0x3FFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[5] >> 22) | ((in[6] & 0xF) << 10)))) & 1)) ^ ((int32(((in[5] >> 22) | ((in[6] & 0xF) << 10)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[6] >> 4) & 0x3FFF)) & 1)) ^ ((int32((in[6] >> 4) & 0x3FFF)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[6] >> 18))) & 1)) ^ ((int32((in[6] >> 18))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[7] >> 0) & 0x3FFF)) & 1)) ^ ((int32((in[7] >> 0) & 0x3FFF)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[7] >> 14) & 0x3FFF)) & 1)) ^ ((int32((in[7] >> 14) & 0x3FFF)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[7] >> 28) | ((in[8] & 0x3FF) << 4)))) & 1)) ^ ((int32(((in[7] >> 28) | ((in[8] & 0x3FF) << 4)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[8] >> 10) & 0x3FFF)) & 1)) ^ ((int32((in[8] >> 10) & 0x3FFF)) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[8] >> 24) | ((in[9] & 0x3F) << 8)))) & 1)) ^ ((int32(((in[8] >> 24) | ((in[9] & 0x3F) << 8)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[9] >> 6) & 0x3FFF)) & 1)) ^ ((int32((in[9] >> 6) & 0x3FFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[9] >> 20) | ((in[10] & 0x3) << 12)))) & 1)) ^ ((int32(((in[9] >> 20) | ((in[10] & 0x3) << 12)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[10] >> 2) & 0x3FFF)) & 1)) ^ ((int32((in[10] >> 2) & 0x3FFF)) >> 1))) + out[22]
	out[24] = T(((-((int32((in[10] >> 16) & 0x3FFF)) & 1)) ^ ((int32((in[10] >> 16) & 0x3FFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[10] >> 30) | ((in[11] & 0xFFF) << 2)))) & 1)) ^ ((int32(((in[10] >> 30) | ((in[11] & 0xFFF) << 2)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[11] >> 12) & 0x3FFF)) & 1)) ^ ((int32((in[11] >> 12) & 0x3FFF)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[11] >> 26) | ((in[12] & 0xFF) << 6)))) & 1)) ^ ((int32(((in[11] >> 26) | ((in[12] & 0xFF) << 6)))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[12] >> 8) & 0x3FFF)) & 1)) ^ ((int32((in[12] >> 8) & 0x3FFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[12] >> 22) | ((in[13] & 0xF) << 10)))) & 1)) ^ ((int32(((in[12] >> 22) | ((in[13] & 0xF) << 10)))) >> 1))) + out[28]
	out[30] = T(((-((int32((in[13] >> 4) & 0x3FFF)) & 1)) ^ ((int32((in[13] >> 4) & 0x3FFF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[13] >> 18))) & 1)) ^ ((int32((in[13] >> 18))) >> 1))) + out[30]
}

func deltaunpackzigzag32_15[T uint32 | int32](initoffset T, in *[15]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7FFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x7FFF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 15) & 0x7FFF)) & 1)) ^ ((int32((in[0] >> 15) & 0x7FFF)) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[0] >> 30) | ((in[1] & 0x1FFF) << 2)))) & 1)) ^ ((int32(((in[0] >> 30) | ((in[1] & 0x1FFF) << 2)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[1] >> 13) & 0x7FFF)) & 1)) ^ ((int32((in[1] >> 13) & 0x7FFF)) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0x7FF) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0x7FF) << 4)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[2] >> 11) & 0x7FFF)) & 1)) ^ ((int32((in[2] >> 11) & 0x7FFF)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[2] >> 26) | ((in[3] & 0x1FF) << 6)))) & 1)) ^ ((int32(((in[2] >> 26) | ((in[3] & 0x1FF) << 6)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[3] >> 9) & 0x7FFF)) & 1)) ^ ((int32((in[3] >> 9) & 0x7FFF)) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[3] >> 24) | ((in[4] & 0x7F) << 8)))) & 1)) ^ ((int32(((in[3] >> 24) | ((in[4] & 0x7F) << 8)))) >> 1))) + out[7]
	out[9] = T(((-((int32((in[4] >> 7) & 0x7FFF)) & 1)) ^ ((int32((in[4] >> 7) & 0x7FFF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[4] >> 22) | ((in[5] & 0x1F) << 10)))) & 1)) ^ ((int32(((in[4] >> 22) | ((in[5] & 0x1F) << 10)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[5] >> 5) & 0x7FFF)) & 1)) ^ ((int32((in[5] >> 5) & 0x7FFF)) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[5] >> 20) | ((in[6] & 0x7) << 12)))) & 1)) ^ ((int32(((in[5] >> 20) | ((in[6] & 0x7) << 12)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[6] >> 3) & 0x7FFF)) & 1)) ^ ((int32((in[6] >> 3) & 0x7FFF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[6] >> 18) | ((in[7] & 0x1) << 14)))) & 1)) ^ ((int32(((in[6] >> 18) | ((in[7] & 0x1) << 14)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[7] >> 1) & 0x7FFF)) & 1)) ^ ((int32((in[7] >> 1) & 0x7FFF)) >> 1))) + out[14]
	out[16] = T(((-((int32((in[7] >> 16) & 0x7FFF)) & 1)) ^ ((int32((in[7] >> 16) & 0x7FFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[7] >> 31) | ((in[8] & 0x3FFF) << 1)))) & 1)) ^ ((int32(((in[7] >> 31) | ((in[8] & 0x3FFF) << 1)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[8] >> 14) & 0x7FFF)) & 1)) ^ ((int32((in[8] >> 14) & 0x7FFF)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[8] >> 29) | ((in[9] & 0xFFF) << 3)))) & 1)) ^ ((int32(((in[8] >> 29) | ((in[9] & 0xFFF) << 3)))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[9] >> 12) & 0x7FFF)) & 1)) ^ ((int32((in[9] >> 12) & 0x7FFF)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[9] >> 27) | ((in[10] & 0x3FF) << 5)))) & 1)) ^ ((int32(((in[9] >> 27) | ((in[10] & 0x3FF) << 5)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[10] >> 10) & 0x7FFF)) & 1)) ^ ((int32((in[10] >> 10) & 0x7FFF)) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[10] >> 25) | ((in[11] & 0xFF) << 7)))) & 1)) ^ ((int32(((in[10] >> 25) | ((in[11] & 0xFF) << 7)))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[11] >> 8) & 0x7FFF)) & 1)) ^ ((int32((in[11] >> 8) & 0x7FFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[11] >> 23) | ((in[12] & 0x3F) << 9)))) & 1)) ^ ((int32(((in[11] >> 23) | ((in[12] & 0x3F) << 9)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[12] >> 6) & 0x7FFF)) & 1)) ^ ((int32((in[12] >> 6) & 0x7FFF)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[12] >> 21) | ((in[13] & 0xF) << 11)))) & 1)) ^ ((int32(((in[12] >> 21) | ((in[13] & 0xF) << 11)))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[13] >> 4) & 0x7FFF)) & 1)) ^ ((int32((in[13] >> 4) & 0x7FFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[13] >> 19) | ((in[14] & 0x3) << 13)))) & 1)) ^ ((int32(((in[13] >> 19) | ((in[14] & 0x3) << 13)))) >> 1))) + out[28]
	out[30] = T(((-((int32((in[14] >> 2) & 0x7FFF)) & 1)) ^ ((int32((in[14] >> 2) & 0x7FFF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[14] >> 17))) & 1)) ^ ((int32((in[14] >> 17))) >> 1))) + out[30]
}

func deltaunpackzigzag32_16[T uint32 | int32](initoffset T, in *[16]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0xFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32((in[0] >> 16))) & 1)) ^ ((int32((in[0] >> 16))) >> 1))) + out[0]
	out[2] = T(((-((int32((in[1] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[1] >> 0) & 0xFFFF)) >> 1))) + out[1]
	out[3] = T(((-((int32((in[1] >> 16))) & 1)) ^ ((int32((in[1] >> 16))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[2] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[2] >> 0) & 0xFFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32((in[2] >> 16))) & 1)) ^ ((int32((in[2] >> 16))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[3] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[3] >> 0) & 0xFFFF)) >> 1))) + out[5]
	out[7] = T(((-((int32((in[3] >> 16))) & 1)) ^ ((int32((in[3] >> 16))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[4] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[4] >> 0) & 0xFFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32((in[4] >> 16))) & 1)) ^ ((int32((in[4] >> 16))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[5] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[5] >> 0) & 0xFFFF)) >> 1))) + out[9]
	out[11] = T(((-((int32((in[5] >> 16))) & 1)) ^ ((int32((in[5] >> 16))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[6] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[6] >> 0) & 0xFFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32((in[6] >> 16))) & 1)) ^ ((int32((in[6] >> 16))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[7] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[7] >> 0) & 0xFFFF)) >> 1))) + out[13]
	out[15] = T(((-((int32((in[7] >> 16))) & 1)) ^ ((int32((in[7] >> 16))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[8] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[8] >> 0) & 0xFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32((in[8] >> 16))) & 1)) ^ ((int32((in[8] >> 16))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[9] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[9] >> 0) & 0xFFFF)) >> 1))) + out[17]
	out[19] = T(((-((int32((in[9] >> 16))) & 1)) ^ ((int32((in[9] >> 16))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[10] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[10] >> 0) & 0xFFFF)) >> 1))) + out[19]
	out[21] = T(((-((int32((in[10] >> 16))) & 1)) ^ ((int32((in[10] >> 16))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[11] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[11] >> 0) & 0xFFFF)) >> 1))) + out[21]
	out[23] = T(((-((int32((in[11] >> 16))) & 1)) ^ ((int32((in[11] >> 16))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[12] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[12] >> 0) & 0xFFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32((in[12] >> 16))) & 1)) ^ ((int32((in[12] >> 16))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[13] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[13] >> 0) & 0xFFFF)) >> 1))) + out[25]
	out[27] = T(((-((int32((in[13] >> 16))) & 1)) ^ ((int32((in[13] >> 16))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[14] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[14] >> 0) & 0xFFFF)) >> 1))) + out[27]
	out[29] = T(((-((int32((in[14] >> 16))) & 1)) ^ ((int32((in[14] >> 16))) >> 1))) + out[28]
	out[30] = T(((-((int32((in[15] >> 0) & 0xFFFF)) & 1)) ^ ((int32((in[15] >> 0) & 0xFFFF)) >> 1))) + out[29]
	out[31] = T(((-((int32((in[15] >> 16))) & 1)) ^ ((int32((in[15] >> 16))) >> 1))) + out[30]
}

func deltaunpackzigzag32_17[T uint32 | int32](initoffset T, in *[17]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1FFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x1FFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 17) | ((in[1] & 0x3) << 15)))) & 1)) ^ ((int32(((in[0] >> 17) | ((in[1] & 0x3) << 15)))) >> 1))) + out[0]
	out[2] = T(((-((int32((in[1] >> 2) & 0x1FFFF)) & 1)) ^ ((int32((in[1] >> 2) & 0x1FFFF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[1] >> 19) | ((in[2] & 0xF) << 13)))) & 1)) ^ ((int32(((in[1] >> 19) | ((in[2] & 0xF) << 13)))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[2] >> 4) & 0x1FFFF)) & 1)) ^ ((int32((in[2] >> 4) & 0x1FFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[2] >> 21) | ((in[3] & 0x3F) << 11)))) & 1)) ^ ((int32(((in[2] >> 21) | ((in[3] & 0x3F) << 11)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[3] >> 6) & 0x1FFFF)) & 1)) ^ ((int32((in[3] >> 6) & 0x1FFFF)) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[3] >> 23) | ((in[4] & 0xFF) << 9)))) & 1)) ^ ((int32(((in[3] >> 23) | ((in[4] & 0xFF) << 9)))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[4] >> 8) & 0x1FFFF)) & 1)) ^ ((int32((in[4] >> 8) & 0x1FFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[4] >> 25) | ((in[5] & 0x3FF) << 7)))) & 1)) ^ ((int32(((in[4] >> 25) | ((in[5] & 0x3FF) << 7)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[5] >> 10) & 0x1FFFF)) & 1)) ^ ((int32((in[5] >> 10) & 0x1FFFF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[5] >> 27) | ((in[6] & 0xFFF) << 5)))) & 1)) ^ ((int32(((in[5] >> 27) | ((in[6] & 0xFFF) << 5)))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[6] >> 12) & 0x1FFFF)) & 1)) ^ ((int32((in[6] >> 12) & 0x1FFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[6] >> 29) | ((in[7] & 0x3FFF) << 3)))) & 1)) ^ ((int32(((in[6] >> 29) | ((in[7] & 0x3FFF) << 3)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[7] >> 14) & 0x1FFFF)) & 1)) ^ ((int32((in[7] >> 14) & 0x1FFFF)) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[7] >> 31) | ((in[8] & 0xFFFF) << 1)))) & 1)) ^ ((int32(((in[7] >> 31) | ((in[8] & 0xFFFF) << 1)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[8] >> 16) | ((in[9] & 0x1) << 16)))) & 1)) ^ ((int32(((in[8] >> 16) | ((in[9] & 0x1) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32((in[9] >> 1) & 0x1FFFF)) & 1)) ^ ((int32((in[9] >> 1) & 0x1FFFF)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[9] >> 18) | ((in[10] & 0x7) << 14)))) & 1)) ^ ((int32(((in[9] >> 18) | ((in[10] & 0x7) << 14)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[10] >> 3) & 0x1FFFF)) & 1)) ^ ((int32((in[10] >> 3) & 0x1FFFF)) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[10] >> 20) | ((in[11] & 0x1F) << 12)))) & 1)) ^ ((int32(((in[10] >> 20) | ((in[11] & 0x1F) << 12)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[11] >> 5) & 0x1FFFF)) & 1)) ^ ((int32((in[11] >> 5) & 0x1FFFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[11] >> 22) | ((in[12] & 0x7F) << 10)))) & 1)) ^ ((int32(((in[11] >> 22) | ((in[12] & 0x7F) << 10)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[12] >> 7) & 0x1FFFF)) & 1)) ^ ((int32((in[12] >> 7) & 0x1FFFF)) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[12] >> 24) | ((in[13] & 0x1FF) << 8)))) & 1)) ^ ((int32(((in[12] >> 24) | ((in[13] & 0x1FF) << 8)))) >> 1))) + out[23]
	out[25] = T(((-((int32((in[13] >> 9) & 0x1FFFF)) & 1)) ^ ((int32((in[13] >> 9) & 0x1FFFF)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[13] >> 26) | ((in[14] & 0x7FF) << 6)))) & 1)) ^ ((int32(((in[13] >> 26) | ((in[14] & 0x7FF) << 6)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[14] >> 11) & 0x1FFFF)) & 1)) ^ ((int32((in[14] >> 11) & 0x1FFFF)) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[14] >> 28) | ((in[15] & 0x1FFF) << 4)))) & 1)) ^ ((int32(((in[14] >> 28) | ((in[15] & 0x1FFF) << 4)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[15] >> 13) & 0x1FFFF)) & 1)) ^ ((int32((in[15] >> 13) & 0x1FFFF)) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[15] >> 30) | ((in[16] & 0x7FFF) << 2)))) & 1)) ^ ((int32(((in[15] >> 30) | ((in[16] & 0x7FFF) << 2)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[16] >> 15))) & 1)) ^ ((int32((in[16] >> 15))) >> 1))) + out[30]
}

func deltaunpackzigzag32_18[T uint32 | int32](initoffset T, in *[18]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3FFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x3FFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 18) | ((in[1] & 0xF) << 14)))) & 1)) ^ ((int32(((in[0] >> 18) | ((in[1] & 0xF) << 14)))) >> 1))) + out[0]
	out[2] = T(((-((int32((in[1] >> 4) & 0x3FFFF)) & 1)) ^ ((int32((in[1] >> 4) & 0x3FFFF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[1] >> 22) | ((in[2] & 0xFF) << 10)))) & 1)) ^ ((int32(((in[1] >> 22) | ((in[2] & 0xFF) << 10)))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[2] >> 8) & 0x3FFFF)) & 1)) ^ ((int32((in[2] >> 8) & 0x3FFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[2] >> 26) | ((in[3] & 0xFFF) << 6)))) & 1)) ^ ((int32(((in[2] >> 26) | ((in[3] & 0xFFF) << 6)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[3] >> 12) & 0x3FFFF)) & 1)) ^ ((int32((in[3] >> 12) & 0x3FFFF)) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[3] >> 30) | ((in[4] & 0xFFFF) << 2)))) & 1)) ^ ((int32(((in[3] >> 30) | ((in[4] & 0xFFFF) << 2)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[4] >> 16) | ((in[5] & 0x3) << 16)))) & 1)) ^ ((int32(((in[4] >> 16) | ((in[5] & 0x3) << 16)))) >> 1))) + out[7]
	out[9] = T(((-((int32((in[5] >> 2) & 0x3FFFF)) & 1)) ^ ((int32((in[5] >> 2) & 0x3FFFF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[5] >> 20) | ((in[6] & 0x3F) << 12)))) & 1)) ^ ((int32(((in[5] >> 20) | ((in[6] & 0x3F) << 12)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[6] >> 6) & 0x3FFFF)) & 1)) ^ ((int32((in[6] >> 6) & 0x3FFFF)) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[6] >> 24) | ((in[7] & 0x3FF) << 8)))) & 1)) ^ ((int32(((in[6] >> 24) | ((in[7] & 0x3FF) << 8)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[7] >> 10) & 0x3FFFF)) & 1)) ^ ((int32((in[7] >> 10) & 0x3FFFF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[7] >> 28) | ((in[8] & 0x3FFF) << 4)))) & 1)) ^ ((int32(((in[7] >> 28) | ((in[8] & 0x3FFF) << 4)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[8] >> 14))) & 1)) ^ ((int32((in[8] >> 14))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[9] >> 0) & 0x3FFFF)) & 1)) ^ ((int32((in[9] >> 0) & 0x3FFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[9] >> 18) | ((in[10] & 0xF) << 14)))) & 1)) ^ ((int32(((in[9] >> 18) | ((in[10] & 0xF) << 14)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[10] >> 4) & 0x3FFFF)) & 1)) ^ ((int32((in[10] >> 4) & 0x3FFFF)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[10] >> 22) | ((in[11] & 0xFF) << 10)))) & 1)) ^ ((int32(((in[10] >> 22) | ((in[11] & 0xFF) << 10)))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[11] >> 8) & 0x3FFFF)) & 1)) ^ ((int32((in[11] >> 8) & 0x3FFFF)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[11] >> 26) | ((in[12] & 0xFFF) << 6)))) & 1)) ^ ((int32(((in[11] >> 26) | ((in[12] & 0xFFF) << 6)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[12] >> 12) & 0x3FFFF)) & 1)) ^ ((int32((in[12] >> 12) & 0x3FFFF)) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[12] >> 30) | ((in[13] & 0xFFFF) << 2)))) & 1)) ^ ((int32(((in[12] >> 30) | ((in[13] & 0xFFFF) << 2)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[13] >> 16) | ((in[14] & 0x3) << 16)))) & 1)) ^ ((int32(((in[13] >> 16) | ((in[14] & 0x3) << 16)))) >> 1))) + out[23]
	out[25] = T(((-((int32((in[14] >> 2) & 0x3FFFF)) & 1)) ^ ((int32((in[14] >> 2) & 0x3FFFF)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[14] >> 20) | ((in[15] & 0x3F) << 12)))) & 1)) ^ ((int32(((in[14] >> 20) | ((in[15] & 0x3F) << 12)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[15] >> 6) & 0x3FFFF)) & 1)) ^ ((int32((in[15] >> 6) & 0x3FFFF)) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[15] >> 24) | ((in[16] & 0x3FF) << 8)))) & 1)) ^ ((int32(((in[15] >> 24) | ((in[16] & 0x3FF) << 8)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[16] >> 10) & 0x3FFFF)) & 1)) ^ ((int32((in[16] >> 10) & 0x3FFFF)) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[16] >> 28) | ((in[17] & 0x3FFF) << 4)))) & 1)) ^ ((int32(((in[16] >> 28) | ((in[17] & 0x3FFF) << 4)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[17] >> 14))) & 1)) ^ ((int32((in[17] >> 14))) >> 1))) + out[30]
}

func deltaunpackzigzag32_19[T uint32 | int32](initoffset T, in *[19]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7FFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x7FFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 19) | ((in[1] & 0x3F) << 13)))) & 1)) ^ ((int32(((in[0] >> 19) | ((in[1] & 0x3F) << 13)))) >> 1))) + out[0]
	out[2] = T(((-((int32((in[1] >> 6) & 0x7FFFF)) & 1)) ^ ((int32((in[1] >> 6) & 0x7FFFF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[1] >> 25) | ((in[2] & 0xFFF) << 7)))) & 1)) ^ ((int32(((in[1] >> 25) | ((in[2] & 0xFFF) << 7)))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[2] >> 12) & 0x7FFFF)) & 1)) ^ ((int32((in[2] >> 12) & 0x7FFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[2] >> 31) | ((in[3] & 0x3FFFF) << 1)))) & 1)) ^ ((int32(((in[2] >> 31) | ((in[3] & 0x3FFFF) << 1)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[3] >> 18) | ((in[4] & 0x1F) << 14)))) & 1)) ^ ((int32(((in[3] >> 18) | ((in[4] & 0x1F) << 14)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[4] >> 5) & 0x7FFFF)) & 1)) ^ ((int32((in[4] >> 5) & 0x7FFFF)) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[4] >> 24) | ((in[5] & 0x7FF) << 8)))) & 1)) ^ ((int32(((in[4] >> 24) | ((in[5] & 0x7FF) << 8)))) >> 1))) + out[7]
	out[9] = T(((-((int32((in[5] >> 11) & 0x7FFFF)) & 1)) ^ ((int32((in[5] >> 11) & 0x7FFFF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[5] >> 30) | ((in[6] & 0x1FFFF) << 2)))) & 1)) ^ ((int32(((in[5] >> 30) | ((in[6] & 0x1FFFF) << 2)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[6] >> 17) | ((in[7] & 0xF) << 15)))) & 1)) ^ ((int32(((in[6] >> 17) | ((in[7] & 0xF) << 15)))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[7] >> 4) & 0x7FFFF)) & 1)) ^ ((int32((in[7] >> 4) & 0x7FFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[7] >> 23) | ((in[8] & 0x3FF) << 9)))) & 1)) ^ ((int32(((in[7] >> 23) | ((in[8] & 0x3FF) << 9)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[8] >> 10) & 0x7FFFF)) & 1)) ^ ((int32((in[8] >> 10) & 0x7FFFF)) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[8] >> 29) | ((in[9] & 0xFFFF) << 3)))) & 1)) ^ ((int32(((in[8] >> 29) | ((in[9] & 0xFFFF) << 3)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[9] >> 16) | ((in[10] & 0x7) << 16)))) & 1)) ^ ((int32(((in[9] >> 16) | ((in[10] & 0x7) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32((in[10] >> 3) & 0x7FFFF)) & 1)) ^ ((int32((in[10] >> 3) & 0x7FFFF)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[10] >> 22) | ((in[11] & 0x1FF) << 10)))) & 1)) ^ ((int32(((in[10] >> 22) | ((in[11] & 0x1FF) << 10)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[11] >> 9) & 0x7FFFF)) & 1)) ^ ((int32((in[11] >> 9) & 0x7FFFF)) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[11] >> 28) | ((in[12] & 0x7FFF) << 4)))) & 1)) ^ ((int32(((in[11] >> 28) | ((in[12] & 0x7FFF) << 4)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[12] >> 15) | ((in[13] & 0x3) << 17)))) & 1)) ^ ((int32(((in[12] >> 15) | ((in[13] & 0x3) << 17)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[13] >> 2) & 0x7FFFF)) & 1)) ^ ((int32((in[13] >> 2) & 0x7FFFF)) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[13] >> 21) | ((in[14] & 0xFF) << 11)))) & 1)) ^ ((int32(((in[13] >> 21) | ((in[14] & 0xFF) << 11)))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[14] >> 8) & 0x7FFFF)) & 1)) ^ ((int32((in[14] >> 8) & 0x7FFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[14] >> 27) | ((in[15] & 0x3FFF) << 5)))) & 1)) ^ ((int32(((in[14] >> 27) | ((in[15] & 0x3FFF) << 5)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[15] >> 14) | ((in[16] & 0x1) << 18)))) & 1)) ^ ((int32(((in[15] >> 14) | ((in[16] & 0x1) << 18)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[16] >> 1) & 0x7FFFF)) & 1)) ^ ((int32((in[16] >> 1) & 0x7FFFF)) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[16] >> 20) | ((in[17] & 0x7F) << 12)))) & 1)) ^ ((int32(((in[16] >> 20) | ((in[17] & 0x7F) << 12)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[17] >> 7) & 0x7FFFF)) & 1)) ^ ((int32((in[17] >> 7) & 0x7FFFF)) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[17] >> 26) | ((in[18] & 0x1FFF) << 6)))) & 1)) ^ ((int32(((in[17] >> 26) | ((in[18] & 0x1FFF) << 6)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[18] >> 13))) & 1)) ^ ((int32((in[18] >> 13))) >> 1))) + out[30]
}

func deltaunpackzigzag32_20[T uint32 | int32](initoffset T, in *[20]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0xFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 20) | ((in[1] & 0xFF) << 12)))) & 1)) ^ ((int32(((in[0] >> 20) | ((in[1] & 0xFF) << 12)))) >> 1))) + out[0]
	out[2] = T(((-((int32((in[1] >> 8) & 0xFFFFF)) & 1)) ^ ((int32((in[1] >> 8) & 0xFFFFF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0xFFFF) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0xFFFF) << 4)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[2] >> 16) | ((in[3] & 0xF) << 16)))) & 1)) ^ ((int32(((in[2] >> 16) | ((in[3] & 0xF) << 16)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[3] >> 4) & 0xFFFFF)) & 1)) ^ ((int32((in[3] >> 4) & 0xFFFFF)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[3] >> 24) | ((in[4] & 0xFFF) << 8)))) & 1)) ^ ((int32(((in[3] >> 24) | ((in[4] & 0xFFF) << 8)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[4] >> 12))) & 1)) ^ ((int32((in[4] >> 12))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[5] >> 0) & 0xFFFFF)) & 1)) ^ ((int32((in[5] >> 0) & 0xFFFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[5] >> 20) | ((in[6] & 0xFF) << 12)))) & 1)) ^ ((int32(((in[5] >> 20) | ((in[6] & 0xFF) << 12)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[6] >> 8) & 0xFFFFF)) & 1)) ^ ((int32((in[6] >> 8) & 0xFFFFF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[6] >> 28) | ((in[7] & 0xFFFF) << 4)))) & 1)) ^ ((int32(((in[6] >> 28) | ((in[7] & 0xFFFF) << 4)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[7] >> 16) | ((in[8] & 0xF) << 16)))) & 1)) ^ ((int32(((in[7] >> 16) | ((in[8] & 0xF) << 16)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[8] >> 4) & 0xFFFFF)) & 1)) ^ ((int32((in[8] >> 4) & 0xFFFFF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[8] >> 24) | ((in[9] & 0xFFF) << 8)))) & 1)) ^ ((int32(((in[8] >> 24) | ((in[9] & 0xFFF) << 8)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[9] >> 12))) & 1)) ^ ((int32((in[9] >> 12))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[10] >> 0) & 0xFFFFF)) & 1)) ^ ((int32((in[10] >> 0) & 0xFFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[10] >> 20) | ((in[11] & 0xFF) << 12)))) & 1)) ^ ((int32(((in[10] >> 20) | ((in[11] & 0xFF) << 12)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[11] >> 8) & 0xFFFFF)) & 1)) ^ ((int32((in[11] >> 8) & 0xFFFFF)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[11] >> 28) | ((in[12] & 0xFFFF) << 4)))) & 1)) ^ ((int32(((in[11] >> 28) | ((in[12] & 0xFFFF) << 4)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[12] >> 16) | ((in[13] & 0xF) << 16)))) & 1)) ^ ((int32(((in[12] >> 16) | ((in[13] & 0xF) << 16)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[13] >> 4) & 0xFFFFF)) & 1)) ^ ((int32((in[13] >> 4) & 0xFFFFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[13] >> 24) | ((in[14] & 0xFFF) << 8)))) & 1)) ^ ((int32(((in[13] >> 24) | ((in[14] & 0xFFF) << 8)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[14] >> 12))) & 1)) ^ ((int32((in[14] >> 12))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[15] >> 0) & 0xFFFFF)) & 1)) ^ ((int32((in[15] >> 0) & 0xFFFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[15] >> 20) | ((in[16] & 0xFF) << 12)))) & 1)) ^ ((int32(((in[15] >> 20) | ((in[16] & 0xFF) << 12)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[16] >> 8) & 0xFFFFF)) & 1)) ^ ((int32((in[16] >> 8) & 0xFFFFF)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[16] >> 28) | ((in[17] & 0xFFFF) << 4)))) & 1)) ^ ((int32(((in[16] >> 28) | ((in[17] & 0xFFFF) << 4)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[17] >> 16) | ((in[18] & 0xF) << 16)))) & 1)) ^ ((int32(((in[17] >> 16) | ((in[18] & 0xF) << 16)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[18] >> 4) & 0xFFFFF)) & 1)) ^ ((int32((in[18] >> 4) & 0xFFFFF)) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[18] >> 24) | ((in[19] & 0xFFF) << 8)))) & 1)) ^ ((int32(((in[18] >> 24) | ((in[19] & 0xFFF) << 8)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[19] >> 12))) & 1)) ^ ((int32((in[19] >> 12))) >> 1))) + out[30]
}

func deltaunpackzigzag32_21[T uint32 | int32](initoffset T, in *[21]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1FFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x1FFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 21) | ((in[1] & 0x3FF) << 11)))) & 1)) ^ ((int32(((in[0] >> 21) | ((in[1] & 0x3FF) << 11)))) >> 1))) + out[0]
	out[2] = T(((-((int32((in[1] >> 10) & 0x1FFFFF)) & 1)) ^ ((int32((in[1] >> 10) & 0x1FFFFF)) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[1] >> 31) | ((in[2] & 0xFFFFF) << 1)))) & 1)) ^ ((int32(((in[1] >> 31) | ((in[2] & 0xFFFFF) << 1)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[2] >> 20) | ((in[3] & 0x1FF) << 12)))) & 1)) ^ ((int32(((in[2] >> 20) | ((in[3] & 0x1FF) << 12)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[3] >> 9) & 0x1FFFFF)) & 1)) ^ ((int32((in[3] >> 9) & 0x1FFFFF)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[3] >> 30) | ((in[4] & 0x7FFFF) << 2)))) & 1)) ^ ((int32(((in[3] >> 30) | ((in[4] & 0x7FFFF) << 2)))) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[4] >> 19) | ((in[5] & 0xFF) << 13)))) & 1)) ^ ((int32(((in[4] >> 19) | ((in[5] & 0xFF) << 13)))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[5] >> 8) & 0x1FFFFF)) & 1)) ^ ((int32((in[5] >> 8) & 0x1FFFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[5] >> 29) | ((in[6] & 0x3FFFF) << 3)))) & 1)) ^ ((int32(((in[5] >> 29) | ((in[6] & 0x3FFFF) << 3)))) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[6] >> 18) | ((in[7] & 0x7F) << 14)))) & 1)) ^ ((int32(((in[6] >> 18) | ((in[7] & 0x7F) << 14)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[7] >> 7) & 0x1FFFFF)) & 1)) ^ ((int32((in[7] >> 7) & 0x1FFFFF)) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[7] >> 28) | ((in[8] & 0x1FFFF) << 4)))) & 1)) ^ ((int32(((in[7] >> 28) | ((in[8] & 0x1FFFF) << 4)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[8] >> 17) | ((in[9] & 0x3F) << 15)))) & 1)) ^ ((int32(((in[8] >> 17) | ((in[9] & 0x3F) << 15)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[9] >> 6) & 0x1FFFFF)) & 1)) ^ ((int32((in[9] >> 6) & 0x1FFFFF)) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[9] >> 27) | ((in[10] & 0xFFFF) << 5)))) & 1)) ^ ((int32(((in[9] >> 27) | ((in[10] & 0xFFFF) << 5)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[10] >> 16) | ((in[11] & 0x1F) << 16)))) & 1)) ^ ((int32(((in[10] >> 16) | ((in[11] & 0x1F) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32((in[11] >> 5) & 0x1FFFFF)) & 1)) ^ ((int32((in[11] >> 5) & 0x1FFFFF)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[11] >> 26) | ((in[12] & 0x7FFF) << 6)))) & 1)) ^ ((int32(((in[11] >> 26) | ((in[12] & 0x7FFF) << 6)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[12] >> 15) | ((in[13] & 0xF) << 17)))) & 1)) ^ ((int32(((in[12] >> 15) | ((in[13] & 0xF) << 17)))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[13] >> 4) & 0x1FFFFF)) & 1)) ^ ((int32((in[13] >> 4) & 0x1FFFFF)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[13] >> 25) | ((in[14] & 0x3FFF) << 7)))) & 1)) ^ ((int32(((in[13] >> 25) | ((in[14] & 0x3FFF) << 7)))) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[14] >> 14) | ((in[15] & 0x7) << 18)))) & 1)) ^ ((int32(((in[14] >> 14) | ((in[15] & 0x7) << 18)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[15] >> 3) & 0x1FFFFF)) & 1)) ^ ((int32((in[15] >> 3) & 0x1FFFFF)) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[15] >> 24) | ((in[16] & 0x1FFF) << 8)))) & 1)) ^ ((int32(((in[15] >> 24) | ((in[16] & 0x1FFF) << 8)))) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[16] >> 13) | ((in[17] & 0x3) << 19)))) & 1)) ^ ((int32(((in[16] >> 13) | ((in[17] & 0x3) << 19)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[17] >> 2) & 0x1FFFFF)) & 1)) ^ ((int32((in[17] >> 2) & 0x1FFFFF)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[17] >> 23) | ((in[18] & 0xFFF) << 9)))) & 1)) ^ ((int32(((in[17] >> 23) | ((in[18] & 0xFFF) << 9)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[18] >> 12) | ((in[19] & 0x1) << 20)))) & 1)) ^ ((int32(((in[18] >> 12) | ((in[19] & 0x1) << 20)))) >> 1))) + out[27]
	out[29] = T(((-((int32((in[19] >> 1) & 0x1FFFFF)) & 1)) ^ ((int32((in[19] >> 1) & 0x1FFFFF)) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[19] >> 22) | ((in[20] & 0x7FF) << 10)))) & 1)) ^ ((int32(((in[19] >> 22) | ((in[20] & 0x7FF) << 10)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[20] >> 11))) & 1)) ^ ((int32((in[20] >> 11))) >> 1))) + out[30]
}

func deltaunpackzigzag32_22[T uint32 | int32](initoffset T, in *[22]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3FFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x3FFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 22) | ((in[1] & 0xFFF) << 10)))) & 1)) ^ ((int32(((in[0] >> 22) | ((in[1] & 0xFFF) << 10)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 12) | ((in[2] & 0x3) << 20)))) & 1)) ^ ((int32(((in[1] >> 12) | ((in[2] & 0x3) << 20)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[2] >> 2) & 0x3FFFFF)) & 1)) ^ ((int32((in[2] >> 2) & 0x3FFFFF)) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[2] >> 24) | ((in[3] & 0x3FFF) << 8)))) & 1)) ^ ((int32(((in[2] >> 24) | ((in[3] & 0x3FFF) << 8)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[3] >> 14) | ((in[4] & 0xF) << 18)))) & 1)) ^ ((int32(((in[3] >> 14) | ((in[4] & 0xF) << 18)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[4] >> 4) & 0x3FFFFF)) & 1)) ^ ((int32((in[4] >> 4) & 0x3FFFFF)) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[4] >> 26) | ((in[5] & 0xFFFF) << 6)))) & 1)) ^ ((int32(((in[4] >> 26) | ((in[5] & 0xFFFF) << 6)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[5] >> 16) | ((in[6] & 0x3F) << 16)))) & 1)) ^ ((int32(((in[5] >> 16) | ((in[6] & 0x3F) << 16)))) >> 1))) + out[7]
	out[9] = T(((-((int32((in[6] >> 6) & 0x3FFFFF)) & 1)) ^ ((int32((in[6] >> 6) & 0x3FFFFF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[6] >> 28) | ((in[7] & 0x3FFFF) << 4)))) & 1)) ^ ((int32(((in[6] >> 28) | ((in[7] & 0x3FFFF) << 4)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[7] >> 18) | ((in[8] & 0xFF) << 14)))) & 1)) ^ ((int32(((in[7] >> 18) | ((in[8] & 0xFF) << 14)))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[8] >> 8) & 0x3FFFFF)) & 1)) ^ ((int32((in[8] >> 8) & 0x3FFFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[8] >> 30) | ((in[9] & 0xFFFFF) << 2)))) & 1)) ^ ((int32(((in[8] >> 30) | ((in[9] & 0xFFFFF) << 2)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[9] >> 20) | ((in[10] & 0x3FF) << 12)))) & 1)) ^ ((int32(((in[9] >> 20) | ((in[10] & 0x3FF) << 12)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[10] >> 10))) & 1)) ^ ((int32((in[10] >> 10))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[11] >> 0) & 0x3FFFFF)) & 1)) ^ ((int32((in[11] >> 0) & 0x3FFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[11] >> 22) | ((in[12] & 0xFFF) << 10)))) & 1)) ^ ((int32(((in[11] >> 22) | ((in[12] & 0xFFF) << 10)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[12] >> 12) | ((in[13] & 0x3) << 20)))) & 1)) ^ ((int32(((in[12] >> 12) | ((in[13] & 0x3) << 20)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[13] >> 2) & 0x3FFFFF)) & 1)) ^ ((int32((in[13] >> 2) & 0x3FFFFF)) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[13] >> 24) | ((in[14] & 0x3FFF) << 8)))) & 1)) ^ ((int32(((in[13] >> 24) | ((in[14] & 0x3FFF) << 8)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[14] >> 14) | ((in[15] & 0xF) << 18)))) & 1)) ^ ((int32(((in[14] >> 14) | ((in[15] & 0xF) << 18)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[15] >> 4) & 0x3FFFFF)) & 1)) ^ ((int32((in[15] >> 4) & 0x3FFFFF)) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[15] >> 26) | ((in[16] & 0xFFFF) << 6)))) & 1)) ^ ((int32(((in[15] >> 26) | ((in[16] & 0xFFFF) << 6)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[16] >> 16) | ((in[17] & 0x3F) << 16)))) & 1)) ^ ((int32(((in[16] >> 16) | ((in[17] & 0x3F) << 16)))) >> 1))) + out[23]
	out[25] = T(((-((int32((in[17] >> 6) & 0x3FFFFF)) & 1)) ^ ((int32((in[17] >> 6) & 0x3FFFFF)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[17] >> 28) | ((in[18] & 0x3FFFF) << 4)))) & 1)) ^ ((int32(((in[17] >> 28) | ((in[18] & 0x3FFFF) << 4)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[18] >> 18) | ((in[19] & 0xFF) << 14)))) & 1)) ^ ((int32(((in[18] >> 18) | ((in[19] & 0xFF) << 14)))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[19] >> 8) & 0x3FFFFF)) & 1)) ^ ((int32((in[19] >> 8) & 0x3FFFFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[19] >> 30) | ((in[20] & 0xFFFFF) << 2)))) & 1)) ^ ((int32(((in[19] >> 30) | ((in[20] & 0xFFFFF) << 2)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[20] >> 20) | ((in[21] & 0x3FF) << 12)))) & 1)) ^ ((int32(((in[20] >> 20) | ((in[21] & 0x3FF) << 12)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[21] >> 10))) & 1)) ^ ((int32((in[21] >> 10))) >> 1))) + out[30]
}

func deltaunpackzigzag32_23[T uint32 | int32](initoffset T, in *[23]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7FFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x7FFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 23) | ((in[1] & 0x3FFF) << 9)))) & 1)) ^ ((int32(((in[0] >> 23) | ((in[1] & 0x3FFF) << 9)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 14) | ((in[2] & 0x1F) << 18)))) & 1)) ^ ((int32(((in[1] >> 14) | ((in[2] & 0x1F) << 18)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[2] >> 5) & 0x7FFFFF)) & 1)) ^ ((int32((in[2] >> 5) & 0x7FFFFF)) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[2] >> 28) | ((in[3] & 0x7FFFF) << 4)))) & 1)) ^ ((int32(((in[2] >> 28) | ((in[3] & 0x7FFFF) << 4)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[3] >> 19) | ((in[4] & 0x3FF) << 13)))) & 1)) ^ ((int32(((in[3] >> 19) | ((in[4] & 0x3FF) << 13)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[4] >> 10) | ((in[5] & 0x1) << 22)))) & 1)) ^ ((int32(((in[4] >> 10) | ((in[5] & 0x1) << 22)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[5] >> 1) & 0x7FFFFF)) & 1)) ^ ((int32((in[5] >> 1) & 0x7FFFFF)) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[5] >> 24) | ((in[6] & 0x7FFF) << 8)))) & 1)) ^ ((int32(((in[5] >> 24) | ((in[6] & 0x7FFF) << 8)))) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[6] >> 15) | ((in[7] & 0x3F) << 17)))) & 1)) ^ ((int32(((in[6] >> 15) | ((in[7] & 0x3F) << 17)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[7] >> 6) & 0x7FFFFF)) & 1)) ^ ((int32((in[7] >> 6) & 0x7FFFFF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[7] >> 29) | ((in[8] & 0xFFFFF) << 3)))) & 1)) ^ ((int32(((in[7] >> 29) | ((in[8] & 0xFFFFF) << 3)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[8] >> 20) | ((in[9] & 0x7FF) << 12)))) & 1)) ^ ((int32(((in[8] >> 20) | ((in[9] & 0x7FF) << 12)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[9] >> 11) | ((in[10] & 0x3) << 21)))) & 1)) ^ ((int32(((in[9] >> 11) | ((in[10] & 0x3) << 21)))) >> 1))) + out[12]
	out[14] = T(((-((int32((in[10] >> 2) & 0x7FFFFF)) & 1)) ^ ((int32((in[10] >> 2) & 0x7FFFFF)) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[10] >> 25) | ((in[11] & 0xFFFF) << 7)))) & 1)) ^ ((int32(((in[10] >> 25) | ((in[11] & 0xFFFF) << 7)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[11] >> 16) | ((in[12] & 0x7F) << 16)))) & 1)) ^ ((int32(((in[11] >> 16) | ((in[12] & 0x7F) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32((in[12] >> 7) & 0x7FFFFF)) & 1)) ^ ((int32((in[12] >> 7) & 0x7FFFFF)) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[12] >> 30) | ((in[13] & 0x1FFFFF) << 2)))) & 1)) ^ ((int32(((in[12] >> 30) | ((in[13] & 0x1FFFFF) << 2)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[13] >> 21) | ((in[14] & 0xFFF) << 11)))) & 1)) ^ ((int32(((in[13] >> 21) | ((in[14] & 0xFFF) << 11)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[14] >> 12) | ((in[15] & 0x7) << 20)))) & 1)) ^ ((int32(((in[14] >> 12) | ((in[15] & 0x7) << 20)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[15] >> 3) & 0x7FFFFF)) & 1)) ^ ((int32((in[15] >> 3) & 0x7FFFFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[15] >> 26) | ((in[16] & 0x1FFFF) << 6)))) & 1)) ^ ((int32(((in[15] >> 26) | ((in[16] & 0x1FFFF) << 6)))) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[16] >> 17) | ((in[17] & 0xFF) << 15)))) & 1)) ^ ((int32(((in[16] >> 17) | ((in[17] & 0xFF) << 15)))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[17] >> 8) & 0x7FFFFF)) & 1)) ^ ((int32((in[17] >> 8) & 0x7FFFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[17] >> 31) | ((in[18] & 0x3FFFFF) << 1)))) & 1)) ^ ((int32(((in[17] >> 31) | ((in[18] & 0x3FFFFF) << 1)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[18] >> 22) | ((in[19] & 0x1FFF) << 10)))) & 1)) ^ ((int32(((in[18] >> 22) | ((in[19] & 0x1FFF) << 10)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[19] >> 13) | ((in[20] & 0xF) << 19)))) & 1)) ^ ((int32(((in[19] >> 13) | ((in[20] & 0xF) << 19)))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[20] >> 4) & 0x7FFFFF)) & 1)) ^ ((int32((in[20] >> 4) & 0x7FFFFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[20] >> 27) | ((in[21] & 0x3FFFF) << 5)))) & 1)) ^ ((int32(((in[20] >> 27) | ((in[21] & 0x3FFFF) << 5)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[21] >> 18) | ((in[22] & 0x1FF) << 14)))) & 1)) ^ ((int32(((in[21] >> 18) | ((in[22] & 0x1FF) << 14)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[22] >> 9))) & 1)) ^ ((int32((in[22] >> 9))) >> 1))) + out[30]
}

func deltaunpackzigzag32_24[T uint32 | int32](initoffset T, in *[24]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0xFFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 24) | ((in[1] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[0] >> 24) | ((in[1] & 0xFFFF) << 8)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 16) | ((in[2] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[1] >> 16) | ((in[2] & 0xFF) << 16)))) >> 1))) + out[1]
	out[3] = T(((-((int32((in[2] >> 8))) & 1)) ^ ((int32((in[2] >> 8))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[3] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[3] >> 0) & 0xFFFFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[3] >> 24) | ((in[4] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[3] >> 24) | ((in[4] & 0xFFFF) << 8)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[4] >> 16) | ((in[5] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[4] >> 16) | ((in[5] & 0xFF) << 16)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[5] >> 8))) & 1)) ^ ((int32((in[5] >> 8))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[6] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[6] >> 0) & 0xFFFFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[6] >> 24) | ((in[7] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[6] >> 24) | ((in[7] & 0xFFFF) << 8)))) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[7] >> 16) | ((in[8] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[7] >> 16) | ((in[8] & 0xFF) << 16)))) >> 1))) + out[9]
	out[11] = T(((-((int32((in[8] >> 8))) & 1)) ^ ((int32((in[8] >> 8))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[9] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[9] >> 0) & 0xFFFFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[9] >> 24) | ((in[10] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[9] >> 24) | ((in[10] & 0xFFFF) << 8)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[10] >> 16) | ((in[11] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[10] >> 16) | ((in[11] & 0xFF) << 16)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[11] >> 8))) & 1)) ^ ((int32((in[11] >> 8))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[12] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[12] >> 0) & 0xFFFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[12] >> 24) | ((in[13] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[12] >> 24) | ((in[13] & 0xFFFF) << 8)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[13] >> 16) | ((in[14] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[13] >> 16) | ((in[14] & 0xFF) << 16)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[14] >> 8))) & 1)) ^ ((int32((in[14] >> 8))) >> 1))) + out[18]
	out[20] = T(((-((int32((in[15] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[15] >> 0) & 0xFFFFFF)) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[15] >> 24) | ((in[16] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[15] >> 24) | ((in[16] & 0xFFFF) << 8)))) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[16] >> 16) | ((in[17] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[16] >> 16) | ((in[17] & 0xFF) << 16)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[17] >> 8))) & 1)) ^ ((int32((in[17] >> 8))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[18] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[18] >> 0) & 0xFFFFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[18] >> 24) | ((in[19] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[18] >> 24) | ((in[19] & 0xFFFF) << 8)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[19] >> 16) | ((in[20] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[19] >> 16) | ((in[20] & 0xFF) << 16)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[20] >> 8))) & 1)) ^ ((int32((in[20] >> 8))) >> 1))) + out[26]
	out[28] = T(((-((int32((in[21] >> 0) & 0xFFFFFF)) & 1)) ^ ((int32((in[21] >> 0) & 0xFFFFFF)) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[21] >> 24) | ((in[22] & 0xFFFF) << 8)))) & 1)) ^ ((int32(((in[21] >> 24) | ((in[22] & 0xFFFF) << 8)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[22] >> 16) | ((in[23] & 0xFF) << 16)))) & 1)) ^ ((int32(((in[22] >> 16) | ((in[23] & 0xFF) << 16)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[23] >> 8))) & 1)) ^ ((int32((in[23] >> 8))) >> 1))) + out[30]
}

func deltaunpackzigzag32_25[T uint32 | int32](initoffset T, in *[25]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1FFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x1FFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 25) | ((in[1] & 0x3FFFF) << 7)))) & 1)) ^ ((int32(((in[0] >> 25) | ((in[1] & 0x3FFFF) << 7)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 18) | ((in[2] & 0x7FF) << 14)))) & 1)) ^ ((int32(((in[1] >> 18) | ((in[2] & 0x7FF) << 14)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 11) | ((in[3] & 0xF) << 21)))) & 1)) ^ ((int32(((in[2] >> 11) | ((in[3] & 0xF) << 21)))) >> 1))) + out[2]
	out[4] = T(((-((int32((in[3] >> 4) & 0x1FFFFFF)) & 1)) ^ ((int32((in[3] >> 4) & 0x1FFFFFF)) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[3] >> 29) | ((in[4] & 0x3FFFFF) << 3)))) & 1)) ^ ((int32(((in[3] >> 29) | ((in[4] & 0x3FFFFF) << 3)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[4] >> 22) | ((in[5] & 0x7FFF) << 10)))) & 1)) ^ ((int32(((in[4] >> 22) | ((in[5] & 0x7FFF) << 10)))) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[5] >> 15) | ((in[6] & 0xFF) << 17)))) & 1)) ^ ((int32(((in[5] >> 15) | ((in[6] & 0xFF) << 17)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[6] >> 8) | ((in[7] & 0x1) << 24)))) & 1)) ^ ((int32(((in[6] >> 8) | ((in[7] & 0x1) << 24)))) >> 1))) + out[7]
	out[9] = T(((-((int32((in[7] >> 1) & 0x1FFFFFF)) & 1)) ^ ((int32((in[7] >> 1) & 0x1FFFFFF)) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[7] >> 26) | ((in[8] & 0x7FFFF) << 6)))) & 1)) ^ ((int32(((in[7] >> 26) | ((in[8] & 0x7FFFF) << 6)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[8] >> 19) | ((in[9] & 0xFFF) << 13)))) & 1)) ^ ((int32(((in[8] >> 19) | ((in[9] & 0xFFF) << 13)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[9] >> 12) | ((in[10] & 0x1F) << 20)))) & 1)) ^ ((int32(((in[9] >> 12) | ((in[10] & 0x1F) << 20)))) >> 1))) + out[11]
	out[13] = T(((-((int32((in[10] >> 5) & 0x1FFFFFF)) & 1)) ^ ((int32((in[10] >> 5) & 0x1FFFFFF)) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[10] >> 30) | ((in[11] & 0x7FFFFF) << 2)))) & 1)) ^ ((int32(((in[10] >> 30) | ((in[11] & 0x7FFFFF) << 2)))) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[11] >> 23) | ((in[12] & 0xFFFF) << 9)))) & 1)) ^ ((int32(((in[11] >> 23) | ((in[12] & 0xFFFF) << 9)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[12] >> 16) | ((in[13] & 0x1FF) << 16)))) & 1)) ^ ((int32(((in[12] >> 16) | ((in[13] & 0x1FF) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[13] >> 9) | ((in[14] & 0x3) << 23)))) & 1)) ^ ((int32(((in[13] >> 9) | ((in[14] & 0x3) << 23)))) >> 1))) + out[16]
	out[18] = T(((-((int32((in[14] >> 2) & 0x1FFFFFF)) & 1)) ^ ((int32((in[14] >> 2) & 0x1FFFFFF)) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[14] >> 27) | ((in[15] & 0xFFFFF) << 5)))) & 1)) ^ ((int32(((in[14] >> 27) | ((in[15] & 0xFFFFF) << 5)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[15] >> 20) | ((in[16] & 0x1FFF) << 12)))) & 1)) ^ ((int32(((in[15] >> 20) | ((in[16] & 0x1FFF) << 12)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[16] >> 13) | ((in[17] & 0x3F) << 19)))) & 1)) ^ ((int32(((in[16] >> 13) | ((in[17] & 0x3F) << 19)))) >> 1))) + out[20]
	out[22] = T(((-((int32((in[17] >> 6) & 0x1FFFFFF)) & 1)) ^ ((int32((in[17] >> 6) & 0x1FFFFFF)) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[17] >> 31) | ((in[18] & 0xFFFFFF) << 1)))) & 1)) ^ ((int32(((in[17] >> 31) | ((in[18] & 0xFFFFFF) << 1)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[18] >> 24) | ((in[19] & 0x1FFFF) << 8)))) & 1)) ^ ((int32(((in[18] >> 24) | ((in[19] & 0x1FFFF) << 8)))) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[19] >> 17) | ((in[20] & 0x3FF) << 15)))) & 1)) ^ ((int32(((in[19] >> 17) | ((in[20] & 0x3FF) << 15)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[20] >> 10) | ((in[21] & 0x7) << 22)))) & 1)) ^ ((int32(((in[20] >> 10) | ((in[21] & 0x7) << 22)))) >> 1))) + out[25]
	out[27] = T(((-((int32((in[21] >> 3) & 0x1FFFFFF)) & 1)) ^ ((int32((in[21] >> 3) & 0x1FFFFFF)) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[21] >> 28) | ((in[22] & 0x1FFFFF) << 4)))) & 1)) ^ ((int32(((in[21] >> 28) | ((in[22] & 0x1FFFFF) << 4)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[22] >> 21) | ((in[23] & 0x3FFF) << 11)))) & 1)) ^ ((int32(((in[22] >> 21) | ((in[23] & 0x3FFF) << 11)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[23] >> 14) | ((in[24] & 0x7F) << 18)))) & 1)) ^ ((int32(((in[23] >> 14) | ((in[24] & 0x7F) << 18)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[24] >> 7))) & 1)) ^ ((int32((in[24] >> 7))) >> 1))) + out[30]
}

func deltaunpackzigzag32_26[T uint32 | int32](initoffset T, in *[26]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3FFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x3FFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 26) | ((in[1] & 0xFFFFF) << 6)))) & 1)) ^ ((int32(((in[0] >> 26) | ((in[1] & 0xFFFFF) << 6)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 20) | ((in[2] & 0x3FFF) << 12)))) & 1)) ^ ((int32(((in[1] >> 20) | ((in[2] & 0x3FFF) << 12)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 14) | ((in[3] & 0xFF) << 18)))) & 1)) ^ ((int32(((in[2] >> 14) | ((in[3] & 0xFF) << 18)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[3] >> 8) | ((in[4] & 0x3) << 24)))) & 1)) ^ ((int32(((in[3] >> 8) | ((in[4] & 0x3) << 24)))) >> 1))) + out[3]
	out[5] = T(((-((int32((in[4] >> 2) & 0x3FFFFFF)) & 1)) ^ ((int32((in[4] >> 2) & 0x3FFFFFF)) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[4] >> 28) | ((in[5] & 0x3FFFFF) << 4)))) & 1)) ^ ((int32(((in[4] >> 28) | ((in[5] & 0x3FFFFF) << 4)))) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[5] >> 22) | ((in[6] & 0xFFFF) << 10)))) & 1)) ^ ((int32(((in[5] >> 22) | ((in[6] & 0xFFFF) << 10)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[6] >> 16) | ((in[7] & 0x3FF) << 16)))) & 1)) ^ ((int32(((in[6] >> 16) | ((in[7] & 0x3FF) << 16)))) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[7] >> 10) | ((in[8] & 0xF) << 22)))) & 1)) ^ ((int32(((in[7] >> 10) | ((in[8] & 0xF) << 22)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[8] >> 4) & 0x3FFFFFF)) & 1)) ^ ((int32((in[8] >> 4) & 0x3FFFFFF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[8] >> 30) | ((in[9] & 0xFFFFFF) << 2)))) & 1)) ^ ((int32(((in[8] >> 30) | ((in[9] & 0xFFFFFF) << 2)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[9] >> 24) | ((in[10] & 0x3FFFF) << 8)))) & 1)) ^ ((int32(((in[9] >> 24) | ((in[10] & 0x3FFFF) << 8)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[10] >> 18) | ((in[11] & 0xFFF) << 14)))) & 1)) ^ ((int32(((in[10] >> 18) | ((in[11] & 0xFFF) << 14)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[11] >> 12) | ((in[12] & 0x3F) << 20)))) & 1)) ^ ((int32(((in[11] >> 12) | ((in[12] & 0x3F) << 20)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[12] >> 6))) & 1)) ^ ((int32((in[12] >> 6))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[13] >> 0) & 0x3FFFFFF)) & 1)) ^ ((int32((in[13] >> 0) & 0x3FFFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[13] >> 26) | ((in[14] & 0xFFFFF) << 6)))) & 1)) ^ ((int32(((in[13] >> 26) | ((in[14] & 0xFFFFF) << 6)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[14] >> 20) | ((in[15] & 0x3FFF) << 12)))) & 1)) ^ ((int32(((in[14] >> 20) | ((in[15] & 0x3FFF) << 12)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[15] >> 14) | ((in[16] & 0xFF) << 18)))) & 1)) ^ ((int32(((in[15] >> 14) | ((in[16] & 0xFF) << 18)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[16] >> 8) | ((in[17] & 0x3) << 24)))) & 1)) ^ ((int32(((in[16] >> 8) | ((in[17] & 0x3) << 24)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[17] >> 2) & 0x3FFFFFF)) & 1)) ^ ((int32((in[17] >> 2) & 0x3FFFFFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[17] >> 28) | ((in[18] & 0x3FFFFF) << 4)))) & 1)) ^ ((int32(((in[17] >> 28) | ((in[18] & 0x3FFFFF) << 4)))) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[18] >> 22) | ((in[19] & 0xFFFF) << 10)))) & 1)) ^ ((int32(((in[18] >> 22) | ((in[19] & 0xFFFF) << 10)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[19] >> 16) | ((in[20] & 0x3FF) << 16)))) & 1)) ^ ((int32(((in[19] >> 16) | ((in[20] & 0x3FF) << 16)))) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[20] >> 10) | ((in[21] & 0xF) << 22)))) & 1)) ^ ((int32(((in[20] >> 10) | ((in[21] & 0xF) << 22)))) >> 1))) + out[24]
	out[26] = T(((-((int32((in[21] >> 4) & 0x3FFFFFF)) & 1)) ^ ((int32((in[21] >> 4) & 0x3FFFFFF)) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[21] >> 30) | ((in[22] & 0xFFFFFF) << 2)))) & 1)) ^ ((int32(((in[21] >> 30) | ((in[22] & 0xFFFFFF) << 2)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[22] >> 24) | ((in[23] & 0x3FFFF) << 8)))) & 1)) ^ ((int32(((in[22] >> 24) | ((in[23] & 0x3FFFF) << 8)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[23] >> 18) | ((in[24] & 0xFFF) << 14)))) & 1)) ^ ((int32(((in[23] >> 18) | ((in[24] & 0xFFF) << 14)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[24] >> 12) | ((in[25] & 0x3F) << 20)))) & 1)) ^ ((int32(((in[24] >> 12) | ((in[25] & 0x3F) << 20)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[25] >> 6))) & 1)) ^ ((int32((in[25] >> 6))) >> 1))) + out[30]
}

func deltaunpackzigzag32_27[T uint32 | int32](initoffset T, in *[27]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7FFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x7FFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 27) | ((in[1] & 0x3FFFFF) << 5)))) & 1)) ^ ((int32(((in[0] >> 27) | ((in[1] & 0x3FFFFF) << 5)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 22) | ((in[2] & 0x1FFFF) << 10)))) & 1)) ^ ((int32(((in[1] >> 22) | ((in[2] & 0x1FFFF) << 10)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 17) | ((in[3] & 0xFFF) << 15)))) & 1)) ^ ((int32(((in[2] >> 17) | ((in[3] & 0xFFF) << 15)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[3] >> 12) | ((in[4] & 0x7F) << 20)))) & 1)) ^ ((int32(((in[3] >> 12) | ((in[4] & 0x7F) << 20)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[4] >> 7) | ((in[5] & 0x3) << 25)))) & 1)) ^ ((int32(((in[4] >> 7) | ((in[5] & 0x3) << 25)))) >> 1))) + out[4]
	out[6] = T(((-((int32((in[5] >> 2) & 0x7FFFFFF)) & 1)) ^ ((int32((in[5] >> 2) & 0x7FFFFFF)) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[5] >> 29) | ((in[6] & 0xFFFFFF) << 3)))) & 1)) ^ ((int32(((in[5] >> 29) | ((in[6] & 0xFFFFFF) << 3)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[6] >> 24) | ((in[7] & 0x7FFFF) << 8)))) & 1)) ^ ((int32(((in[6] >> 24) | ((in[7] & 0x7FFFF) << 8)))) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[7] >> 19) | ((in[8] & 0x3FFF) << 13)))) & 1)) ^ ((int32(((in[7] >> 19) | ((in[8] & 0x3FFF) << 13)))) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[8] >> 14) | ((in[9] & 0x1FF) << 18)))) & 1)) ^ ((int32(((in[8] >> 14) | ((in[9] & 0x1FF) << 18)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[9] >> 9) | ((in[10] & 0xF) << 23)))) & 1)) ^ ((int32(((in[9] >> 9) | ((in[10] & 0xF) << 23)))) >> 1))) + out[10]
	out[12] = T(((-((int32((in[10] >> 4) & 0x7FFFFFF)) & 1)) ^ ((int32((in[10] >> 4) & 0x7FFFFFF)) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[10] >> 31) | ((in[11] & 0x3FFFFFF) << 1)))) & 1)) ^ ((int32(((in[10] >> 31) | ((in[11] & 0x3FFFFFF) << 1)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[11] >> 26) | ((in[12] & 0x1FFFFF) << 6)))) & 1)) ^ ((int32(((in[11] >> 26) | ((in[12] & 0x1FFFFF) << 6)))) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[12] >> 21) | ((in[13] & 0xFFFF) << 11)))) & 1)) ^ ((int32(((in[12] >> 21) | ((in[13] & 0xFFFF) << 11)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[13] >> 16) | ((in[14] & 0x7FF) << 16)))) & 1)) ^ ((int32(((in[13] >> 16) | ((in[14] & 0x7FF) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[14] >> 11) | ((in[15] & 0x3F) << 21)))) & 1)) ^ ((int32(((in[14] >> 11) | ((in[15] & 0x3F) << 21)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[15] >> 6) | ((in[16] & 0x1) << 26)))) & 1)) ^ ((int32(((in[15] >> 6) | ((in[16] & 0x1) << 26)))) >> 1))) + out[17]
	out[19] = T(((-((int32((in[16] >> 1) & 0x7FFFFFF)) & 1)) ^ ((int32((in[16] >> 1) & 0x7FFFFFF)) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[16] >> 28) | ((in[17] & 0x7FFFFF) << 4)))) & 1)) ^ ((int32(((in[16] >> 28) | ((in[17] & 0x7FFFFF) << 4)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[17] >> 23) | ((in[18] & 0x3FFFF) << 9)))) & 1)) ^ ((int32(((in[17] >> 23) | ((in[18] & 0x3FFFF) << 9)))) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[18] >> 18) | ((in[19] & 0x1FFF) << 14)))) & 1)) ^ ((int32(((in[18] >> 18) | ((in[19] & 0x1FFF) << 14)))) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[19] >> 13) | ((in[20] & 0xFF) << 19)))) & 1)) ^ ((int32(((in[19] >> 13) | ((in[20] & 0xFF) << 19)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[20] >> 8) | ((in[21] & 0x7) << 24)))) & 1)) ^ ((int32(((in[20] >> 8) | ((in[21] & 0x7) << 24)))) >> 1))) + out[23]
	out[25] = T(((-((int32((in[21] >> 3) & 0x7FFFFFF)) & 1)) ^ ((int32((in[21] >> 3) & 0x7FFFFFF)) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[21] >> 30) | ((in[22] & 0x1FFFFFF) << 2)))) & 1)) ^ ((int32(((in[21] >> 30) | ((in[22] & 0x1FFFFFF) << 2)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[22] >> 25) | ((in[23] & 0xFFFFF) << 7)))) & 1)) ^ ((int32(((in[22] >> 25) | ((in[23] & 0xFFFFF) << 7)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[23] >> 20) | ((in[24] & 0x7FFF) << 12)))) & 1)) ^ ((int32(((in[23] >> 20) | ((in[24] & 0x7FFF) << 12)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[24] >> 15) | ((in[25] & 0x3FF) << 17)))) & 1)) ^ ((int32(((in[24] >> 15) | ((in[25] & 0x3FF) << 17)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[25] >> 10) | ((in[26] & 0x1F) << 22)))) & 1)) ^ ((int32(((in[25] >> 10) | ((in[26] & 0x1F) << 22)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[26] >> 5))) & 1)) ^ ((int32((in[26] >> 5))) >> 1))) + out[30]
}

func deltaunpackzigzag32_28[T uint32 | int32](initoffset T, in *[28]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0xFFFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0xFFFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 28) | ((in[1] & 0xFFFFFF) << 4)))) & 1)) ^ ((int32(((in[0] >> 28) | ((in[1] & 0xFFFFFF) << 4)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 24) | ((in[2] & 0xFFFFF) << 8)))) & 1)) ^ ((int32(((in[1] >> 24) | ((in[2] & 0xFFFFF) << 8)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 20) | ((in[3] & 0xFFFF) << 12)))) & 1)) ^ ((int32(((in[2] >> 20) | ((in[3] & 0xFFFF) << 12)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[3] >> 16) | ((in[4] & 0xFFF) << 16)))) & 1)) ^ ((int32(((in[3] >> 16) | ((in[4] & 0xFFF) << 16)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[4] >> 12) | ((in[5] & 0xFF) << 20)))) & 1)) ^ ((int32(((in[4] >> 12) | ((in[5] & 0xFF) << 20)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[5] >> 8) | ((in[6] & 0xF) << 24)))) & 1)) ^ ((int32(((in[5] >> 8) | ((in[6] & 0xF) << 24)))) >> 1))) + out[5]
	out[7] = T(((-((int32((in[6] >> 4))) & 1)) ^ ((int32((in[6] >> 4))) >> 1))) + out[6]
	out[8] = T(((-((int32((in[7] >> 0) & 0xFFFFFFF)) & 1)) ^ ((int32((in[7] >> 0) & 0xFFFFFFF)) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[7] >> 28) | ((in[8] & 0xFFFFFF) << 4)))) & 1)) ^ ((int32(((in[7] >> 28) | ((in[8] & 0xFFFFFF) << 4)))) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[8] >> 24) | ((in[9] & 0xFFFFF) << 8)))) & 1)) ^ ((int32(((in[8] >> 24) | ((in[9] & 0xFFFFF) << 8)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[9] >> 20) | ((in[10] & 0xFFFF) << 12)))) & 1)) ^ ((int32(((in[9] >> 20) | ((in[10] & 0xFFFF) << 12)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[10] >> 16) | ((in[11] & 0xFFF) << 16)))) & 1)) ^ ((int32(((in[10] >> 16) | ((in[11] & 0xFFF) << 16)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[11] >> 12) | ((in[12] & 0xFF) << 20)))) & 1)) ^ ((int32(((in[11] >> 12) | ((in[12] & 0xFF) << 20)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[12] >> 8) | ((in[13] & 0xF) << 24)))) & 1)) ^ ((int32(((in[12] >> 8) | ((in[13] & 0xF) << 24)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[13] >> 4))) & 1)) ^ ((int32((in[13] >> 4))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[14] >> 0) & 0xFFFFFFF)) & 1)) ^ ((int32((in[14] >> 0) & 0xFFFFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[14] >> 28) | ((in[15] & 0xFFFFFF) << 4)))) & 1)) ^ ((int32(((in[14] >> 28) | ((in[15] & 0xFFFFFF) << 4)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[15] >> 24) | ((in[16] & 0xFFFFF) << 8)))) & 1)) ^ ((int32(((in[15] >> 24) | ((in[16] & 0xFFFFF) << 8)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[16] >> 20) | ((in[17] & 0xFFFF) << 12)))) & 1)) ^ ((int32(((in[16] >> 20) | ((in[17] & 0xFFFF) << 12)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[17] >> 16) | ((in[18] & 0xFFF) << 16)))) & 1)) ^ ((int32(((in[17] >> 16) | ((in[18] & 0xFFF) << 16)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[18] >> 12) | ((in[19] & 0xFF) << 20)))) & 1)) ^ ((int32(((in[18] >> 12) | ((in[19] & 0xFF) << 20)))) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[19] >> 8) | ((in[20] & 0xF) << 24)))) & 1)) ^ ((int32(((in[19] >> 8) | ((in[20] & 0xF) << 24)))) >> 1))) + out[21]
	out[23] = T(((-((int32((in[20] >> 4))) & 1)) ^ ((int32((in[20] >> 4))) >> 1))) + out[22]
	out[24] = T(((-((int32((in[21] >> 0) & 0xFFFFFFF)) & 1)) ^ ((int32((in[21] >> 0) & 0xFFFFFFF)) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[21] >> 28) | ((in[22] & 0xFFFFFF) << 4)))) & 1)) ^ ((int32(((in[21] >> 28) | ((in[22] & 0xFFFFFF) << 4)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[22] >> 24) | ((in[23] & 0xFFFFF) << 8)))) & 1)) ^ ((int32(((in[22] >> 24) | ((in[23] & 0xFFFFF) << 8)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[23] >> 20) | ((in[24] & 0xFFFF) << 12)))) & 1)) ^ ((int32(((in[23] >> 20) | ((in[24] & 0xFFFF) << 12)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[24] >> 16) | ((in[25] & 0xFFF) << 16)))) & 1)) ^ ((int32(((in[24] >> 16) | ((in[25] & 0xFFF) << 16)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[25] >> 12) | ((in[26] & 0xFF) << 20)))) & 1)) ^ ((int32(((in[25] >> 12) | ((in[26] & 0xFF) << 20)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[26] >> 8) | ((in[27] & 0xF) << 24)))) & 1)) ^ ((int32(((in[26] >> 8) | ((in[27] & 0xF) << 24)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[27] >> 4))) & 1)) ^ ((int32((in[27] >> 4))) >> 1))) + out[30]
}

func deltaunpackzigzag32_29[T uint32 | int32](initoffset T, in *[29]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x1FFFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x1FFFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 29) | ((in[1] & 0x3FFFFFF) << 3)))) & 1)) ^ ((int32(((in[0] >> 29) | ((in[1] & 0x3FFFFFF) << 3)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 26) | ((in[2] & 0x7FFFFF) << 6)))) & 1)) ^ ((int32(((in[1] >> 26) | ((in[2] & 0x7FFFFF) << 6)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 23) | ((in[3] & 0xFFFFF) << 9)))) & 1)) ^ ((int32(((in[2] >> 23) | ((in[3] & 0xFFFFF) << 9)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[3] >> 20) | ((in[4] & 0x1FFFF) << 12)))) & 1)) ^ ((int32(((in[3] >> 20) | ((in[4] & 0x1FFFF) << 12)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[4] >> 17) | ((in[5] & 0x3FFF) << 15)))) & 1)) ^ ((int32(((in[4] >> 17) | ((in[5] & 0x3FFF) << 15)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[5] >> 14) | ((in[6] & 0x7FF) << 18)))) & 1)) ^ ((int32(((in[5] >> 14) | ((in[6] & 0x7FF) << 18)))) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[6] >> 11) | ((in[7] & 0xFF) << 21)))) & 1)) ^ ((int32(((in[6] >> 11) | ((in[7] & 0xFF) << 21)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[7] >> 8) | ((in[8] & 0x1F) << 24)))) & 1)) ^ ((int32(((in[7] >> 8) | ((in[8] & 0x1F) << 24)))) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[8] >> 5) | ((in[9] & 0x3) << 27)))) & 1)) ^ ((int32(((in[8] >> 5) | ((in[9] & 0x3) << 27)))) >> 1))) + out[8]
	out[10] = T(((-((int32((in[9] >> 2) & 0x1FFFFFFF)) & 1)) ^ ((int32((in[9] >> 2) & 0x1FFFFFFF)) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[9] >> 31) | ((in[10] & 0xFFFFFFF) << 1)))) & 1)) ^ ((int32(((in[9] >> 31) | ((in[10] & 0xFFFFFFF) << 1)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[10] >> 28) | ((in[11] & 0x1FFFFFF) << 4)))) & 1)) ^ ((int32(((in[10] >> 28) | ((in[11] & 0x1FFFFFF) << 4)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[11] >> 25) | ((in[12] & 0x3FFFFF) << 7)))) & 1)) ^ ((int32(((in[11] >> 25) | ((in[12] & 0x3FFFFF) << 7)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[12] >> 22) | ((in[13] & 0x7FFFF) << 10)))) & 1)) ^ ((int32(((in[12] >> 22) | ((in[13] & 0x7FFFF) << 10)))) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[13] >> 19) | ((in[14] & 0xFFFF) << 13)))) & 1)) ^ ((int32(((in[13] >> 19) | ((in[14] & 0xFFFF) << 13)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[14] >> 16) | ((in[15] & 0x1FFF) << 16)))) & 1)) ^ ((int32(((in[14] >> 16) | ((in[15] & 0x1FFF) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[15] >> 13) | ((in[16] & 0x3FF) << 19)))) & 1)) ^ ((int32(((in[15] >> 13) | ((in[16] & 0x3FF) << 19)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[16] >> 10) | ((in[17] & 0x7F) << 22)))) & 1)) ^ ((int32(((in[16] >> 10) | ((in[17] & 0x7F) << 22)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[17] >> 7) | ((in[18] & 0xF) << 25)))) & 1)) ^ ((int32(((in[17] >> 7) | ((in[18] & 0xF) << 25)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[18] >> 4) | ((in[19] & 0x1) << 28)))) & 1)) ^ ((int32(((in[18] >> 4) | ((in[19] & 0x1) << 28)))) >> 1))) + out[19]
	out[21] = T(((-((int32((in[19] >> 1) & 0x1FFFFFFF)) & 1)) ^ ((int32((in[19] >> 1) & 0x1FFFFFFF)) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[19] >> 30) | ((in[20] & 0x7FFFFFF) << 2)))) & 1)) ^ ((int32(((in[19] >> 30) | ((in[20] & 0x7FFFFFF) << 2)))) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[20] >> 27) | ((in[21] & 0xFFFFFF) << 5)))) & 1)) ^ ((int32(((in[20] >> 27) | ((in[21] & 0xFFFFFF) << 5)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[21] >> 24) | ((in[22] & 0x1FFFFF) << 8)))) & 1)) ^ ((int32(((in[21] >> 24) | ((in[22] & 0x1FFFFF) << 8)))) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[22] >> 21) | ((in[23] & 0x3FFFF) << 11)))) & 1)) ^ ((int32(((in[22] >> 21) | ((in[23] & 0x3FFFF) << 11)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[23] >> 18) | ((in[24] & 0x7FFF) << 14)))) & 1)) ^ ((int32(((in[23] >> 18) | ((in[24] & 0x7FFF) << 14)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[24] >> 15) | ((in[25] & 0xFFF) << 17)))) & 1)) ^ ((int32(((in[24] >> 15) | ((in[25] & 0xFFF) << 17)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[25] >> 12) | ((in[26] & 0x1FF) << 20)))) & 1)) ^ ((int32(((in[25] >> 12) | ((in[26] & 0x1FF) << 20)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[26] >> 9) | ((in[27] & 0x3F) << 23)))) & 1)) ^ ((int32(((in[26] >> 9) | ((in[27] & 0x3F) << 23)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[27] >> 6) | ((in[28] & 0x7) << 26)))) & 1)) ^ ((int32(((in[27] >> 6) | ((in[28] & 0x7) << 26)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[28] >> 3))) & 1)) ^ ((int32((in[28] >> 3))) >> 1))) + out[30]
}

func deltaunpackzigzag32_30[T uint32 | int32](initoffset T, in *[30]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x3FFFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x3FFFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 30) | ((in[1] & 0xFFFFFFF) << 2)))) & 1)) ^ ((int32(((in[0] >> 30) | ((in[1] & 0xFFFFFFF) << 2)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 28) | ((in[2] & 0x3FFFFFF) << 4)))) & 1)) ^ ((int32(((in[1] >> 28) | ((in[2] & 0x3FFFFFF) << 4)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 26) | ((in[3] & 0xFFFFFF) << 6)))) & 1)) ^ ((int32(((in[2] >> 26) | ((in[3] & 0xFFFFFF) << 6)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[3] >> 24) | ((in[4] & 0x3FFFFF) << 8)))) & 1)) ^ ((int32(((in[3] >> 24) | ((in[4] & 0x3FFFFF) << 8)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[4] >> 22) | ((in[5] & 0xFFFFF) << 10)))) & 1)) ^ ((int32(((in[4] >> 22) | ((in[5] & 0xFFFFF) << 10)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[5] >> 20) | ((in[6] & 0x3FFFF) << 12)))) & 1)) ^ ((int32(((in[5] >> 20) | ((in[6] & 0x3FFFF) << 12)))) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[6] >> 18) | ((in[7] & 0xFFFF) << 14)))) & 1)) ^ ((int32(((in[6] >> 18) | ((in[7] & 0xFFFF) << 14)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[7] >> 16) | ((in[8] & 0x3FFF) << 16)))) & 1)) ^ ((int32(((in[7] >> 16) | ((in[8] & 0x3FFF) << 16)))) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[8] >> 14) | ((in[9] & 0xFFF) << 18)))) & 1)) ^ ((int32(((in[8] >> 14) | ((in[9] & 0xFFF) << 18)))) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[9] >> 12) | ((in[10] & 0x3FF) << 20)))) & 1)) ^ ((int32(((in[9] >> 12) | ((in[10] & 0x3FF) << 20)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[10] >> 10) | ((in[11] & 0xFF) << 22)))) & 1)) ^ ((int32(((in[10] >> 10) | ((in[11] & 0xFF) << 22)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[11] >> 8) | ((in[12] & 0x3F) << 24)))) & 1)) ^ ((int32(((in[11] >> 8) | ((in[12] & 0x3F) << 24)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[12] >> 6) | ((in[13] & 0xF) << 26)))) & 1)) ^ ((int32(((in[12] >> 6) | ((in[13] & 0xF) << 26)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[13] >> 4) | ((in[14] & 0x3) << 28)))) & 1)) ^ ((int32(((in[13] >> 4) | ((in[14] & 0x3) << 28)))) >> 1))) + out[13]
	out[15] = T(((-((int32((in[14] >> 2))) & 1)) ^ ((int32((in[14] >> 2))) >> 1))) + out[14]
	out[16] = T(((-((int32((in[15] >> 0) & 0x3FFFFFFF)) & 1)) ^ ((int32((in[15] >> 0) & 0x3FFFFFFF)) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[15] >> 30) | ((in[16] & 0xFFFFFFF) << 2)))) & 1)) ^ ((int32(((in[15] >> 30) | ((in[16] & 0xFFFFFFF) << 2)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[16] >> 28) | ((in[17] & 0x3FFFFFF) << 4)))) & 1)) ^ ((int32(((in[16] >> 28) | ((in[17] & 0x3FFFFFF) << 4)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[17] >> 26) | ((in[18] & 0xFFFFFF) << 6)))) & 1)) ^ ((int32(((in[17] >> 26) | ((in[18] & 0xFFFFFF) << 6)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[18] >> 24) | ((in[19] & 0x3FFFFF) << 8)))) & 1)) ^ ((int32(((in[18] >> 24) | ((in[19] & 0x3FFFFF) << 8)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[19] >> 22) | ((in[20] & 0xFFFFF) << 10)))) & 1)) ^ ((int32(((in[19] >> 22) | ((in[20] & 0xFFFFF) << 10)))) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[20] >> 20) | ((in[21] & 0x3FFFF) << 12)))) & 1)) ^ ((int32(((in[20] >> 20) | ((in[21] & 0x3FFFF) << 12)))) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[21] >> 18) | ((in[22] & 0xFFFF) << 14)))) & 1)) ^ ((int32(((in[21] >> 18) | ((in[22] & 0xFFFF) << 14)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[22] >> 16) | ((in[23] & 0x3FFF) << 16)))) & 1)) ^ ((int32(((in[22] >> 16) | ((in[23] & 0x3FFF) << 16)))) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[23] >> 14) | ((in[24] & 0xFFF) << 18)))) & 1)) ^ ((int32(((in[23] >> 14) | ((in[24] & 0xFFF) << 18)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[24] >> 12) | ((in[25] & 0x3FF) << 20)))) & 1)) ^ ((int32(((in[24] >> 12) | ((in[25] & 0x3FF) << 20)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[25] >> 10) | ((in[26] & 0xFF) << 22)))) & 1)) ^ ((int32(((in[25] >> 10) | ((in[26] & 0xFF) << 22)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[26] >> 8) | ((in[27] & 0x3F) << 24)))) & 1)) ^ ((int32(((in[26] >> 8) | ((in[27] & 0x3F) << 24)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[27] >> 6) | ((in[28] & 0xF) << 26)))) & 1)) ^ ((int32(((in[27] >> 6) | ((in[28] & 0xF) << 26)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[28] >> 4) | ((in[29] & 0x3) << 28)))) & 1)) ^ ((int32(((in[28] >> 4) | ((in[29] & 0x3) << 28)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[29] >> 2))) & 1)) ^ ((int32((in[29] >> 2))) >> 1))) + out[30]
}

func deltaunpackzigzag32_31[T uint32 | int32](initoffset T, in *[31]uint32, out *[32]T) {
	out[0] = T(((-((int32((in[0] >> 0) & 0x7FFFFFFF)) & 1)) ^ ((int32((in[0] >> 0) & 0x7FFFFFFF)) >> 1))) + initoffset
	out[1] = T(((-((int32(((in[0] >> 31) | ((in[1] & 0x3FFFFFFF) << 1)))) & 1)) ^ ((int32(((in[0] >> 31) | ((in[1] & 0x3FFFFFFF) << 1)))) >> 1))) + out[0]
	out[2] = T(((-((int32(((in[1] >> 30) | ((in[2] & 0x1FFFFFFF) << 2)))) & 1)) ^ ((int32(((in[1] >> 30) | ((in[2] & 0x1FFFFFFF) << 2)))) >> 1))) + out[1]
	out[3] = T(((-((int32(((in[2] >> 29) | ((in[3] & 0xFFFFFFF) << 3)))) & 1)) ^ ((int32(((in[2] >> 29) | ((in[3] & 0xFFFFFFF) << 3)))) >> 1))) + out[2]
	out[4] = T(((-((int32(((in[3] >> 28) | ((in[4] & 0x7FFFFFF) << 4)))) & 1)) ^ ((int32(((in[3] >> 28) | ((in[4] & 0x7FFFFFF) << 4)))) >> 1))) + out[3]
	out[5] = T(((-((int32(((in[4] >> 27) | ((in[5] & 0x3FFFFFF) << 5)))) & 1)) ^ ((int32(((in[4] >> 27) | ((in[5] & 0x3FFFFFF) << 5)))) >> 1))) + out[4]
	out[6] = T(((-((int32(((in[5] >> 26) | ((in[6] & 0x1FFFFFF) << 6)))) & 1)) ^ ((int32(((in[5] >> 26) | ((in[6] & 0x1FFFFFF) << 6)))) >> 1))) + out[5]
	out[7] = T(((-((int32(((in[6] >> 25) | ((in[7] & 0xFFFFFF) << 7)))) & 1)) ^ ((int32(((in[6] >> 25) | ((in[7] & 0xFFFFFF) << 7)))) >> 1))) + out[6]
	out[8] = T(((-((int32(((in[7] >> 24) | ((in[8] & 0x7FFFFF) << 8)))) & 1)) ^ ((int32(((in[7] >> 24) | ((in[8] & 0x7FFFFF) << 8)))) >> 1))) + out[7]
	out[9] = T(((-((int32(((in[8] >> 23) | ((in[9] & 0x3FFFFF) << 9)))) & 1)) ^ ((int32(((in[8] >> 23) | ((in[9] & 0x3FFFFF) << 9)))) >> 1))) + out[8]
	out[10] = T(((-((int32(((in[9] >> 22) | ((in[10] & 0x1FFFFF) << 10)))) & 1)) ^ ((int32(((in[9] >> 22) | ((in[10] & 0x1FFFFF) << 10)))) >> 1))) + out[9]
	out[11] = T(((-((int32(((in[10] >> 21) | ((in[11] & 0xFFFFF) << 11)))) & 1)) ^ ((int32(((in[10] >> 21) | ((in[11] & 0xFFFFF) << 11)))) >> 1))) + out[10]
	out[12] = T(((-((int32(((in[11] >> 20) | ((in[12] & 0x7FFFF) << 12)))) & 1)) ^ ((int32(((in[11] >> 20) | ((in[12] & 0x7FFFF) << 12)))) >> 1))) + out[11]
	out[13] = T(((-((int32(((in[12] >> 19) | ((in[13] & 0x3FFFF) << 13)))) & 1)) ^ ((int32(((in[12] >> 19) | ((in[13] & 0x3FFFF) << 13)))) >> 1))) + out[12]
	out[14] = T(((-((int32(((in[13] >> 18) | ((in[14] & 0x1FFFF) << 14)))) & 1)) ^ ((int32(((in[13] >> 18) | ((in[14] & 0x1FFFF) << 14)))) >> 1))) + out[13]
	out[15] = T(((-((int32(((in[14] >> 17) | ((in[15] & 0xFFFF) << 15)))) & 1)) ^ ((int32(((in[14] >> 17) | ((in[15] & 0xFFFF) << 15)))) >> 1))) + out[14]
	out[16] = T(((-((int32(((in[15] >> 16) | ((in[16] & 0x7FFF) << 16)))) & 1)) ^ ((int32(((in[15] >> 16) | ((in[16] & 0x7FFF) << 16)))) >> 1))) + out[15]
	out[17] = T(((-((int32(((in[16] >> 15) | ((in[17] & 0x3FFF) << 17)))) & 1)) ^ ((int32(((in[16] >> 15) | ((in[17] & 0x3FFF) << 17)))) >> 1))) + out[16]
	out[18] = T(((-((int32(((in[17] >> 14) | ((in[18] & 0x1FFF) << 18)))) & 1)) ^ ((int32(((in[17] >> 14) | ((in[18] & 0x1FFF) << 18)))) >> 1))) + out[17]
	out[19] = T(((-((int32(((in[18] >> 13) | ((in[19] & 0xFFF) << 19)))) & 1)) ^ ((int32(((in[18] >> 13) | ((in[19] & 0xFFF) << 19)))) >> 1))) + out[18]
	out[20] = T(((-((int32(((in[19] >> 12) | ((in[20] & 0x7FF) << 20)))) & 1)) ^ ((int32(((in[19] >> 12) | ((in[20] & 0x7FF) << 20)))) >> 1))) + out[19]
	out[21] = T(((-((int32(((in[20] >> 11) | ((in[21] & 0x3FF) << 21)))) & 1)) ^ ((int32(((in[20] >> 11) | ((in[21] & 0x3FF) << 21)))) >> 1))) + out[20]
	out[22] = T(((-((int32(((in[21] >> 10) | ((in[22] & 0x1FF) << 22)))) & 1)) ^ ((int32(((in[21] >> 10) | ((in[22] & 0x1FF) << 22)))) >> 1))) + out[21]
	out[23] = T(((-((int32(((in[22] >> 9) | ((in[23] & 0xFF) << 23)))) & 1)) ^ ((int32(((in[22] >> 9) | ((in[23] & 0xFF) << 23)))) >> 1))) + out[22]
	out[24] = T(((-((int32(((in[23] >> 8) | ((in[24] & 0x7F) << 24)))) & 1)) ^ ((int32(((in[23] >> 8) | ((in[24] & 0x7F) << 24)))) >> 1))) + out[23]
	out[25] = T(((-((int32(((in[24] >> 7) | ((in[25] & 0x3F) << 25)))) & 1)) ^ ((int32(((in[24] >> 7) | ((in[25] & 0x3F) << 25)))) >> 1))) + out[24]
	out[26] = T(((-((int32(((in[25] >> 6) | ((in[26] & 0x1F) << 26)))) & 1)) ^ ((int32(((in[25] >> 6) | ((in[26] & 0x1F) << 26)))) >> 1))) + out[25]
	out[27] = T(((-((int32(((in[26] >> 5) | ((in[27] & 0xF) << 27)))) & 1)) ^ ((int32(((in[26] >> 5) | ((in[27] & 0xF) << 27)))) >> 1))) + out[26]
	out[28] = T(((-((int32(((in[27] >> 4) | ((in[28] & 0x7) << 28)))) & 1)) ^ ((int32(((in[27] >> 4) | ((in[28] & 0x7) << 28)))) >> 1))) + out[27]
	out[29] = T(((-((int32(((in[28] >> 3) | ((in[29] & 0x3) << 29)))) & 1)) ^ ((int32(((in[28] >> 3) | ((in[29] & 0x3) << 29)))) >> 1))) + out[28]
	out[30] = T(((-((int32(((in[29] >> 2) | ((in[30] & 0x1) << 30)))) & 1)) ^ ((int32(((in[29] >> 2) | ((in[30] & 0x1) << 30)))) >> 1))) + out[29]
	out[31] = T(((-((int32((in[30] >> 1))) & 1)) ^ ((int32((in[30] >> 1))) >> 1))) + out[30]
}
